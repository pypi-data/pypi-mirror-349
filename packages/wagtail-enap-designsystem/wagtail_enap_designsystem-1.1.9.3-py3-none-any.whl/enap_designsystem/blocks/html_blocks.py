...
class CitizenServerBlock(blocks.StructBlock):
    ...
    background_image = ImageChooserBlock(required=False, help_text="Background image for the block")
...
class CarouselGreen(blocks.StructBlock):
    ...
    def get_context(self, value, parent_context=None):
        context = super().get_context(value, parent_context=parent_context)
        # Garantir que os valores estejam disponíveis tanto como 'self' quanto como 'value'
        context['tag'] = value.get('tag', '')
...
class TopicLinksBlock(blocks.StructBlock):
    """
    Bloco para exibir tópicos com links "Veja mais" e ícones Font Awesome
    """
    
    topic1_icon = blocks.CharBlock(
        required=False,
        max_length=50,
        label=_("Ícone do tópico 1"),
        help_text=_("Classe do ícone Font Awesome (ex: fa-solid fa-house)"),
    ...
    topic2_icon = blocks.CharBlock(
        required=False,
        max_length=50,
        label=_("Ícone do tópico 2"),
        help_text=_("Classe do ícone Font Awesome (ex: fa-solid fa-house)"),
    ...
    topic3_icon = blocks.CharBlock(
        required=False,
        max_length=50,
        label=_("Ícone do tópico 3"),
        help_text=_("Classe do ícone Font Awesome (ex: fa-solid fa-house)"),
