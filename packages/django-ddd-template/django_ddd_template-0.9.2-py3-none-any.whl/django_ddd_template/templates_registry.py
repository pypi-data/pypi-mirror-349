...
TEMPLATES = {
    "domain/entities/{app_name | file_name}.py": dedent('''
        class {{AppName}}:
    ...
    "domain/repositories/{app_name | file_name}_repository.py": dedent('''
...
''').strip(),
    ...
    "domain/services/{app_name | file_name}_service.py": dedent('''
...
''').strip(),
    ...
    "infrastructure/models/{app_name | file_name}_model.py": dedent('''
...
from {{app_name}}.domain.entities.entity import {{AppName}}
from {{app_name}}.domain.repositories.entity_repository import {{AppName}}Repository
from {{app_name}}.infrastructure.models.entity_model import {{AppName}}Model
...
''').strip(),
    ...
    "infrastructure/serializers/{app_name | file_name}_serializer.py": dedent('''
from rest_framework import serializers
from {{app_name}}.infrastructure.models.{app_name | file_name}_model import {{AppName}}Model
...
''').strip(),
    ...
    "infrastructure/views/{app_name | file_name}_view.py": dedent('''
from rest_framework import viewsets
from {{app_name}}.infrastructure.models.{app_name | file_name}_model import {{AppName}}Model
from {{app_name}}.infrastructure.serializers.{app_name | file_name}_serializer import {{AppName}}Serializer
...
from {{app_name}}.infrastructure.views.{app_name | file_name}_view import {{AppName}}ViewSet
...
import unittest
from {{app_name}}.domain.services.{app_name | file_name}_service import {{AppName}}Service
from {{app_name}}.domain.entities.{app_name | file_name} import {{AppName}}
