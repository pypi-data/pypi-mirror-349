...
class GetOrders:
    ...
    def _get_data_from_api(self) -> None:
        ...
        while True:
            ...
            # Get the new orders
            raw_orders_data = self._get_api_data() if not self.payload.resync_from_broker else self._get_update_book_api_data()
    ...
    def parse_data(self, order_data: list[ApiResponseOrderListing_Type]) -> dict[str, ResponseOrderListingData_Type]:
        ...
        for data in order_data:
            ...
            _tmp_order_ref_internal_id: str = f"{data['b_orderid']}|{data.get('e_orderid', '')}"
            ...
            if (_tmp_order_ref_internal_id not in parsed_broker_data) \
                ...
                parsed_broker_data[_tmp_order_ref_internal_id] = { #  type: ignore
                    ...
                    'instrument': generic_models.Instrument_Pydantic.from_api_str(data['instrument']).api_instr_str,
    ...
    def _get_data_from_local_file(self) -> dict[BrokerClient_Pydantic, list[ResponseOrderListingData_Type]]:
