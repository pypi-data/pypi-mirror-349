...
class ResponseGetPositions_Pydantic(generic_models.BaseResponse_Pydantic):
    body: typing.Optional[dict[BrokerClient_Pydantic, list[ResponsePositionsAccountwiseListing_Type]]] = Field(default=None)


class ResponseGetPositionsConsolidated_Pydantic(generic_models.BaseResponse_Pydantic):
