...
class _ResponseError_Pydantic(BaseModel):
    code: typing.Optional[generic_enums.ErrorCodes] = Field(default=None)
    msg: typing.Optional[str] = Field(default=None)

class BaseResponse_Pydantic(BaseModel):
    success: bool
    error: typing.Optional[_ResponseError_Pydantic] = Field(default_factory=_ResponseError_Pydantic)
...
class InternalSessionData_Pydantic(typing.TypedDict):
    qapp_ac_data: AccountDetails_Pydantic


class Instrument_Pydantic(BaseModel):
    ...
    def from_api_str(cls, instr: str) -> typing.Self:
        ...
        return cls(
            ...
            instrument_type=generic_enums.InstrumentType(_tmp['instrument_type']),
