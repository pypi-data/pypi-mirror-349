...
class OptionsBrokerOrderUpdatesWebsocket(QappWebsocket):
    ...
    def __init__(
            ...
            order_updates_callback: collections.abc.Callable[[websocket_models.BrokerOrderUpdateWsData_Pydantic], typing.Any],
        ) -> None:
    ...
    def _process_broker_order_update(self, order_data: websocket_models.BrokerOrderUpdateRawWsData_Type) -> websocket_models.BrokerOrderUpdateWsData_Pydantic:
        ...
        _tmp_order_ref_internal_id = f"{order_data['b_orderid']}|{order_data.get('e_orderid', '')}"
        ...
        _new_order = websocket_models.BrokerOrderUpdateWsData_Pydantic(
            ...
            e_orderid=order_data.get('e_orderid', ''),
            userid=str(order_data['userid']),
            instrument=generic_models.Instrument_Pydantic.from_api_str(order_data['instrument']).api_instr_str,
