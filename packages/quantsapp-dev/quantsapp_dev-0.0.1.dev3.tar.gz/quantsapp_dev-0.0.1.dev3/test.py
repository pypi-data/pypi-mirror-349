...
def broker_order_update(update: quantsapp.response.BrokerOrderUpdateWsData_Pydantic) -> typing.Any:
...
# available_brokers_resp = qapp_execution.list_available_brokers(name_type='enum')
# print()
...
#     is_choice_login_available = quantsapp.Broker.CHOICE in available_brokers_resp.body['access_token_login']
#     is_fivepaisa_login_available = quantsapp.Broker.FIVEPAISA in available_brokers_resp.body['access_token_login']
...
#     marigin_benefit=True,  # Optional - Default = True
#     legs=[
#         {
#             'qty': 75,
#             'price': 0.05,
...
# # TODO push this into list orders and positions with resync brokers options
