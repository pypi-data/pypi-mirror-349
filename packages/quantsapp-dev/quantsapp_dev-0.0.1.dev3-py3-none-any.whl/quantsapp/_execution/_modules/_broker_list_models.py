...
class ResponseListAvailableBrokers_Pydantic(generic_models.BaseResponse_Pydantic):
    body: typing.Optional[ResponseListAvailableBrokers_Type] = Field(default=None)

class ResponseListMappedBrokers_Pydantic(generic_models.BaseResponse_Pydantic):
