...
class ResponseGetBrokerWebsocketConnectionStatus_Pydantic(generic_models.BaseResponse_Pydantic):
    body: typing.Optional[ResponseBrokerWsConnStatus_Type] = Field(default=None)

class ResponseBrokerWebsocketReConnect_Pydantic(generic_models.BaseResponse_Pydantic):
