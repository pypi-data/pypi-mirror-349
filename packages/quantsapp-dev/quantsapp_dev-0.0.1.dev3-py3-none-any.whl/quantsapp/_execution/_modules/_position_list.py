...
class GetPositions:
    ...
    def update_positions(self) -> None:
        ...
        if not self.payload.resync_from_broker:
            ...
            with contextlib.suppress(Exception):
                execution_cache.positions = self._get_data_from_local_file()
    ...
    def _get_data_from_local_file(self) -> dict[str, list[ApiResponsePositionsAccountwise_Type]]:
...
class GetPositionsCombined:
    ...
    def update_positions(self) -> None:
        ...
        if not self.payload.resync_from_broker:
            ...
            # if file not exists then download the new data from api and push it to cache
            with contextlib.suppress(Exception):
                execution_cache.positions_combined = self._get_data_from_local_file()
                return None
    ...
    def _get_data_from_local_file(self) -> list[ApiResponsePositionsCombined_Type]:
        """Get the Mapped Brokers data from the local cache file"""
