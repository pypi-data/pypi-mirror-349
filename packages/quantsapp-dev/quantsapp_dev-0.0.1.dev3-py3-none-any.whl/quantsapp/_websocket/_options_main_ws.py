...
class OptionsMainWebsocket(QappWebsocket):
    ...
    def _process_market_timings_data(self) -> None:
        ...
        nse_fno_market_timings: websocket_models.ApiResponseMainOptionsWsMarketTimings_Type = self.ws_session_data['market_timings'][generic_enums.Exchange.NSE_FNO.value.lower()] # type: ignore
