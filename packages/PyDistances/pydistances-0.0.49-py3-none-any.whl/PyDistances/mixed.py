...
class RelMSDistMatrix: 
    ...
    def compute(self, X, tol=0.0001, d=2, Gs_PSD_trans=True):
        """
        Compute method.
        ...
        if Gs_PSD_trans == True :
            ...
            if not G1_SDP :
                ...
                print('G1 is not SDP, a transformation to enforced it will be applied.')
                ...
                print('G2 is not SDP, a transformation to enforced it will be applied.')
                ...
                print('G3 is not SDP, a transformation to enforced it will be applied.')
