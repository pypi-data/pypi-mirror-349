  ...
  py::class_<RemoteInferenceRequest>(m, "RemoteInferenceRequest")
      ...
      .def_property_readonly(
          ...
          [](const RemoteInferenceRequest& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceRequest::Type::PROCESS,
                "Invalid type for process_request");
            ASSERT_VALID_RUNTIME(self.process_request.has_value(),
      ...
      .def_property_readonly(
          ...
          [](const RemoteInferenceRequest& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceRequest::Type::ABORT,
                "Invalid type for abort_request");
            ASSERT_VALID_RUNTIME(self.abort_request.has_value(),
      ...
      .def_property_readonly(
          ...
          [](const RemoteInferenceRequest& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceRequest::Type::STARTUP,
                "Invalid type for startup_request");
            ASSERT_VALID_RUNTIME(self.startup_request.has_value(),
      ...
      .def_property_readonly(
          "config_request", [](const RemoteInferenceRequest& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceRequest::Type::CONFIG,
                "Invalid type for config_request");
            ASSERT_VALID_RUNTIME(self.config_request.has_value(),
  ...
  py::class_<RemoteInferenceResponse>(m, "RemoteInferenceResponse")
      ...
      .def_property_readonly(
          ...
          [](const RemoteInferenceResponse& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceResponse::Type::OUTPUT,
                "Invalid type for output_response");
            ASSERT_VALID_RUNTIME(self.output_response.has_value(),
      ...
      .def_property_readonly(
          ...
          [](const RemoteInferenceResponse& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceResponse::Type::ERROR,
                "Invalid type for error_response");
            ASSERT_VALID_RUNTIME(self.error_response.has_value(),
      ...
      .def_property_readonly(
          ...
          [](const RemoteInferenceResponse& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceResponse::Type::STARTUP,
                "Invalid type for startup_response");
            ASSERT_VALID_RUNTIME(self.startup_response.has_value(),
      ...
      .def_property_readonly(
          "model_config", [](const RemoteInferenceResponse& self) {
            ASSERT_VALID_RUNTIME(
                self.type == RemoteInferenceResponse::Type::MODEL_CONFIG,
                "Invalid type for model_config");
            ASSERT_VALID_RUNTIME(self.model_config.has_value(),
