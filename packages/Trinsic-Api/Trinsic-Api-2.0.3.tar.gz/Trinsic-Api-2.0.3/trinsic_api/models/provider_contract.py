...
class ProviderContract(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "logoUrl", "available", "geography", "regions", "launchMethod", "collectionMethod", "resultsMayBeDelayedAfterRedirect", "hasRefreshableContent", "requiresInput", "hasTrinsicInterface", "supportsAdvancedProviderSessions", "subProviders", "health"]
