...
async def log_tool_usage(data: ToolUsageData, api_endpoint: str = "https://observeeapi-242959672448.us-central1.run.app/logs/") -> None:
    """
...
def observee_usage_logger(func: Callable[..., Awaitable[str]]) -> Callable[..., Awaitable[str]]:
    """
