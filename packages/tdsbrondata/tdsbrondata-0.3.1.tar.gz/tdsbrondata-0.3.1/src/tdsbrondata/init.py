...
def lakehouse(schemaName, sourceDataMode, sourceDataPeriod):
    ...
    tdsbrondata.schemaNameBronze = tdsbrondata.schemaName.replace('S', 'B')
    tdsbrondata.schemaNameSilver = tdsbrondata.schemaName.replace('B', 'S')
    ...
    tdsbrondata.lakehouseNameBronze = tdsbrondata.lakehouseName.replace('S', 'B')
    tdsbrondata.lakehouseNameSilver = tdsbrondata.lakehouseName.replace('B', 'S')
