...
from ui_coverage_scenario_tool.src.history.models import CoverageHistoryState, AppHistoryState
        ...
        state = CoverageHistoryState(
            apps={
                app.key: AppHistoryState(
                    ...
                    scenarios={
                        scenario.name: scenario.history
                        for scenario in report.apps_coverage[app.key].scenarios
                    }
                )
