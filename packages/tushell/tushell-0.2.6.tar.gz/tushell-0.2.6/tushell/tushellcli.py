...
def get_memory(key, list_keys, json_flag, json_file, md_flag, md_file):
    """Get fractal stone memory value by key. Ritual: --json/--md for stdout, --json-file/--md-file for file output."""
