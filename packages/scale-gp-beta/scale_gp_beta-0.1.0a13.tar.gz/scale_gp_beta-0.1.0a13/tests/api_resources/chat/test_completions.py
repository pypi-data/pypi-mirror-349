...
class TestCompletions:
    ...
    def test_method_models(self, client: SGPClient) -> None:
        ...
        assert_matches_type(SyncCursorPage[ModelDefinition], completion, path=["response"])
...
class TestAsyncCompletions:
    ...
    async def test_method_models(self, async_client: AsyncSGPClient) -> None:
        ...
        assert_matches_type(AsyncCursorPage[ModelDefinition], completion, path=["response"])
