...
from zecmf.testing.constants import HTTP_OK, HTTP_UNAUTHORIZED
...
@pytest.mark.parametrize(
    ...
    [
        (None, HTTP_UNAUTHORIZED),  # No token
        ("Not a real token", HTTP_UNAUTHORIZED),  # Invalid format
        ("Bearer invalid.token.format", HTTP_UNAUTHORIZED),  # Invalid token
    ],
)
