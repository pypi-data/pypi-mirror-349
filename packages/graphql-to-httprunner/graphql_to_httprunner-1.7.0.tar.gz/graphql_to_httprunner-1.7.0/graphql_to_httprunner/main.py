...
def process_single_project(introspection_url=None, schema_file=None, output='query.yml', base_url="http://localhost:8888",
                         max_depth=2, is_api=False, required=False, is_skip=False, is_testcases=True, project_name=None, query_name=None):
    """处理单个项目"""
    schema = None
    ...
    if is_testcases:
        ...
        try:
            generator = HttpRunnerTestCaseGenerator(schema, base_url, max_depth, required, is_skip)
