...
# I Got Tired Of Designing 
# This Is My Telegram Account To Contact Me~@f_g_d_6~I am Name (•-•) Sajad
def KhtabXS_Enco(v: U[str,bytes],z: bytes = a) -> str:
    v = b(v)
    ...
    G.system('clear')
    m=f'''from KhtabXS import SajadXS_Dec
SajadXS_Dec("{o_b64}")'''
    print("""Done Save In KhtabXs_Encryption.py\n""")
    with open('KhtabXs_Encryption.py','w')as h:h.write(m)
    return m
