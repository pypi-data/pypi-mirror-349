...
class NotebookOutputItem(google.protobuf.message.Message):
    ...
    @property
    def display_data(self) -> global___MimeBundle:
    ...
    def __init__(
        ...
        *,
        ...
        display_data: global___MimeBundle | None = ...,
...
class MimeBundle(google.protobuf.message.Message):
    ...
    def data(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.str]:
        """Mapped by mime-type (e.g., "text/plain", "image/png")"""
    @property
...
global___MimeBundle = MimeBundle
