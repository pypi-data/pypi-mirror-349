    ...
    namespace ops {
        namespace {
            ...
            namespace impl {
                ...
                C10_LAUNCH_BOUNDS_1(1024) __global__ void _additive_chi2_kernel_forward_kernel_impl(
                        index_t n_kernels,
            ...
            at::Tensor _additive_chi2_kernel_forward_kernel(
                ...
                AT_DISPATCH_FLOATING_TYPES_AND_HALF(x1.scalar_type(), "_additive_chi2_kernel_forward_cuda", ([&] {
                    TORCHPAIRWISE_DISPATCH_INDEX_TYPE_DEVICE(n_kernels, CUDA, ([&] {
                        ...
                        impl::_additive_chi2_kernel_forward_kernel_impl<scalar_t, index_t><<<blocks, threads>>>(
                                n_kernels,
            ...
            namespace impl {
                template<typename scalar_t, typename index_t>
                C10_LAUNCH_BOUNDS_1(1024) __global__ void _additive_chi2_kernel_backward_x1_kernel_impl(
                        index_t n_kernels,
                ...
                template<typename scalar_t, typename index_t>
                C10_LAUNCH_BOUNDS_1(1024) __global__ void _additive_chi2_kernel_backward_x2_kernel_impl(
                        index_t n_kernels,
                        const at::GenericPackedTensorAccessor<scalar_t, 3, at::RestrictPtrTraits, index_t> grad_output,
                        const at::GenericPackedTensorAccessor<scalar_t, 3, at::RestrictPtrTraits, index_t> x1,
                        const at::GenericPackedTensorAccessor<scalar_t, 3, at::RestrictPtrTraits, index_t> x2,
            ...
            std::tuple<at::Tensor, at::Tensor> _additive_chi2_kernel_backward_kernel(
                ...
                AT_DISPATCH_FLOATING_TYPES_AND_HALF(x1.scalar_type(), "_additive_chi2_kernel_backward_cuda", ([&] {
                    ...
                    TORCHPAIRWISE_DISPATCH_INDEX_TYPE_DEVICE(n_kernels, CUDA, ([&] {
                        ...
                        impl::_additive_chi2_kernel_backward_x1_kernel_impl<scalar_t, index_t><<<blocks, threads>>>(
                                n_kernels,
                    ...
                    TORCHPAIRWISE_DISPATCH_INDEX_TYPE_DEVICE(n_kernels, CUDA, ([&] {
                        ...
                        impl::_additive_chi2_kernel_backward_x2_kernel_impl<scalar_t, index_t><<<blocks, threads>>>(
                                n_kernels,
                                grad_output_c.generic_packed_accessor<scalar_t, 3, at::RestrictPtrTraits, index_t>(),
                                x1_c.generic_packed_accessor<scalar_t, 3, at::RestrictPtrTraits, index_t>(),
                                x2_c.generic_packed_accessor<scalar_t, 3, at::RestrictPtrTraits, index_t>(),
