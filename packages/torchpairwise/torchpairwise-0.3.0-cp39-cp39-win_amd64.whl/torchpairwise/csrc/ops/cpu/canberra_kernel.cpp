    ...
    namespace ops {
        namespace {
            namespace impl {
                ...
                void _canberra_forward_kernel_impl(
                        index_t n_kernels,
            ...
            at::Tensor _canberra_forward_kernel(
                ...
                AT_DISPATCH_FLOATING_TYPES_AND_HALF(x1.scalar_type(), "_canberra_forward_cpu", ([&] {
                    TORCHPAIRWISE_DISPATCH_INDEX_TYPE_DEVICE(n_kernels, CPU, ([&] {
                        auto output_accessor =
                                output.accessor<scalar_t, 3>();
                        impl::_canberra_forward_kernel_impl<scalar_t, index_t>(
                                n_kernels,
            ...
            namespace impl {
                template<typename scalar_t, typename index_t>
                void _canberra_backward_x1_kernel_impl(
                        index_t n_kernels,
                ...
                template<typename scalar_t, typename index_t>
                void _canberra_backward_x2_kernel_impl(
                        index_t n_kernels,
                        const at::TensorAccessor<scalar_t, 3> grad_output,
                        const at::TensorAccessor<scalar_t, 3> x1,
                        const at::TensorAccessor<scalar_t, 3> x2,
            ...
            std::tuple<at::Tensor, at::Tensor> _canberra_backward_kernel(
                ...
                AT_DISPATCH_FLOATING_TYPES_AND_HALF(x1.scalar_type(), "_canberra_backward_cpu", ([&] {
                    n_kernels = x1_c.numel();
                    TORCHPAIRWISE_DISPATCH_INDEX_TYPE_DEVICE(n_kernels, CPU, ([&] {
                        auto grad_x1_accessor =
                                grad_x1.accessor<scalar_t, 3>();
                        impl::_canberra_backward_x1_kernel_impl<scalar_t, index_t>(
                                n_kernels,
                    ...
                    TORCHPAIRWISE_DISPATCH_INDEX_TYPE_DEVICE(n_kernels, CPU, ([&] {
                        ...
                        impl::_canberra_backward_x2_kernel_impl<scalar_t, index_t>(
                                n_kernels,
                                grad_output_c.accessor<scalar_t, 3>(),
                                x1_c.accessor<scalar_t, 3>(),
                                x2_c.accessor<scalar_t, 3>(),
