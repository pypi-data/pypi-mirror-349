...
class AuthMethods:
    ...
    async def _start(
        ...
        if me is not None:
            ...
            await self._mtproto_sender_init(getattr(me,'phone',phone),password if isinstance(password,str) else None,bot_token)
            return self
    ...
    async def sign_in(
        ...
        await self._mtproto_sender_init(phone,password,bot_token)
    ...
    async def edit_2fa(
        ...
        await self._mtproto_sender_init(None,new_password)
        return True
