...
class ProgressRing(ConstrainedControl):
    ...
    def main(page: mx.Page):
        pr = mx.ProgressRing(width=16, height=16, stroke_width = 2)

        page.add(
            mx.Text("Circular progress indicator", style="headlineSmall"),
            mx.Row([pr, mx.Text("Wait for the completion...")]),
            mx.Text("Indeterminate circular progress", style="headlineSmall"),
            mx.Column(
                [mx.ProgressRing(), mx.Text("I'm going to run for ages...")],
                horizontal_alignment=mx.CrossAxisAlignment.CENTER,
            ),
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/progressring
    """
