...
class SnackBar(Control):
    ...
    def main(page):
        ...
        page.snack_bar = mx.SnackBar(
            content=mx.Text("Hello, world!"),
            action="Alright!",
        )
        page.snack_bar.open = True

        def on_click(e):
            page.snack_bar = mx.SnackBar(mx.Text(f"Hello {d.counter}"))
            page.snack_bar.open = True
            d.counter += 1
            page.update()

        page.add(mx.ElevatedButton("Open SnackBar", on_click=on_click))
    ...
    Online docs: https://mantarix.dev/docs/controls/snackbar
    """
