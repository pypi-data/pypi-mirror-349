...
class BottomSheet(Control):
    ...
    def main(page: mx.Page):
        ...
        def handle_dismissal(e):
            page.add(mx.Text("Bottom sheet dismissed"))
        bs = mx.BottomSheet(
            ...
            content=mx.Container(
                ...
                content=mx.Column(
                    tight=True,
                    controls=[
                        mx.Text("This is bottom sheet's content!"),
                        mx.ElevatedButton("Close bottom sheet", on_click=lambda _: page.close(bs)),
                    ],
                ),
            ),
        )
        page.add(mx.ElevatedButton("Display bottom sheet", on_click=lambda _: page.open(bs)))
    ...
    Online docs: https://mantarix.dev/docs/controls/bottomsheet
    """
