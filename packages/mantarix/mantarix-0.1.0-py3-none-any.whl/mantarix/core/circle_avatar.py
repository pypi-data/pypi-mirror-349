...
class CircleAvatar(ConstrainedControl):
    ...
    def main(page):
        ...
        a3 = mx.CircleAvatar(
            content=mx.Icon(mx.icons.ABC),
        )
        # avatar with icon and custom colors
        a4 = mx.CircleAvatar(
            content=mx.Icon(mx.icons.WARNING_ROUNDED),
            color=mx.colors.YELLOW_200,
            bgcolor=mx.colors.AMBER_700,
        )
        ...
        a5 = mx.Stack(
            [
                ...
                mx.Container(
                    content=mx.CircleAvatar(bgcolor=mx.colors.GREEN, radius=5),
                    alignment=mx.alignment.bottom_left,
                ),
            ],
            width=40,
            height=40,
    ...
    Online docs: https://mantarix.dev/docs/controls/circleavatar
    """
