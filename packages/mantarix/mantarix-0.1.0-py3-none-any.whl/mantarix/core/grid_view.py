...
class GridView(ConstrainedControl, ScrollableControl, AdaptiveControl):
    ...
    def main(page: mx.Page):
        ...
        page.theme_mode = mx.ThemeMode.DARK
        page.padding = 50
        page.update()
        ...
        for i in range(0, 60):
            images.controls.append(
                mx.Image(
                    ...
                    fit=mx.ImageFit.NONE,
                    repeat=mx.ImageRepeat.NO_REPEAT,
                    border_radius=mx.border_radius.all(10),
                )
            )
        page.update()
    ...
    Online docs: https://mantarix.dev/docs/controls/gridview
    """
