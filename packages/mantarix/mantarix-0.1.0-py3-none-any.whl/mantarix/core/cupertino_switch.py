...
class CupertinoSwitch(ConstrainedControl):
    ...
    def main(page: mx.Page):
        page.add(
            mx.CupertinoSwitch(label="Cupertino Switch", value=True),
            mx.Switch(label="Material Checkbox", value=True),
            mx.Container(height=20),
            mx.Text(
                "Adaptive Switch shows as CupertinoSwitch on macOS and iOS and as Switch on other platforms:"
            ),
            mx.Switch(adaptive=True, label="Adaptive Switch", value=True),
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/cupertinoswitch
    """
