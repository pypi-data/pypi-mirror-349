...
class CupertinoListTile(ConstrainedControl):
    ...
    def main(page: mx.Page):
        ...
        page.add(
            mx.CupertinoListTile(
                notched=True,
                additional_info=mx.Text("Wed Jan 25"),
                bgcolor_activated=mx.colors.AMBER_ACCENT,
                leading=mx.Icon(name=mx.cupertino_icons.GAME_CONTROLLER),
                title=mx.Text("CupertinoListTile not notched"),
                subtitle=mx.Text("Subtitle"),
                trailing=mx.Icon(name=mx.cupertino_icons.ALARM),
    ...
    Online docs: https://mantarix.dev/docs/controls/cupertinolisttile
    """
