...
class ProgressBar(ConstrainedControl):
    ...
    def main(page: mx.Page):
        pb = mx.ProgressBar(width=400)

        page.add(
            mx.Text("Linear progress indicator", style="headlineSmall"),
            mx.Column([ mx.Text("Doing something..."), pb]),
            mx.Text("Indeterminate progress bar", style="headlineSmall"),
            mx.ProgressBar(width=400, color="amber", bgcolor="#eeeeee"),
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/progressbar
    """
