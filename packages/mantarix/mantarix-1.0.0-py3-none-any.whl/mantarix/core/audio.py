...
class Audio(Control):
    ...
    def main(page: mx.Page):
        ...
        page.add(
            mx.Text("This is an app with background audio."),
            mx.ElevatedButton("Stop playing", on_click=lambda _: audio1.pause()),
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/audio
    """
