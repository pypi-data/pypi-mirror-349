...
from mantarix.core.text_style import TextOverflow, TextStyle, TextThemeStyle
...
class Text(ConstrainedControl):
    ...
    def main(page: mx.Page):
        ...
        page.add(
            mx.Text("Size 10", size=10),
            mx.Text("Size 30, Italic", size=20, color="pink600", italic=True),
            mx.Text("Limit long text to 2 lines and fading", style=mx.TextThemeStyle.HEADLINE_SMALL),
            mx.Text(
    ...
    Online docs: https://mantarix.dev/docs/controls/text
    """
