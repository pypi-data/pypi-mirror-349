...
class RangeSlider(ConstrainedControl):
    ...
    def main(page: mx.Page):
        range_slider = mx.RangeSlider(
            min=0,
            max=50,
            start_value=10,
            divisions=10,
            end_value=20,
            inactive_color=mx.colors.GREEN_300,
            active_color=mx.colors.GREEN_700,
            overlay_color=mx.colors.GREEN_100,
        ...
        page.add(
            mx.Column(
                ...
                controls=[
                    mx.Text("Range slider", size=20, weight=mx.FontWeight.BOLD),
                    range_slider,
                ],
            )
        )
    ...
    Online docs: https://mantarix.dev/docs/controls/rangeslider
    """
