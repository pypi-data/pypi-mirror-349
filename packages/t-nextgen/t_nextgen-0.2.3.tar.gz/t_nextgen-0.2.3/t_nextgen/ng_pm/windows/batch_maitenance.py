...
class BatchMaintenanceWindow(NextGenWindow):
    ...
    def update_total_billed_header(self, ledger_billed: str) -> None:
        ...
        self.desktop_app.set_text(self.window.child_window(auto_id="txtTotBilled"), str(ledger_billed))
    ...
    def update_total_allowed_header(self, ledger_allowed: str) -> None:
        ...
        self.desktop_app.set_text(self.window.child_window(auto_id="txtTotApproved"), str(ledger_allowed))
    ...
    def update_total_paid_header(self, ledger_payment: str) -> None:
        ...
        self.desktop_app.set_text(self.window.child_window(auto_id="txtTotPaid"), str(ledger_payment))
    ...
    def update_batch_desc(self, text: str) -> None:
        ...
        self.desktop_app.set_text(self.window.child_window(auto_id="txtDesc"), text)
    ...
    def update_process_date(self, date_to_update: str) -> None:
        ...
        self.desktop_app.set_text(
            self.window.child_window(auto_id="txtProcessDate").child_window(auto_id="mtxtDate"), date_to_update
        )
    ...
    def update_total_adjustment(self, total_adjustment: str) -> None:
        ...
        self.desktop_app.set_text(self.window.child_window(auto_id="txtTotAdjusted"), total_adjustment)
