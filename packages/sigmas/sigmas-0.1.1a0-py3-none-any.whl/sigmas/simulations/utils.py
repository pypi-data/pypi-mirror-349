...
def get_scopesim_inst_pkgs_path():
    ...
    #else:
    #    home_dir = Path.home()
    #    user_data_dir = home_dir / ".sigmas" / "inst_pkgs"
    #    os.mkdir(user_data_dir)
    #    return os.path.abspath(user_data_dir)
    
    #Temporary workaround, it will install the pkgs in the current directory
    #but at least won't do so again if rerunning simulations
    current_dir = os.getcwd()
    pkg_dir = os.path.join(current_dir, "inst_pkgs")
