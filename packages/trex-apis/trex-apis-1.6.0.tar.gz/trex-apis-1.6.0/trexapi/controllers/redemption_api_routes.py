...
from trexmodel.models.datastore.reward_models import CustomerEntitledReward,\
    CustomerPointReward
        ...
        with db_client.context():
            ...
            if redemption_catalogue and redemption_catalogue.is_effectived and redemption_catalogue.is_expired==False:
                ...
                if customer_merchant_acct.key_in_str ==redemption_catalogue_merchant_acct.key_in_str: 
                    ...
                    customer = _giveaway_redemption_catalogue_item_to_partner_customer_and_transfer_reward_to_partner_customer(
...
def _giveaway_redemption_catalogue_item_to_partner_customer_and_transfer_reward_to_partner_customer(
    ...
    if hq_outlet is None:
        ...
        if redeem_item_details:
            ...
            if partner_customer is not None:
                ...
                logger.info('Partner customer point reward have been created and redeemed, customer_reward_summary=%s', partner_customer.reward_summary)
                
                giveaway_redeem_catalogue_item(partner_customer, redeem_item_details, redeem_reward_format, 
                                                       redemption_catalogue_key, voucher_key,
                ...
                CustomerRedemption.create(merchant_customer, 
                                    reward_format                           = redeem_reward_format,
                                    redeemed_amount                         = redeem_reward_amount,
                                    redeemed_datetime                       = transact_datetime, 
                                    is_partnership_redemption               = True,
                                    is_allow_to_revert                      = False,
                                    )
                
                PartnershipRewardTransaction.create(merchant_acct, partner_merchant_acct, user_acct, redeem_reward_amount)
