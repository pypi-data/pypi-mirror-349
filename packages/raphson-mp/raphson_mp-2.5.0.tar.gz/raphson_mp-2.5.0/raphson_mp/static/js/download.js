import { jsonPost, formatLargeNumber } from "./util.js";

async function performSearch() {
    const searchQuery = /** @type {HTMLInputElement} */ (document.getElementById('search-query'));
    ...
    downloadButton.addEventListener('click', async () => {
        ...
        try {
            ...
            await reader.read().then(function process(result) {
                if (result.done) {
                    console.debug("download: stream done");
