...
class NetworkApplicationEnumerateDetails_EnumerateSshDetails(UniversalBaseModel):
...
class NetworkApplicationEnumerateDetails_EnumerateFtpDetails(UniversalBaseModel):
...
class NetworkApplicationEnumerateDetails_EnumerateSmtpDetails(UniversalBaseModel):
...
class NetworkApplicationEnumerateDetails_EnumerateGrpcDetails(UniversalBaseModel):
