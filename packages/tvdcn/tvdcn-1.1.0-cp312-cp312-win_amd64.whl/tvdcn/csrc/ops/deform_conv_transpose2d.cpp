...
namespace tvdcn {
    namespace ops {
        ...
        at::Tensor deform_conv_transpose2d_symint(
                const at::Tensor &input,
                const at::Tensor &weight,
                const at::optional<at::Tensor> &offset,
                const at::optional<at::Tensor> &mask,
            ...
            static auto op = c10::Dispatcher::singleton()
                    .findSchemaOrThrow("tvdcn::deform_conv_transpose2d", "")
                    .typed<decltype(deform_conv_transpose2d_symint)>();
            return op.call(
                    input,
                    weight,
                    offset,
        ...
        namespace detail {
            ...
            std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor>
            _deform_conv_transpose2d_backward_symint(
                    const at::Tensor &grad_out,
                    const at::Tensor &input,
                    const at::Tensor &weight,
                    const at::optional<at::Tensor> &offset,
                ...
                static auto op = c10::Dispatcher::singleton()
                        .findSchemaOrThrow("tvdcn::_deform_conv_transpose2d_backward", "")
                        .typed<decltype(_deform_conv_transpose2d_backward_symint)>();
                return op.call(
                        grad_out,
                        input,
                        weight,
        ...
        TORCH_LIBRARY_FRAGMENT(tvdcn, m) {
            m.def(TORCH_SELECTIVE_SCHEMA(
                          ...
                          "SymInt[2] stride=1, SymInt[2] padding=0, SymInt[2] output_padding=0, "
                          "SymInt[2] dilation=1, SymInt groups=1) -> Tensor"));
            m.def(TORCH_SELECTIVE_SCHEMA(
                          "tvdcn::_deform_conv_transpose2d_backward(Tensor grad, Tensor input, Tensor weight, "
                          "Tensor? offset=None, Tensor? mask=None, Tensor? bias=None, "
                          "SymInt[2] stride=1, SymInt[2] padding=0, SymInt[2] output_padding=0, "
                          "SymInt[2] dilation=1, SymInt groups=1) -> (Tensor, Tensor, Tensor, Tensor, Tensor)"));
        }
    }
}
