...
from ncp_dataquery.types import NamedRowTuple
from ncp_dataquery.types import POWERS_OF_TEN
from ncp_dataquery.types import Time
from ncp_dataquery.types import Timestamp
from ncp_dataquery.types import TimestampWithTimeZone
from ncp_dataquery.types import TimeWithTimeZone
...
class IntervalDayToSecondMapper(ValueMapper[timedelta]):
    def map(self, value: Any) -> Optional[timedelta]:
        ...
        try:
            ...
            raise ncp_dataquery.exceptions.TrinoDataError(error_str) from e
