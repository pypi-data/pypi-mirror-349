...
if __name__ == "__main__":
    ...
    import scanpy as sc
    # Load data
    adata = sc.read_h5ad("/Users/natapolpornputtapong/Projects/scGPT/test/Kim2020_Lung.h5ad")
    # verify gene col
    ...
    r_embed_data(
        ...
        genes = genes,
        model_dir = "/Users/natapolpornputtapong/Projects/scGPT/test/scGPT_human",
        max_length=1200,
        batch_size=64,
        use_batch_id=False,
        obs_to_save=None,
