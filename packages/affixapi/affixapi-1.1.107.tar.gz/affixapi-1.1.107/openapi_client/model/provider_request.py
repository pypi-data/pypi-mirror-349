...
class ProviderRequest(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["sandbox", "bamboohr", "breathe", "cezanne", "charliehr", "deel", "deputy", "hailyhr", "hibob", "humaans", "iris cascade", "moorepay", "nmbrs", "parolla.ie", "payfit", "personio.de", "planday", "sagehr", "saplinghr", "staffology", "xero uk", "brain payroll", "brightpay connect", "employment hero", "factorialhr", "fourthhr", "gusto", "itrent", "justworks", "kontek.se", "onpay", "oysterhr", "paycircle", "pento.io", "peoplehr", "remote.com", "sageone", "shape payroll", "simplepay.ie", "quickbooks online", "zoho", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["sandbox", "bamboohr", "breathe", "cezanne", "charliehr", "deel", "deputy", "hailyhr", "hibob", "humaans", "iris cascade", "moorepay", "nmbrs", "parolla.ie", "payfit", "personio.de", "planday", "sagehr", "saplinghr", "staffology", "xero uk", "brain payroll", "brightpay connect", "employment hero", "factorialhr", "fourthhr", "gusto", "itrent", "justworks", "kontek.se", "onpay", "oysterhr", "paycircle", "pento.io", "peoplehr", "remote.com", "sageone", "shape payroll", "simplepay.ie", "quickbooks online", "zoho", ]  # noqa: E501
