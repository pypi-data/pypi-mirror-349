...
ScreenableType = Union[
    models.Screenable, models.Ephemeris, models.Catalog, prop_models.Propagation
]

ScreenableObject = Union[models.Ephemeris, models.Catalog, prop_models.Propagation]
...
class ScreeningClient:
    ...
    def list_screenings(
        ...
        :return: The retrieved collection of resources.
        :rtype: Collection[models.Screenings]
        """
    ...
    def list_conjunctions(
        ...
        if screening_id is not None:
            path = urljoin(settings.satcat_rest_api_url, f"screenings/{screening_id}/conjunctions")
        else:
    ...
    def list_screening_primaries(
        ...
        """
        path = urljoin(settings.satcat_rest_api_url, f"screenings/{screening_id}/primaries")
        items = self.client.request_list(
            path,
            filters=filters,
            count=count,
    ...
    def list_screening_secondaries(
        ...
        :rtype: Collection[models.Screenable]
        """
        path = urljoin(settings.satcat_rest_api_url, f"screenings/{screening_id}/secondaries")
        items = self.client.request_list(
            path,
            filters=filters,
            count=count,
    ...
    def add_screening_primary(
        ...
        path = urljoin(settings.satcat_rest_api_url, f"screenings/{screening.id}/primaries")
    ...
    def add_screening_secondary(
        ...
        path = urljoin(settings.satcat_rest_api_url, f"screenings/{screening.id}/secondaries")
        res = self.client.request(path, method="POST", json=data)
        return models.Screenable.parse_obj(res.json())
    ...
    def submit_screening(self, screening: models.Screening) -> models.Screening:
        ...
        :rtype: models.Screening
        """
        path = urljoin(settings.satcat_rest_api_url, f"screenings/{screening.id}/submit")
    ...
    def list_conjunctions_ccsds(
        ...
        """
        path = urljoin(settings.satcat_rest_api_url, f"screenings/{screening_id}/results/ccsds")
        items = self.client.request_list(
            path,
            filters=filters,
            count=count,
