...
class PersonLinkType(BaseModel):
    """
    Navázaný objekt
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="identifikátor uuid")
    code: Optional[StrictStr] = Field(default=None, description="Kód navázaného subjektu")
    name: Optional[StrictStr] = Field(default=None, description="Název navázaného subjektu")
    link_type: Optional[StrictStr] = Field(default=None, description="Typ vazby")


class PersonEntryType(BaseModel):
    """
    Položka subjektu v kontextu
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="identifikátor uuid")
    person_type: Optional[PersonTypeEnum] = Field(default=None, description='Typ osoby (zdroj CRŽP)')
    name: Optional[StrictStr] = Field(default=None, description="Název nebo jméno osoby")
    is_admin: Optional[StrictBool] = Field(default=False, description="Je uživatel administrátorem?")
    membership: Optional[StrictStr] = Field(default=None, description="Typ členství (admin/representative/employee)")
    tags: Optional[TagType] = Field(default=None, description="Seznam tagů objektu")


class PersonListType(ListTypeBase):
    """
    Seznam vrácených subjektů
    """ # noqa: E501
    hits: Optional[StrictInt] = Field(default=None, description="celkový počet vybraných položek")
    entries: Optional[List[Optional[PersonEntryType]]] = Field(default=None, description='Položky seznamu')
...
class PersonBaseType(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Kód subjektu")
    ico: Optional[StrictStr] = Field(default=None, description="Jiný identifikátor")
    birthdate: Optional[datetime] = Field(default=None, description="Datum narození")
    person_type: Optional[PersonTypeEnum] = Field(default=None, description='Typ osoby (zdroj CRŽP)')
    name: Optional[StrictStr] = Field(default=None, description="Název nebo jméno osoby")
    full_name: Optional[StrictStr] = Field(default=None, description="Plné jméno. U fyzických osob včetně titulů")
    ...
    address_printable: Optional[StrictStr] = Field(default=None, description="Adresa pro tisk")
...
class PersonType(PersonBaseType):
    """
    Osoba, subjekt. Fyzická nebo právnická osoba.
    """
    identifier: Optional[StrictStr] = Field(default=None, description="identifikátor uuid")
    pid: Optional[StrictStr] = Field(default=None, description="identifikátor PID")
    registry: Optional[RegistryType] = Field(default=None, description='Reference na identifikační údaje')
    admins: Optional[List[StrictStr]] = Field(default=None, description="Správci subjektu")
    members: Optional[List[Optional[MemberType]]] = Field(default=None, description="Členové subjektu")
    linked_persons: Optional[List[Optional[PersonLinkType]]] = Field(default=None, description="Vazba na jiný subjekt")
