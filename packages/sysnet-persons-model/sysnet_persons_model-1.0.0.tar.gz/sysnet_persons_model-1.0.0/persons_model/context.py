...
from persons_model.person import PersonEntryType
...
class ContextPersonsType(BaseModel):
    ...
    admin: Optional[List[Optional[PersonEntryType]]] = Field(default=[], description='Tyto subjekty uživatel spravuje')
