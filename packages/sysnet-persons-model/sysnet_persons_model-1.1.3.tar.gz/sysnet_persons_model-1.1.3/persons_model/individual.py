...
class IndividualBaseType(BaseModel):
    ...
    """
    name: Optional[StrictStr] = Field(default=None, description="Jméno osoby pro zobrazení")
    username: Optional[StrictStr] = Field(default=None, description="Uživatelské jméno osoby")
    dn: Optional[StrictStr] = Field(default=None, description="LDAP distinguished name")
    ...
    contact_default: Optional[StrictInt] = Field(default=0, description="Primární kontaktní údaje")
    address: Optional[List[Optional[LocationType]]] = Field(default=None, description='Seznam adres')
    address_default: Optional[StrictInt] = Field(default=0, description="Primární adresní údaje")
