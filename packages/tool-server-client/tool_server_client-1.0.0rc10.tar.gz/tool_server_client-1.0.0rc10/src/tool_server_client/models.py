...
class FileOperationRequest(MBaseModel):
    ...
    paths: Optional[List[str]] = Field(None, description="paths", alias="Paths")
    ...
    src: Optional[str] = Field(None, description="src", alias="Src") # For move/copy
    dst: Optional[str] = Field(None, description="dst", alias="Dst") # For move/copy
    pattern: Optional[str] = Field(None, description="pattern", alias="Pattern") # For search
