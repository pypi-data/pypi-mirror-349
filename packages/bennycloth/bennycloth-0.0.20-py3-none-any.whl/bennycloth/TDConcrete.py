...
def CreepModelCode2010(fcm,h0,t0,t,**kwargs):
    ...
    h0 - nominal thickness (mm), h0 = 2*A/O where A = section area, O = section circumference
    t0 - loading age (days)
...
if __name__ == '__main__':
    ...
    shrinkage = ShrinkageACI209R(45.7,39,ts,1007)
    creep = CreepACI209R(45.7,39,t0,1007)
    ...
    shrinkage = ShrinkageModelCode2010(fc,150,14,10000)
    #print(shrinkage)

    creep = CreepModelCode2010(45.7,77.8,7,357)
    creep = CreepModelCode2010(fc,150,28,10000)
    print(creep)    
