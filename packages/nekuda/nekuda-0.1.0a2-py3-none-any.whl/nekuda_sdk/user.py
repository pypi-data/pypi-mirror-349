...
Nekuda SDK call.  Returned by :py:meth:`nekuda_sdk.NekudaClient.user`.
"""
...
class UserContext:  # noqa: D101 – docstring below
    """A thin immutable wrapper around :class:`~nekuda_sdk.NekudaClient` that
    ...
    # ------------------------------------------------------------------
    def create_mandate(self, mandate: MandateData, *, request_id: str | None = None) -> Dict[str, Any]:
        """Create a mandate for this user.

        Parameters
        ----------
        mandate:
            The :class:`~nekuda_sdk.models.MandateData` describing the purchase
            intent.
        request_id:
