...
from pilot_probing.models import PromptVersion
import uuid

from pilot_probing.tracking import run_manager
...
def mock_config():
    ...
    with patch('pilot_probing.config.get_config', return_value=test_config):
        with patch('pilot_probing.http_client.get_config', return_value=test_config):
            yield test_config
