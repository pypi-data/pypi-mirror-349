...
from pilot_probing.prompt import get_prompt, render, templateCache
...
class TestGetTemplate:
    ...
    def test_get_template_no_api_key(self, mock_config, monkeypatch):
        ...
        monkeypatch.setattr('pilot_probing.prompt.get_http_client', lambda: mock_client)
    ...
    def test_get_template_local_debug(self, mock_config, mock_requests_post, sample_prompt_version_dict):
        ...
        assert 'X-Top-Account-Id' in headers
        assert 'X-Top-User-Id' in headers
