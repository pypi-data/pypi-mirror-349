...
from pilot_probing.consumer import Consumer
...
class TestConsumer:
    ...
    def mock_config(self):
        ...
        with patch('pilot_probing.consumer.get_config') as mock_get_config:
            config = MagicMock()
    ...
    def test_consumer_initialization(self, mock_event_queue):
        ...
        with patch('pilot_probing.consumer.atexit.register') as mock_register:
    ...
    def test_send_batch_with_local_debug(self, mock_event_queue, mock_config, sample_events):
        ...
        with patch('requests.post') as mock_post:
            ...
            assert 'X-Top-Account-Id' in kwargs['headers']
            assert 'X-Top-User-Id' in kwargs['headers']
