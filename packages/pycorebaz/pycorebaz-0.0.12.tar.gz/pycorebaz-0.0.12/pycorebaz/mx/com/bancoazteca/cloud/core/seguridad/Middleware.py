...
from pycorebaz.mx.com.bancoazteca.cloud.configuracion.Configuracion import origins
from pycorebaz.mx.com.bancoazteca.cloud.core.utilerias.Constantes import SELF
