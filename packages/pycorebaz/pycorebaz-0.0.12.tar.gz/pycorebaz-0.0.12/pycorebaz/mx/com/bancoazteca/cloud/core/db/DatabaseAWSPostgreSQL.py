...
# from pycorebaz.mx.com.bancoazteca.cloud.core.models.DB import DB # Podrías adaptarlo o quitarlo si la clase es solo para PG
from pycorebaz.mx.com.bancoazteca.cloud.core.models.Daos import Daos
from pycorebaz.mx.com.bancoazteca.cloud.core.models.TipoConsulta import TipoConsulta


class DatabaseAWSPostgreSQL(object):
    '''
        Proyecto: pycorebaz (Adaptado para PostgreSQL)
