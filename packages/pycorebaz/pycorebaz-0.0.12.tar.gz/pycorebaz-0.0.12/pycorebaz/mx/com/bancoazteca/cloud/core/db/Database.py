...
from pycorebaz.mx.com.bancoazteca.cloud.configuracion.Configuracion import db_usr, db_paw, db_url
from pycorebaz.mx.com.bancoazteca.cloud.core.models.DB import DB
