...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_href=None, base_path=None, base_url=None, name=None, pulp_labels=None, hidden=False, pulp_created=None, local_vars_configuration=None):  # noqa: E501
