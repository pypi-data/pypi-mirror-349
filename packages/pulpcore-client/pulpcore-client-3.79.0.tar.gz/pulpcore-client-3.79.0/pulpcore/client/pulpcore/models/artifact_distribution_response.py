...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "base_path", "pulp_labels", "hidden", "pulp_href", "pulp_created", "base_url", "pulp_last_updated", "no_content_change_since", "content_guard", "prn"]
