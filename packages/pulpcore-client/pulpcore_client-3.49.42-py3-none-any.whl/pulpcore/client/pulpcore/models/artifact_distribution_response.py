...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_labels=None, base_path=None, content_guard=None, hidden=False, name=None, pulp_href=None, base_url=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
