...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_href=None, hidden=False, pulp_labels=None, content_guard=None, pulp_created=None, base_url=None, name=None, local_vars_configuration=None):  # noqa: E501
