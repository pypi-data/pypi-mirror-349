...
from crud_tools.crud_admin_registry import CrudAdminRegistry
...
def get_sqlalchemy_models(module_name: str) -> List[Type[DeclarativeMeta]]:
...
def get_admin_model_status(module_name: str) -> List[Dict[str, str]]:
    ...
    for model in models:
        from plugins.crud_tools.router.crud import get_admin_instance
