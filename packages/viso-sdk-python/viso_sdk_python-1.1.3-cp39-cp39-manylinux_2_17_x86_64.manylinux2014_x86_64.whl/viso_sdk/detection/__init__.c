...
#define __pyx_kp_u_viso_sdk_detection___init __pyx_string_tab[7]
...
__Pyx_RefNannySetupContext("PyInit_detection", 0);
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_viso_sdk_detection___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_viso_sdk_detection___init, sizeof(__pyx_k_viso_sdk_detection___init), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_viso_sdk_detection___init */
  {0, 0, 0, 0, 0}
};
/* InitStrings.proto */
