...
#   timestamp: 2025-05-14T18:14:50+00:00
...
class V1ArchiveSubaccountBalanceGetParametersQuery(BaseModel):
    ...
    end_time: Optional[float] = Field("2025-05-14T06:49:10.356Z", alias="endTime")
...
class V1ArchiveSubaccountUnrealizedPnlGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-05-14T06:49:10.359Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy7] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: str = Field(..., alias="subaccountId")
...
class V1ArchiveSubaccountVolumeGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-05-14T06:49:10.362Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy7] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: str = Field(..., alias="subaccountId")
