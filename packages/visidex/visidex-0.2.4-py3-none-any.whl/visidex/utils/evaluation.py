...
def print_results_table(all_results):
    ...
    for result in all_results:
        ...
        table.add_row([
            ...
            params['distance'],
            params['threshold'],
            generate_metrics_output(TP=matches["TP"], FP=matches["FP"], FN=matches["FN"], TN=matches["TN"]),
            generate_metrics_output(TP=scores["TP"], FP=scores["FP"], FN=scores["FN"], TN=scores["TN"])
        ])
