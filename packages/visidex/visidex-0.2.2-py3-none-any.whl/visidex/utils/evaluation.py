...
def print_results_table(all_results):
    ...
    for result in all_results:
        ...
        SUM_MTP, SUM_MFP, SUM_MFN, SUM_MTN = result['matches']
        SUM_STP, SUM_SFP, SUM_SFN, SUM_STN = result['scores']
        ...
        table.add_row([
            ...
            params['distance'],
            params['threshold'],
            generate_metrics_output(SUM_MTP, SUM_MFP, SUM_MFN, SUM_MTN),
            generate_metrics_output(SUM_STP, SUM_SFP, SUM_SFN, SUM_STN)
        ])
