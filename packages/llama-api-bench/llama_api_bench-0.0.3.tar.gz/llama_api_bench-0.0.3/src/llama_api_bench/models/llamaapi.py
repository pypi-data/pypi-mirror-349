...
LLAMA_API_MODEL_CONFIGS: list[ModelConfig] = [
    ...
    ModelConfig(model="Cerebras-Llama-3.3-70B-Instruct", unsupported_test_cases=["vision"]),
    ModelConfig(model="Groq-Llama-4-Maverick-17B-128E-Instruct", unsupported_test_cases=["vision"]),
    ModelConfig(model="Groq-Llama-3.3-70B-Instruct", unsupported_test_cases=["structured_output", "vision"]),
]
