...
class Vector3:
    ...
    def __init__(self, list: list[float]) -> None: ...
    @classmethod
    def DefaultOffset(cls) -> Vector3: ...
    @classmethod
    def DefaultScale(cls) -> Vector3: ...
    def _pybind11_conduit_v1_(self, *args, **kwargs) -> Any: ...
    @overload
...
class VoxelKey:
    ...
    @classmethod
    def GetResolutionAtDepth(cls, depth: int, las_header, copc_header) -> float: ...
    def Intersects(self, arg0, arg1) -> bool: ...
    @classmethod
    def InvalidKey(cls) -> VoxelKey: ...
    def IsValid(self) -> bool: ...
    def Resolution(self, las_header, copc_header) -> float: ...
    @classmethod
    def RootKey(cls) -> VoxelKey: ...
