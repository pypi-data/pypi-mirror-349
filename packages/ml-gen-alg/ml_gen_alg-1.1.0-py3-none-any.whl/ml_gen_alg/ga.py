...
def plot_fitness_evolution(self):
    if not hasattr(self, "fitness_history") or len(self.fitness_history) == 0:
        print("⚠️ No hay historial de fitness para graficar. Asegúrate de ejecutar `genetic_algorithm()` primero.")
        return

    plt.figure(figsize=(10, 6))
    plt.plot(range(len(self.fitness_history)), self.fitness_history, marker='o', linestyle='-')
