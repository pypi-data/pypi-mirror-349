from .schema import ModelRateLimit
...
DEFAULT_RATE_LIMITS: RateLimitConfig = [
    ...
    ModelRateLimit(model_names=["gemini/gemini-2.0-flash-lite"], rpm=4000, tpm=4_000_000),
    ModelRateLimit(model_names=["gemini/gemini-2.0-flash"], rpm=2000, tpm=4_000_000),
    ModelRateLimit(model_names=["gemini/gemini-2.5-pro-preview-03-25"], rpm=150, tpm=2_000_000),
    ModelRateLimit(model_names=["gemini/gemini-2.5-flash-preview-04-17"], rpm=1000, tpm=1_000_000),
    # XAI Models
