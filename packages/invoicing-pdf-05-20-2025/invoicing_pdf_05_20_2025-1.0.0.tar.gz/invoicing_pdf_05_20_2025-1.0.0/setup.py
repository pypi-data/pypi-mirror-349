...
setup(
    name='invoicing-pdf-05-20-2025',  #* Your package will have this name
    ...
    author='Amanda Hancock',  # Your name
    author_email='your.email@example.com',  # Your email
    url='https://github.com/amahan500/app20-python-package.git',  # Homepage of your library (e.g. github or your website)
