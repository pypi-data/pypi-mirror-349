...
class WebSapCommonFunctions:
    ...
    def check_login_error(self, by: By = By.CSS_SELECTOR):
        ...
        while True:
            sleep(2)
            try:
                self.browser.find_element(by, ERROR_ICON_CSS_SELECTOR)
            except NoSuchElementException:
                try:
                    self.switch_iframe([IFRAME_CSS_SELECTOR])
                    sleep(1)
                    self.browser.find_element(by, LOGIN_CONTINUE_BUTTON_CSS_SELECTOR)
                except NoSuchElementException:
                    try:
                        self.browser.find_element(by, MAIN_PAGE_HEADER_CSS_SELECTOR)
                    except NoSuchElementException:
                        pass
                    else:
                        return True
                    ...
                    sleep(2)
                    self.wait.until(EC.presence_of_element_located((by, MAIN_PAGE_HEADER_CSS_SELECTOR)))
                    sleep(2)
                    return True
            else:
    ...
    def login_sap_with_password(self, sap_user: str = '', sap_password: str = '', by: By = By.CSS_SELECTOR):
        ...
        while True:
            sleep(2)
            try:
                self.browser.find_element(by, USERNAME_CSS_SELECTOR)
            except NoSuchElementException:
                try:
                    self.switch_iframe([IFRAME_CSS_SELECTOR])
                    sleep(1)
    ...
    def input_t_code(self, t_code: str, iframe_list=None, by: By = By.CSS_SELECTOR):
        ...
        t_code_element = self.browser.find_element(by, T_CODE_CSS_SELECTOR)
    ...
    def find_input_element_by_title(self, title: str, input_index, by: By = By.CSS_SELECTOR):
        ...
        target_input_elements = self.browser.find_elements(by, f"input[title='{title}']")
    ...
    def input_layout(self, layout: str = '', by: By = By.CSS_SELECTOR):
        ...
        Args:
            ...
            by(By): This is the By method to find element
        """
        layout_element = self.browser.find_element(by, LAYOUT_CSS_SELECTOR)
    ...
    def input_download_excel_file_name(self, file_name: str, remote_save=False, username='', password='', server_name='', share_name='', remote_folder_path='',
        ...
        if not switch_result['switchResult']:
            ...
            ok_button = self.browser.find_element(by, EXCEL_CONTINUE_CSS_SELECTOR)
            actions = ActionChains(self.browser)
            ...
            sleep(2)
            try:
                self.browser.find_element(by, EXCEL_CONTINUE_CSS_SELECTOR)
            except NoSuchElementException:
                pass
            else:
        ...
        while True:
            try:
                self.wait.until(EC.presence_of_element_located((by, EXCEL_FILE_NAME_INPUT_CSS_SELECTOR)))
                self.wait.until(EC.element_to_be_clickable((by, EXCEL_FILE_NAME_INPUT_CSS_SELECTOR)))
                sleep(1)
                self.press_keyboard_shortcut([Keys.DELETE])

                file_name_input_element = self.browser.find_element(by, EXCEL_FILE_NAME_INPUT_CSS_SELECTOR)
                actions = ActionChains(self.browser)
    ...
    def input_y01f_download_excel_file_name(self, file_name: str, remote_save=False, username='', password='', server_name='', share_name='', remote_folder_path='',
        ...
        while True:
            try:
                self.wait.until(EC.presence_of_element_located((by, Y01F_FILE_NAME_INPUT_CSS_SELECTOR)))
                self.wait.until(EC.element_to_be_clickable((by, Y01F_FILE_NAME_INPUT_CSS_SELECTOR)))
                sleep(1)

                file_name_input_element = self.browser.find_element(by, Y01F_FILE_NAME_INPUT_CSS_SELECTOR)
                actions = ActionChains(self.browser)
                actions.click(file_name_input_element)
    ...
    def determine_dynamic_selection_button_index(self, section_name: str, multi_selection_button_index: int, by: By = By.CSS_SELECTOR):
        ...
        """
        is_find = False
        div_elements = self.browser.find_elements(by,
    ...
    def input_multiple_selection(self,
        ...
        if multiple_index_check_result:
            ...
            if clear_section_data:
                self.wait.until(
                    EC.presence_of_element_located((by, DELETE_ENTIRE_SELECTION_BUTTON_CSS_SELECTOR)))
                sleep(1)
    ...
    def input_multiple_selection_with_index(self,
        ...
        multiple_selection_buttons = self.browser.find_elements(by, "div[title^='Multiple selection' i]")
        for button_index, multiple_selection_button in enumerate(multiple_selection_buttons):
            if button_index + 1 == multiple_selection_index:
                ...
                self.wait.until(EC.presence_of_element_located((by, input_css_path)))
                if clear_section_data:
                    self.wait.until(EC.presence_of_element_located((by, DELETE_ENTIRE_SELECTION_BUTTON_CSS_SELECTOR)))
                    sleep(1)
                    self.click_or_input_by_css_selector(DELETE_ENTIRE_SELECTION_BUTTON_CSS_SELECTOR, 'click')
                    sleep(2)
                # click select ranges tab
    ...
    def input_variant_multiple_selection_with_index(self,
        ...
        multiple_selection_buttons = self.browser.find_elements(by, ".urPWContentTable div[title^='Multiple selection' i]")
        for button_index, multiple_selection_button in enumerate(multiple_selection_buttons):
            if button_index + 1 == multiple_selection_index:
                # self.click_or_input_by_element(multiple_selection_button, 'click')
                self.move_to_and_click_element('', target_element=multiple_selection_button)
    ...
    def wait_multiple_selection_switch(self, tab_index: int, by: By = By.CSS_SELECTOR):
        ...
        while True:
            try:
                self.browser.find_element(by, f'td.lsTbsPanel2 div:first-child div:nth-child({tab_index}) div[aria-selected="true"]')
            except NoSuchElementException:
                try:
                    self.browser.find_element(by, f'td.lsTbsPanel2 div:first-child div[selected="true"]:nth-child({tab_index})')
                except NoSuchElementException:
                    sleep(2)
                else:
                    break
    ...
    def wait_file_upload_confirmation_dialog(self, by: By = By.CSS_SELECTOR):
        ...
        """
        sleep(1)
        self.wait.until(EC.presence_of_element_located((by, UPLOAD_CONFIRM_BUTTON_CSS_SELECTOR)))
        sleep(1)
