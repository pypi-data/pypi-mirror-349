...
class Element(db.Model):
    ...
    plm_comp_cid=db.Column(db.String(50), unique=True)
    plm_comp_cid_desc=db.Column(db.String(50))
    plm_comp_cid_parent=db.Column(db.String(50))
    plm_comp_aid=db.Column(db.String(50))
    ...
    #plm_log_cid=db.Column(db.String(50))
