...
class NoSignalCommunityManager(ecommunity.simulator.Manager):
    ...
    def __init__(self, pv_system: core.solar.PVsystem, number_of_day_interactions: int, number_of_hour_interactions: int, no_alert_threshold, randomize_ratio: int = .2, averager_depth_in_hours: int = 3) -> None:
        ...
        for house in ecommunity.irise.IRISE(pv_system.datetimes, zipcode_pattern='381%').get_houses():
