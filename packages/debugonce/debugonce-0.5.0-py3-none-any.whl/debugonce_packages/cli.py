...
def replay(session_file):
    ...
    if not os.path.exists(export_file):
        click.echo(f"Error: Exported script '{export_file}' not found. Please run 'export' first.")
        return
    ...
    try:
        ...
        click.echo(f"Error: Script execution failed with code {e.returncode}")
        click.echo(f"Error output:\n{e.stderr}")
    except FileNotFoundError:
        click.echo(f"Error: Python interpreter not found. Please ensure Python is in your PATH.")
