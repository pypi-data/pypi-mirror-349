...
class TestTask:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_suspended_payload(self, client: SampleHealthcare) -> None:
        task = client.api.v2.task.retrieve_suspended_payload(
            "taskId",
        )
        assert_matches_type(TaskRetrieveSuspendedPayloadResponse, task, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_suspended_payload(self, client: SampleHealthcare) -> None:
        response = client.api.v2.task.with_raw_response.retrieve_suspended_payload(
            "taskId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_suspended_payload(self, client: SampleHealthcare) -> None:
        with client.api.v2.task.with_streaming_response.retrieve_suspended_payload(
            "taskId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_retrieve_suspended_payload(self, client: SampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            client.api.v2.task.with_raw_response.retrieve_suspended_payload(
                "",
            )
    ...
    def test_raw_response_retry(self, client: SampleHealthcare) -> None:
        response = client.api.v2.task.with_raw_response.retry(
            "taskId",
        )
    ...
    def test_streaming_response_retry(self, client: SampleHealthcare) -> None:
        with client.api.v2.task.with_streaming_response.retry(
            "taskId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retry(self, client: SampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            client.api.v2.task.with_raw_response.retry(
                "",
            )
    ...
    def test_method_update_screen_time(self, client: SampleHealthcare) -> None:
        task = client.api.v2.task.update_screen_time(
            task_id="taskId",
    ...
    def test_raw_response_update_screen_time(self, client: SampleHealthcare) -> None:
        response = client.api.v2.task.with_raw_response.update_screen_time(
            task_id="taskId",
            additional_screen_time=1,
        )
    ...
    def test_streaming_response_update_screen_time(self, client: SampleHealthcare) -> None:
        with client.api.v2.task.with_streaming_response.update_screen_time(
            task_id="taskId",
            additional_screen_time=1,
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update_screen_time(self, client: SampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            client.api.v2.task.with_raw_response.update_screen_time(
                task_id="",
                additional_screen_time=1,
            )
...
class TestAsyncTask:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_suspended_payload(self, async_client: AsyncSampleHealthcare) -> None:
        task = await async_client.api.v2.task.retrieve_suspended_payload(
            "taskId",
        )
        assert_matches_type(TaskRetrieveSuspendedPayloadResponse, task, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_suspended_payload(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.task.with_raw_response.retrieve_suspended_payload(
            "taskId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_suspended_payload(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.task.with_streaming_response.retrieve_suspended_payload(
            "taskId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_retrieve_suspended_payload(self, async_client: AsyncSampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            await async_client.api.v2.task.with_raw_response.retrieve_suspended_payload(
                "",
            )
    ...
    async def test_method_retry(self, async_client: AsyncSampleHealthcare) -> None:
        task = await async_client.api.v2.task.retry(
            "taskId",
        )
        assert_matches_type(TaskRetryResponse, task, path=["response"])
    ...
    async def test_raw_response_retry(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.task.with_raw_response.retry(
            "taskId",
        )
    ...
    async def test_streaming_response_retry(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.task.with_streaming_response.retry(
            "taskId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retry(self, async_client: AsyncSampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            await async_client.api.v2.task.with_raw_response.retry(
                "",
            )
    ...
    async def test_method_update_screen_time(self, async_client: AsyncSampleHealthcare) -> None:
        task = await async_client.api.v2.task.update_screen_time(
            task_id="taskId",
            additional_screen_time=1,
        )
        assert_matches_type(Optional[TaskUpdateScreenTimeResponse], task, path=["response"])
    ...
    async def test_raw_response_update_screen_time(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.task.with_raw_response.update_screen_time(
            task_id="taskId",
            additional_screen_time=1,
        )
    ...
    async def test_streaming_response_update_screen_time(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.task.with_streaming_response.update_screen_time(
            task_id="taskId",
            additional_screen_time=1,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update_screen_time(self, async_client: AsyncSampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            await async_client.api.v2.task.with_raw_response.update_screen_time(
                task_id="",
                additional_screen_time=1,
            )
