...
class TestStep:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_output(self, client: SampleHealthcare) -> None:
        step = client.api.v2.workflow_run.step.retrieve_output(
            "stepId",
        )
        assert_matches_type(StepRetrieveOutputResponse, step, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_output(self, client: SampleHealthcare) -> None:
        response = client.api.v2.workflow_run.step.with_raw_response.retrieve_output(
            "stepId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_output(self, client: SampleHealthcare) -> None:
        with client.api.v2.workflow_run.step.with_streaming_response.retrieve_output(
            "stepId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_retrieve_output(self, client: SampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `step_id` but received ''"):
            client.api.v2.workflow_run.step.with_raw_response.retrieve_output(
                "",
            )
...
class TestAsyncStep:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_output(self, async_client: AsyncSampleHealthcare) -> None:
        step = await async_client.api.v2.workflow_run.step.retrieve_output(
            "stepId",
        )
        assert_matches_type(StepRetrieveOutputResponse, step, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_output(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.workflow_run.step.with_raw_response.retrieve_output(
            "stepId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_output(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.workflow_run.step.with_streaming_response.retrieve_output(
            "stepId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_retrieve_output(self, async_client: AsyncSampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `step_id` but received ''"):
            await async_client.api.v2.workflow_run.step.with_raw_response.retrieve_output(
                "",
            )
