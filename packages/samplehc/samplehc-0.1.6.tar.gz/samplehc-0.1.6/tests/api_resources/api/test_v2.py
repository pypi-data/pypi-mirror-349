...
class TestV2:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_async_result(self, client: SampleHealthcare) -> None:
        v2 = client.api.v2.retrieve_async_result(
            "asyncResultId",
        )
        assert_matches_type(V2RetrieveAsyncResultResponse, v2, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_async_result(self, client: SampleHealthcare) -> None:
        response = client.api.v2.with_raw_response.retrieve_async_result(
            "asyncResultId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_async_result(self, client: SampleHealthcare) -> None:
        with client.api.v2.with_streaming_response.retrieve_async_result(
            "asyncResultId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_retrieve_async_result(self, client: SampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `async_result_id` but received ''"):
            client.api.v2.with_raw_response.retrieve_async_result(
                "",
            )
...
class TestAsyncV2:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_async_result(self, async_client: AsyncSampleHealthcare) -> None:
        v2 = await async_client.api.v2.retrieve_async_result(
            "asyncResultId",
        )
        assert_matches_type(V2RetrieveAsyncResultResponse, v2, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_async_result(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.api.v2.with_raw_response.retrieve_async_result(
            "asyncResultId",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_async_result(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.api.v2.with_streaming_response.retrieve_async_result(
            "asyncResultId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_retrieve_async_result(self, async_client: AsyncSampleHealthcare) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `async_result_id` but received ''"):
            await async_client.api.v2.with_raw_response.retrieve_async_result(
                "",
            )
