...
from .....types.api.v2.document_retrieve_metadata_response import DocumentRetrieveMetadataResponse
from .....types.api.v2.document_create_from_splits_response import DocumentCreateFromSplitsResponse
from .....types.api.v2.document_retrieve_csv_content_response import DocumentRetrieveCsvContentResponse
...
class DocumentResourceWithRawResponse:
    def __init__(self, document: DocumentResource) -> None:
        ...
        self.retrieve_csv_content = to_raw_response_wrapper(
            document.retrieve_csv_content,
        )
        self.retrieve_metadata = to_raw_response_wrapper(
            document.retrieve_metadata,
        )
