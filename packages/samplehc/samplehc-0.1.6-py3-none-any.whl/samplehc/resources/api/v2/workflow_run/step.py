...
from .....types.api.v2.workflow_run.step_retrieve_output_response import StepRetrieveOutputResponse
    ...
    def retrieve_output(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=StepRetrieveOutputResponse,
        )
