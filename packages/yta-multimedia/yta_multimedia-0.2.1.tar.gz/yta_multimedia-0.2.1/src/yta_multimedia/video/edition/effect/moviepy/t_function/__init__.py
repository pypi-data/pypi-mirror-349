...
def run_rate_function(t: float, duration: float, rate_function: type, *args, **kwargs):
    """
...
class TFunctionSetPosition:
    ...
    def linear(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
    ...
    def linear_doing_circles(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
    ...
    def linear_with_normal_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.linear(t, duration, initial_position, final_position, rate_function)

        return shake(pos, 4)
    
    def linear_with_decreasing_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.linear(t, duration, initial_position, final_position, rate_function)

        # TODO: You can set a RateFunction also here
        return shake_decreasing(pos, 4, t / duration)
    
    def linear_with_increasing_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.linear(t, duration, initial_position, final_position, rate_function)

        # TODO: You can set a RateFunction also here
        return shake_increasing(pos, 4, t / duration)
    
    def sinusoidal(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        """
    ...
    def sinusoidal_doing_circles(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.sinusoidal(t, duration, initial_position, final_position, rate_function)

        # TODO: What about using a linear function (?)
        return circles(pos, 1, 200, t / duration)
    
    def sinusoidal_with_normal_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.sinusoidal(t, duration, initial_position, final_position, rate_function)

        return shake(pos, 4)
    
    def sinusoidal_with_decreasing_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.sinusoidal(t, duration, initial_position, final_position, rate_function)

        # TODO: You can set a RateFunction also here
        return shake_decreasing(pos, 4, t / duration)

    def sinusoidal_with_increasing_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.sinusoidal(t, duration, initial_position, final_position, rate_function)

        # TODO: You can set a RateFunction also here
        return shake_increasing(pos, 4, t / duration)
    
    def zigzag(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        factor = run_rate_function(t, duration, rate_function)
        amplitude = 15
    ...
    def zigzag_doing_circles(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.zigzag(t, duration, initial_position, final_position, rate_function)

        # TODO: What about using a linear function (?)
        return circles(pos, 1, 200, t / duration)
    
    def zigzag_with_normal_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.zigzag(t, duration, initial_position, final_position, rate_function)

        return shake(pos, 4)
    
    def zigzag_with_decreasing_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.zigzag(t, duration, initial_position, final_position, rate_function)

        # TODO: You can set a RateFunction also here
        return shake_decreasing(pos, 4, t / duration)
    
    def zigzag_with_increasing_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        pos = TFunctionSetPosition.zigzag(t, duration, initial_position, final_position, rate_function)
