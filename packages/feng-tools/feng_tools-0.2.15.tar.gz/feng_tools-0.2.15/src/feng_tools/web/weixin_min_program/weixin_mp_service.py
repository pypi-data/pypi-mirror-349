...
from feng_tools.web.weixin_min_program.model.weixin_mp_models import WeixinMpUserInfoPo, UserGenderTypeEnum
    ...
    def run_mp_save_userinfo(self, user_info: WxMpUserInfo) -> dict|None:
        with self.SessionLocal() as db:
            ...
            if userinfo_po:
                ...
                userinfo_po.gender = [tmp for tmp in UserGenderTypeEnum if user_info.gender == tmp.value][0]
