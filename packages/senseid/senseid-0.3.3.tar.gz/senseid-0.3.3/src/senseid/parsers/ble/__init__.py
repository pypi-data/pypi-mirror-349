...
class SenseidBleTag(SenseidTag):
    ...
    def _is_senseid_beacon(self, beacon_bytes: bytearray):
        local_name = beacon_bytes[2:len(SENSEID_BLE_DEF.local_name)+2]
    ...
    def _parse_senseid_beacon(self, beacon_bytes: bytearray):
        senseid_type = beacon_bytes[8]
        fw_version = beacon_bytes[9]
        #senseid_sn_bytes = beacon_bytes[7:10]
        #id = beacon_bytes[0:10].hex().upper()
        ...
        senseid_value_bytes = beacon_bytes[10:]
