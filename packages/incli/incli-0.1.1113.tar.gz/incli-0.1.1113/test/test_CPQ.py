...
#'NOS_t_CoverageTechnology__c':'FTTH'
 #       }
    ...
    def test_get_cart_items_bt(self):
        ...
        items = CPQ.getCartItems_api_custom(cartId,price=False,validate=False)
...
# this one decomposition and plan remaining 8013O00000546JWQAY
    ...
    def test_applyAdjustment(self):
        ...
        res = CPQ.applyAdjustment('0Q0AP000001P6010AC','0QLAP0000014yQ4','OT_STD_CST',field='vlocity_cmt__OneTimeCost__c',adjustmentValue=3)
