...
def getCartItems_api_custom(cartId, query=None,id=None,lastRecordId=None,pagesize=None,hierarchy=None,includeAttachment=None,headerFieldSet=None,filter=None,price=None,validate=None,fields=None):
    paramStr = stringify(locals(),exclude=['cartId'])
