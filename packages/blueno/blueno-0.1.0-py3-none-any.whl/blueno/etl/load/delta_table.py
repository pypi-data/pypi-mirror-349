...
from blueno.etl.helpers import get_max_column_value
from blueno.etl.helpers.get_or_create_delta_table import get_or_create_delta_table
from blueno.etl.helpers.merge_helpers import (
...
def upsert(
    ...
    update_exclusion_columns: str | list[str] | list[Column] | None = None,
    predicate_exclusion_columns: str | list[str] | list[Column] | None = None,
) -> dict[str, str]:
    """
