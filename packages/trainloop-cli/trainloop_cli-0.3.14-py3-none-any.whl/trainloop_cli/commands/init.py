...
def init_command():
    ...
    scaffold_path = resources.files("trainloop_cli").joinpath("../scaffold").resolve()

    print(f"scaffold_path: {scaffold_path}")
    ...
    shutil.copytree(scaffold_path / "trainloop", trainloop_dir)
