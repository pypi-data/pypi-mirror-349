...
class ResourceControlTagging(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "created_by_id", "control_tag", "status", "reason", "inherited_from_resource_id", "inherited_from_resource_type", "resource_id", "resource_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourceControlTagging from a JSON string"""
