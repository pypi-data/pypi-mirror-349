...
class ReportAwsCost(Template):
    ...
    def text_summary_forecast(self, df_year_totals: pd.DataFrame):
        ...
        last_month_totals = df_year_totals.loc[self.last_month]["SubTotal"]
        current_month_totals = df_year_totals.loc[self.current_month]["SubTotal"]
        current_month_endom = df_year_totals.loc[self.current_month]["Forecast"]
