...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_NOTIFICATIONTYPE']._serialized_start = 339
    _globals['_NOTIFICATIONTYPE']._serialized_end = 482
    _globals['_NOTIFICATION']._serialized_start = 23
    _globals['_NOTIFICATION']._serialized_end = 336