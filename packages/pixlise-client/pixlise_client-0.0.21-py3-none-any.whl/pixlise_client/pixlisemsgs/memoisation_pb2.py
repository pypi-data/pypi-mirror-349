...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_MEMOISEDITEM']._serialized_end = 214
    _globals['_MEMPMCDATAVALUE']._serialized_start = 216
    _globals['_MEMPMCDATAVALUE']._serialized_end = 297
    _globals['_MEMPMCDATAVALUES']._serialized_start = 299
    _globals['_MEMPMCDATAVALUES']._serialized_end = 422
    _globals['_MEMREGIONSETTINGS']._serialized_start = 424
    _globals['_MEMREGIONSETTINGS']._serialized_end = 542
    _globals['_MEMDATAQUERYRESULT']._serialized_start = 545
    _globals['_MEMDATAQUERYRESULT']._serialized_end = 699