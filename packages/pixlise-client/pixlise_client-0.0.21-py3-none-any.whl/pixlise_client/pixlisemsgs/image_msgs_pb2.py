...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_IMAGEUPLOADHTTPREQUEST']._serialized_end = 810
    _globals['_IMAGEDELETEREQ']._serialized_start = 812
    _globals['_IMAGEDELETEREQ']._serialized_end = 842
    _globals['_IMAGEDELETERESP']._serialized_start = 844
    _globals['_IMAGEDELETERESP']._serialized_end = 861
    _globals['_IMAGESETMATCHTRANSFORMREQ']._serialized_start = 863
    _globals['_IMAGESETMATCHTRANSFORMREQ']._serialized_end = 950
    _globals['_IMAGESETMATCHTRANSFORMRESP']._serialized_start = 952
    _globals['_IMAGESETMATCHTRANSFORMRESP']._serialized_end = 980