        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "format": {
                        "type": "string",
                        "description": "Target format. PDF can be converted to: DOCX, XLSX, PPTX, images (including long images), HTML, TXT (text extraction), CSV, or Markdown (md). Other formats (DOCX, XLSX, PPTX, images, CAD, CAJ, OFD, HTML, TEX (LaTeX), TXT) can be converted to PDF. PDF to PDF conversion is not supported.",
