...
class Pipette(Handler):
        ...
        if n_src_wells == n_dest_wells:
            for src, dest in zip(source_wells, dest_wells):
                if use_new_tip == 'always' and self.has_tip():
                    ...
                    self.pick_up_tip(tiprack, pick_up_tip_order)
    ...
    def transfer(self, 
                 ...
                 pick_up_tip_order: Literal['top_to_bottom', 'bottom_to_top'] = 'top_to_bottom'
                 ) -> 'Pipette':
        ...
        Args:
            ...
            pick_up_tip_order (Literal['top_to_bottom', 'bottom_to_top'], optional): The order to pick up tips - either from top to bottom of the tiprack or bottom to top. The argument only works when the location is not specified and single channel pipette is used. Defaults to 'top_to_bottom'.    
    ...
    def pick_up_tip(self, location: Union[TipRack, Well, Column, None] = None, pick_up_tip_order: Literal['top_to_bottom', 'bottom_to_top'] = 'top_to_bottom') -> 'Pipette':
        ...
        Args:
            ...
            pick_up_tip_order (Literal['top_to_bottom', 'bottom_to_top'], optional): The order to auto pick up tips - either from top to bottom of the tiprack or bottom to top. The argument only works when the location is not specified and single channel pipette is used. Defaults to 'top_to_bottom'.   
        ...
        if isinstance(location, (Well, Column)):
            ...
            self.__current_tip_location = tiprack._get_new_tip(self.n_channel, pick_up_tip_order)
