...
class BankCreate(BaseModel):
    number: Optional[str] = Field(None, max_length=34, example="123456789", description="Bank Account Number")
    description: Optional[str] = Field(None, max_length=100, example="Salary Bank", description="Bank Account Description")
    iban: str = Field(..., min_length=5, max_length=34, example="NL20INGB0001234567", description="IBAN")
    city: Optional[str] = Field(None, max_length=100, example="Amsterdam", description="City Bank")
    name: Optional[str] = Field(None, max_length=100, example="ING Bank", description="Name Bank")
    bank_account_type: Optional[BankAccountType] = Field(None, example=BankAccountType.BANK_ACCOUNT_1.value, description="Bank Account Type")

class BankUpdate(BaseModel):
    bank_account_id: str = Field(..., example="49a69eda-252e-4ccb-a220-38ea90511d4f", description="Bank Account ID")
    number: Optional[str] = Field(None, max_length=34, example="123456789", description="Bank Account Number")
    description: Optional[str] = Field(None, max_length=100, example="Main Checking Account", description="Bank Account Description")
    iban: Optional[str] = Field(None, min_length=5, max_length=34, example="NL20INGB0001234567", description="IBAN")
    city: Optional[str] = Field(None, max_length=100, example="Rotterdam", description="City Bank")
    name: Optional[str] = Field(None, max_length=100, example="ABN AMRO", description="Name Bank")
    ...
    ]] = Field(None, example="NL", description="Country Code Bank")
    bank_account_type: Optional[BankAccountType] = Field(None, example=BankAccountType.BANK_ACCOUNT_1.value, description="Bank Account Type")
