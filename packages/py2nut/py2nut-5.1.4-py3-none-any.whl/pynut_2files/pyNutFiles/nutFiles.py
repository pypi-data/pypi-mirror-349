...
def fStr_fillXls_celByCel(str_path, df_data, str_SheetName='', xl_sheet=0, int_nbRows=0, int_rowsWhere=1, xl_app=None):
    ...
    #         if xl_sheet is None:
    #             raise ValueError('  (--) ERROR in filXlscelByCel: sheet is None')
    #         if xl_sheet == 0:
    #             raise ValueError('  (--) ERROR in filXlscelByCel: sheet is 0')
    #     else:
    #         if xl_app is None:
    ...
    # except Exception as err:
    #     logger.error('  ERROR in fl fillXlscelByCel 2, Insert or delete ROWS: |{}|'.format(err))
