...
class TestStat:
    ...
    def to_json(self):
        ...
        _data = {
            ...
            "l99th_latency": convert_time_to_milliseconds(self.l99th_latency),
            "l95th_latency": convert_time_to_milliseconds(self.l95th_latency),
            "l90th_latency": convert_time_to_milliseconds(self.l90th_latency),
