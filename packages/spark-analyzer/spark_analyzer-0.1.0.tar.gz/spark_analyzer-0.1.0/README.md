...
After installation, you need to configure the tool using the configuration wizard:
...
After installation and configuration, you can run the tool using:
...
The upload process is secure and encrypted. No sensitive data is extracted from your Spark jobs - only performance metrics and metadata necessary for optimization analysis are transmitted.