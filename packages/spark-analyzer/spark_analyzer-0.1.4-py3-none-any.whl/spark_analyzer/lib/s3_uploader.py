...
class S3Uploader:
    ...
    DEFAULT_API_KEY = "prR1Lzi+xM+bcSp+6hyqHg=="
    DEFAULT_API_SECRET = "9Z+SbOvQbgoQCqFwkh97unrCTcGdpPBZhmEV5MD0yr8="
    DEFAULT_ORG_ID = "aa6e0325-1987-4295-a140-02bf22adce1e"
    DEFAULT_USER_ID = "nQOT2J5l38hTH7VHesBrkQAm1ZF2"
    ...
    def __init__(self, config_file: str = "config.ini", use_staging: bool = False, args=None):
        ...
        config_paths = [
            pkg_resources.resource_filename("spark_analyzer", os.path.join("lib", "configs", config_file)),
