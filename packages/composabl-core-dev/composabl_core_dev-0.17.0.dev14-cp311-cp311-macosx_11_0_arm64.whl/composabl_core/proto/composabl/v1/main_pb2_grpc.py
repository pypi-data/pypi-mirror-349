...
class RemotePerceptorIsolationServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.compute = channel.unary_unary(
                '/composabl.RemotePerceptorIsolationServer/compute',
                request_serializer=composabl_dot_v1_dot_main__pb2.RemotePerceptorComputeRequest.SerializeToString,
                response_deserializer=composabl_dot_v1_dot_main__pb2.RemotePerceptorComputeResponse.FromString,
                )
...
class RemotePerceptorIsolationServerServicer(object):
    ...
    def compute(self, request, context):
        ...
        - RemotePerceptorComputeRequest: Contains the composabl observation
        - RemotePerceptorComputeResponse: The perceptor variables
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RemotePerceptorIsolationServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'compute': grpc.unary_unary_rpc_method_handler(
                    servicer.compute,
                    request_deserializer=composabl_dot_v1_dot_main__pb2.RemotePerceptorComputeRequest.FromString,
                    response_serializer=composabl_dot_v1_dot_main__pb2.RemotePerceptorComputeResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class RemotePerceptorIsolationServer(object):
    ...
    def compute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/composabl.RemotePerceptorIsolationServer/compute',
            composabl_dot_v1_dot_main__pb2.RemotePerceptorComputeRequest.SerializeToString,
            composabl_dot_v1_dot_main__pb2.RemotePerceptorComputeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
