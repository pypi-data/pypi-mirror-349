...
if __name__ == "__main__":
    drawio_path = "docs/images/example.drawio"
    destination = "docs/images/"
    output_files = [
        # SVG name for each page in the Draw.io file.
    ]
    source_path = Path(__file__).parent.parent.joinpath(drawio_path)
    dest_path = Path(__file__).parent.parent.joinpath(destination)
