...
class Item(object):
    ...
    def from_dictionary(cls,
        ...
        pricing = APIHelper.deserialize_union_type(UnionTypeLookUp.get('ItemPricing'), dictionary.get('pricing'), False) if dictionary.get('pricing') is not None else APIHelper.SKIP
