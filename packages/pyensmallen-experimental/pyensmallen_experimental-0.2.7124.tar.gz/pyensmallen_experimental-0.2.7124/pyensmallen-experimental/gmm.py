...
from . import _pyensmallen-experimental as pe
...
class EnsmallenEstimator:
    """
    GMM Estimator using pyensmallen-experimental optimization backend with JAX autodifferentiation.
    """
    ...
    def gmm_objective(self, beta: np.ndarray, gradient: np.ndarray) -> float:
        """
        Compute GMM objective function value and gradient for pyensmallen-experimental.
        ...
        # Assign gradient (pyensmallen-experimental requires modifying gradient in-place)
    ...
    def fit(
        ...
        """
        Fit the GMM model using pyensmallen-experimental optimizer with JAX gradients.
