...
extras["audio"] = deps_list(
    ...
    "pyctcdecode",
    "phonemizer",
    # "kenlm", # Removed: kenlm's Git URL (from deps["kenlm"]) is not allowed by PyPI in package metadata.
    # Users requiring kenlm for full audio functionality should install it manually:
    # pip install git+https://github.com/ydshieh/kenlm@78f664fb3dafe1468d868d71faf19534530698d5
)
...
setup(
    name="transformers-qwenomni",
    version="4.52.0.2",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
    author="The Hugging Face team (past and future) with the help of all our contributors (https://github.com/huggingface/transformers/graphs/contributors)",
    author_email="oss@shamit.in",
    description="Transformers: With code for Qwen 2.5 Omni",
