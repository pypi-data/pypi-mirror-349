SCHEMA = {
  ...
  "required" : [ "PromptArn" ],
  "readOnlyProperties" : [ "/properties/Arn", "/properties/CreatedAt", "/properties/PromptId", "/properties/UpdatedAt", "/properties/Version", "/properties/Name", "/properties/DefaultVariant", "/properties/Variants", "/properties/CustomerEncryptionKeyArn" ],
  "primaryIdentifier" : [ "/properties/Arn" ],
  "createOnlyProperties" : [ "/properties/PromptArn", "/properties/Description", "/properties/Tags" ],
  "handlers" : {
    "create" : {
      "permissions" : [ "bedrock:CreatePromptVersion", "bedrock:GetPrompt", "bedrock:TagResource", "bedrock:ListTagsForResource", "kms:GenerateDataKey", "kms:Decrypt" ]
    },
    "read" : {
  ...
  "tagging" : {
    ...
    "tagUpdatable" : False,
    "taggable" : True,
    "permissions" : [ "bedrock:TagResource", "bedrock:ListTagsForResource" ]
  },
  "additionalProperties" : False
}