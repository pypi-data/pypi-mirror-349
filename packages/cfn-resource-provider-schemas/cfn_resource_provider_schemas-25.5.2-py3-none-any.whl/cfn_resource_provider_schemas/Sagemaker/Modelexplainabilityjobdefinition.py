SCHEMA = {
  ...
  "handlers" : {
    "create" : {
      "permissions" : [ "sagemaker:CreateModelExplainabilityJobDefinition", "sagemaker:DescribeModelExplainabilityJobDefinition", "iam:PassRole", "sagemaker:AddTags", "sagemaker:ListTags" ]
    },
    "delete" : {
      "permissions" : [ "sagemaker:DeleteModelExplainabilityJobDefinition" ]
    },
    "read" : {
      "permissions" : [ "sagemaker:DescribeModelExplainabilityJobDefinition", "sagemaker:ListTags" ]
    },
    "list" : {
      "permissions" : [ "sagemaker:ListModelExplainabilityJobDefinitions", "sagemaker:ListTags" ]
    }
  },
