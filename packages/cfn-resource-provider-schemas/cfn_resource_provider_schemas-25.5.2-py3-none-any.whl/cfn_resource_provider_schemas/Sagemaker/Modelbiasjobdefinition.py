SCHEMA = {
  ...
  "handlers" : {
    "create" : {
      "permissions" : [ "sagemaker:CreateModelBiasJobDefinition", "sagemaker:DescribeModelBiasJobDefinition", "iam:PassRole", "sagemaker:AddTags", "sagemaker:ListTags" ]
    },
    "delete" : {
      "permissions" : [ "sagemaker:DeleteModelBiasJobDefinition" ]
    },
    "read" : {
      "permissions" : [ "sagemaker:DescribeModelBiasJobDefinition", "sagemaker:ListTags" ]
    },
    "list" : {
      "permissions" : [ "sagemaker:ListModelBiasJobDefinitions", "sagemaker:ListTags" ]
    }
  },
