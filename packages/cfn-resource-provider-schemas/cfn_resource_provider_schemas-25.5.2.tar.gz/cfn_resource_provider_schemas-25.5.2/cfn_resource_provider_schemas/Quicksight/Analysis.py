SCHEMA = {
  ...
  "readOnlyProperties" : [ "/properties/Arn", "/properties/CreatedTime", "/properties/DataSetArns", "/properties/LastUpdatedTime" ],
  ...
  "handlers" : {
    "read" : {
      "permissions" : [ "quicksight:DescribeAnalysis", "quicksight:DescribeAnalysisPermissions", "quicksight:ListTagsForResource" ]
    },
    "create" : {
  ...
  "writeOnlyProperties" : [ "/properties/Definition", "/properties/Parameters", "/properties/SourceEntity", "/properties/Status", "/properties/ValidationStrategy", "/properties/FolderArns" ],
  ...
  "definitions" : {
    ...
    "AnalysisError" : {
      "description" : "<p>Analysis error.</p>",
      "additionalProperties" : False,
      "type" : "object",
      "properties" : {
        "Type" : {
