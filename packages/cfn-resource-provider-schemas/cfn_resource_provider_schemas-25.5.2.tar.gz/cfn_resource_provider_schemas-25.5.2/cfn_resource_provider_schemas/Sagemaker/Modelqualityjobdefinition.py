SCHEMA = {
  ...
  "handlers" : {
    "create" : {
      "permissions" : [ "sagemaker:CreateModelQualityJobDefinition", "sagemaker:DescribeModelQualityJobDefinition", "sagemaker:AddTags", "sagemaker:ListTags", "iam:PassRole" ]
    },
    "delete" : {
      "permissions" : [ "sagemaker:DeleteModelQualityJobDefinition" ]
    },
    "read" : {
      "permissions" : [ "sagemaker:DescribeModelQualityJobDefinition", "sagemaker:ListTags" ]
    },
    "list" : {
      "permissions" : [ "sagemaker:ListModelQualityJobDefinitions", "sagemaker:ListTags" ]
    }
  },
  ...
  "writeOnlyProperties" : [ "/properties/EndpointName" ],
  "tagging" : {
    "taggable" : True,
    "tagOnCreate" : True,
    "tagUpdatable" : False,
