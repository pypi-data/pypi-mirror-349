...
spec = importlib.util.spec_from_file_location("model_train_component.py")
...
def model_train_component(*args, **kwargs):
    raise NotImplementedError("User must provide model_train_component")
