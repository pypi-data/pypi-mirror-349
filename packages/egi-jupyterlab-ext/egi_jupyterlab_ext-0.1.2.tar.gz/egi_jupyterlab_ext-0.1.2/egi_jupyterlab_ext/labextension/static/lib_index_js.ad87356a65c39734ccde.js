...
function GrafanaPage() {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("iframe", { src: "http://localhost:3000/d/abcd1234/my-dashboard?orgId=1&kiosk", width: "100%", height: "600", style: { border: 'none', overflow: 'hidden' } }));
}
...
const App = () => {
    ...
    const ActivePage = {
        ...
        [Page.Grafana]: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_pages_GrafanaPage__WEBPACK_IMPORTED_MODULE_7__["default"], null)
    };
...
//# sourceMappingURL=lib_index_js.ad87356a65c39734ccde.js.map