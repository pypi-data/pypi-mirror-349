...
def create_agmin(
    base: DeclarativeMeta, get_session: Callable[[], Session], app: Optional[FastAPI] = None, home_url: str = "/"
) -> "SQLAlchemyAgmin":
    ...
    """
    return SQLAlchemyAgmin(base, get_session, app, home_url=home_url)
...
class SQLAlchemyAgmin:
    def __init__(self, base: DeclarativeMeta, get_session, app: Optional[FastAPI] = None, home_url: str = "/"):
