...
def make_column_id(
    ...
    *,
    ...
    schema_prefix = [ID_PART_DIVIDER.join(schema_parts)] if len(schema_parts) > 0 else []
    ...
    column_id = ID_SECTION_DIVIDER.join([*schema_prefix, *attr_prefix, base_name, *attr_suffix])
