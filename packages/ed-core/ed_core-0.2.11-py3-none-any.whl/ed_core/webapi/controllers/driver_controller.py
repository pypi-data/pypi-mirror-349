...
from ed_core.application.features.driver.requests.queries import (
    ...
    GetDriverHeldFundsQuery, GetDriverOrdersQuery, GetDriverQuery)
...
@router.get(
    "/{driver_id}/driver-held-funds", response_model=GenericResponse[list[OrderDto]]
)
@rest_endpoint
async def driver_held_funds(
    ...
    return await mediator.send(GetDriverHeldFundsQuery(driver_id=driver_id))
...
async def driver_orders(
    ...
    return await mediator.send(GetDriverOrdersQuery(driver_id=driver_id))
