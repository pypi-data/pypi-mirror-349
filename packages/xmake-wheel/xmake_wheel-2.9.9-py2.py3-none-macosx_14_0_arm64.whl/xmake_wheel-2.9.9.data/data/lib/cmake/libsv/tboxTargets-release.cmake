...
set_target_properties(libsv::tbox PROPERTIES
  ...
  # IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libtbox.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtbox.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS libsv::tbox )
list(APPEND _IMPORT_CHECK_FILES_FOR_libsv::tbox "${_IMPORT_PREFIX}/lib/libtbox.a" )
