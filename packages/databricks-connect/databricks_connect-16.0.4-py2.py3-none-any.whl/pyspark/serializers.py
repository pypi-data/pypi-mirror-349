...
class FramedSerializer(Serializer):
    ...
    def _read_func_from_code_literal(self, stream):
        ...
        Return the function handler and the return type back.
        ...
        if len(handler_name) > 0:
            ...
            raise PySparkAssertionError("Handler name is not allowed for UDF.")
        ...
        return module._udf_handler_func_entry, _parse_datatype_json_string(return_type)
