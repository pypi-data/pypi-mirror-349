...
from wiim.bridge import LinkPlayBridge, LinkPlayMultiroom
from wiim.consts import LOGGER
from wiim.discovery import discover_wiim_bridges
from wiim.exceptions import LinkPlayInvalidDataException
...
class LinkPlayController:
    ...
    async def discover_bridges(self) -> None:
        ...
        discovered_bridges = await discover_wiim_bridges(self.session)
