...
# ruff: noqa: E402
from tesslate_chainlit.auth import ensure_jwt_secret
from tesslate_chainlit.cache import init_lc_cache
...
from tesslate_chainlit.markdown import init_markdown
from tesslate_chainlit.secret import random_secret
from tesslate_chainlit.telemetry import trace_event
from tesslate_chainlit.utils import check_file
...
@click.version_option(prog_name="Tesslate Chainlit")
def cli():
    return
...
def run_chainlit(target: str):
    ...
    from tesslate_chainlit.server import app
    ...
    # Create the tesslate_chainlit.md file if it doesn't exist
...
def chainlit_run(
    ...
    if ci:
        ...
        trace_event("tesslate_chainlit run")
...
def chainlit_hello(args=None, **kwargs):
    trace_event("tesslate_chainlit hello")
...
def chainlit_init(args=None, **kwargs):
    trace_event("tesslate_chainlit init")
...
def chainlit_create_secret(args=None, **kwargs):
    trace_event("tesslate_chainlit secret")
...
def chainlit_lint_translations(args=None, **kwargs):
    trace_event("tesslate_chainlit lint-translation")
