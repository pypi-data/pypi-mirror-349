...
from tesslate_chainlit.types import FileReference

if TYPE_CHECKING:
    from mcp import ClientSession

    from tesslate_chainlit.types import FileDict
...
class BaseSession:
    ...
    @property
    def files_dir(self):
        from tesslate_chainlit.config import FILES_DIRECTORY
...
class HTTPSession(BaseSession):
    """Internal HTTP session object. Used to consume tesslate_chainlit through API (no websocket)."""
