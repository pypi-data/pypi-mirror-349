...
from tesslate_chainlit.message import ErrorMessage
...
def mount_chainlit(app: FastAPI, target: str, path="/chainlit"):
    from tesslate_chainlit.config import config, load_module
    from tesslate_chainlit.server import app as chainlit_app
