...
from tesslate_chainlit.data.base import BaseDataLayer
from tesslate_chainlit.logger import logger
from tesslate_chainlit.translations import lint_translation_json
...
if TYPE_CHECKING:
    ...
    from tesslate_chainlit.message import Message
    from tesslate_chainlit.types import ChatProfile, InputAudioChunk, Starter, ThreadDict
    from tesslate_chainlit.user import User
else:
...
config_dir = os.path.join(APP_ROOT, ".tesslate_chainlit")
...
# custom_meta_image_url = "https://tesslate_chainlit-cloud.s3.eu-west-3.amazonaws.com/logo/chainlit_banner.png"
...
#     url = "https://github.com/tesslate_chainlit/tesslate_chainlit/issues"
...
class ChainlitConfig:
    # Directory where the tesslate_chainlit project is located
    root = APP_ROOT
    # tesslate_chainlit server URL. Used only for cloud features
    chainlit_server: str
    run: RunSettings
...
def load_config():
    ...
    chainlit_server = os.environ.get("CHAINLIT_SERVER", "https://cloud.tesslate_chainlit.io")
...
def lint_translations():
    # Load the ground truth (en-US.json file from tesslate_chainlit source code)
