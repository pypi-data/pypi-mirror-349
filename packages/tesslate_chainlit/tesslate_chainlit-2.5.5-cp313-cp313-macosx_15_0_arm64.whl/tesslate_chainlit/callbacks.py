...
from tesslate_chainlit.config import config
from tesslate_chainlit.context import context
from tesslate_chainlit.data.base import BaseDataLayer
from tesslate_chainlit.mcp import McpConnection
from tesslate_chainlit.message import Message
from tesslate_chainlit.oauth_providers import get_configured_oauth_providers
from tesslate_chainlit.step import Step, step
from tesslate_chainlit.telemetry import trace
from tesslate_chainlit.types import ChatProfile, Starter, ThreadDict
from tesslate_chainlit.user import User
from tesslate_chainlit.utils import wrap_user_function


@trace
def on_app_startup(func: Callable[[], Union[None, Awaitable[None]]]) -> Callable:
    """
    Hook to run code when the tesslate_chainlit application starts.
...
def on_app_shutdown(func: Callable[[], Union[None, Awaitable[None]]]) -> Callable:
    """
    Hook to run code when the tesslate_chainlit application shuts down.
