...
from tesslate_chainlit.session import ClientType, HTTPSession, WebsocketSession

if TYPE_CHECKING:
    from tesslate_chainlit.emitter import BaseChainlitEmitter
    from tesslate_chainlit.step import Step
...
class ChainlitContextException(Exception):
    def __init__(self, msg="tesslate_chainlit context not found", *args, **kwargs):
...
class ChainlitContext:
    ...
    def __init__(
        ...
        from tesslate_chainlit.emitter import BaseChainlitEmitter, ChainlitEmitter
...
context_var: ContextVar[ChainlitContext] = ContextVar("tesslate_chainlit")
