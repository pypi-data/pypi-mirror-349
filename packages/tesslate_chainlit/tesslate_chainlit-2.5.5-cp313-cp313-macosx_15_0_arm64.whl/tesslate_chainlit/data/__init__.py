    ...
    if not _data_layer_initialized:
        if _data_layer:
            ...
            if config.code.data_layer:
                ...
                trace_event("Init tesslate_chainlit official data layer")
                ...
                if sum([is_using_s3, is_using_gcs, is_using_azure]) > 1:
                    ...
                    from tesslate_chainlit.data.storage_clients.s3 import S3StorageClient
                    ...
                    from tesslate_chainlit.data.storage_clients.gcs import GCSStorageClient
                    ...
                    from tesslate_chainlit.data.storage_clients.azure_blob import (
