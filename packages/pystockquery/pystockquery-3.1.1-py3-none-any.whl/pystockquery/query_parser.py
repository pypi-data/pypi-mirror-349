...
class QueryParser:
    def __init__(self):
        self.condition_map = {
            # ... (keep existing condition_map as is) ...
        }
    ...
    def parse_query(self, query_string):
        # ... (keep existing parse_query method as is) ...
    ...
    def _parse_condition(self, condition_str):
        ...
        # Map operator to actual operator symbol
        op = self.comparison_operators.get(operator, '==')
    ...
    def _map_condition(self, condition_str):
        # ... (keep existing _map_condition method as is) ...
        """
