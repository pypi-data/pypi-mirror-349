...
class MetadataSpec(Spec, _MetadataSpec):
    ...
    def get_asset_metadata(
        ...
        **kwargs,
        ...
        Returns:
            Response with ViewMetadata model containing the asset metadata
        ...
        """
        resp = self._get(
            self.gen_url(f"assets/{asset_id}/views/{view_id}/"), **kwargs
        )
...
class SearchSpec(Spec, _SearchSpec):
    ...
    def search(
        ...
        **kwargs,
        ...
        resp = self._post(self.gen_url("search/"), json=json_data, **kwargs)
