...
class SyntheticCredential(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationLabels", "applications", "createdAt", "createdBy", "credentialName", "credentialValue", "mobileAppLabels", "mobileApps", "modifiedAt", "modifiedBy", "websiteLabels", "websites"]
