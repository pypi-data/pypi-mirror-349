...
class FullTrace(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    root_span: Span = Field(alias="rootSpan")
    total_error_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="totalErrorCount")
    __properties: ClassVar[List[str]] = ["id", "rootSpan", "totalErrorCount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of root_span
        if self.root_span:
            _dict['rootSpan'] = self.root_span.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "rootSpan": Span.from_dict(obj["rootSpan"]) if obj.get("rootSpan") is not None else None,
            "totalErrorCount": obj.get("totalErrorCount")
        })
        return _obj
