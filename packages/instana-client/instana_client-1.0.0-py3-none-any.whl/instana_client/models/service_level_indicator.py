...
class ServiceLevelIndicator(BaseModel):
    ...
    def blueprint_validate_enum(cls, value):
        ...
        if value not in set(['latency', 'availability', 'traffic', 'custom']):
            raise ValueError("must be one of enum values ('latency', 'availability', 'traffic', 'custom')")
        return value
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'availability': 'AvailabilityBlueprintIndicator','custom': 'CustomBlueprintIndicator','latency': 'LatencyBlueprintIndicator','traffic': 'TrafficBlueprintIndicator'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AvailabilityBlueprintIndicator, CustomBlueprintIndicator, LatencyBlueprintIndicator, TrafficBlueprintIndicator]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AvailabilityBlueprintIndicator, CustomBlueprintIndicator, LatencyBlueprintIndicator, TrafficBlueprintIndicator]]:
