...
class Release(BaseModel):
    ...
    Release
    """ # noqa: E501
    applications: Optional[Annotated[List[ApplicationScope], Field(min_length=0, max_length=10)]] = None
    name: Annotated[str, Field(min_length=0, strict=True, max_length=256)]
    services: Optional[Annotated[List[ServiceScope], Field(min_length=0, max_length=10)]] = None
