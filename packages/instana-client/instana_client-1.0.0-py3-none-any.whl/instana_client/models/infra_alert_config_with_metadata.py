...
class InfraAlertConfigWithMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "created", "customPayloadFields", "description", "enabled", "evaluationType", "gracePeriod", "granularity", "groupBy", "id", "initialCreated", "name", "readOnly", "rule", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold"]
