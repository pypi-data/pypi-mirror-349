...
class SessionSettings(BaseModel):
    ...
    SessionSettings
    """ # noqa: E501
    idle_time_in_millis: Optional[Annotated[int, Field(le=28800000, strict=True, ge=60000)]] = Field(default=None, alias="idleTimeInMillis")
    token_life_time_in_millis: Optional[Annotated[int, Field(le=604800000, strict=True, ge=900000)]] = Field(default=None, alias="tokenLifeTimeInMillis")
