...
class TestDashboardApiToken(unittest.TestCase):
    """DashboardApiToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardApiToken:
        """Test DashboardApiToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardApiToken`
        """
        model = DashboardApiToken()
        if include_optional:
    ...
    def testDashboardApiToken(self):
        """Test DashboardApiToken"""
