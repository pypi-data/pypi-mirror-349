...
class TestDNSActionFilterQueryTime(unittest.TestCase):
    """DNSActionFilterQueryTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSActionFilterQueryTime:
        """Test DNSActionFilterQueryTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSActionFilterQueryTime`
        """
        model = DNSActionFilterQueryTime()
        if include_optional:
            return DNSActionFilterQueryTime(
                key = '',
                operator = 'CONTAINS',
                value = 56
            )
    ...
    def testDNSActionFilterQueryTime(self):
        """Test DNSActionFilterQueryTime"""
