...
class TestMobileAppMetricResult(unittest.TestCase):
    """MobileAppMetricResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileAppMetricResult:
        """Test MobileAppMetricResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileAppMetricResult`
        """
        model = MobileAppMetricResult()
        if include_optional:
    ...
    def testMobileAppMetricResult(self):
        """Test MobileAppMetricResult"""
