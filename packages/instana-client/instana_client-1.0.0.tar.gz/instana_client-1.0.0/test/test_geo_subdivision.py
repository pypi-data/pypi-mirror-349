...
class TestGeoSubdivision(unittest.TestCase):
    """GeoSubdivision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoSubdivision:
        """Test GeoSubdivision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoSubdivision`
        """
