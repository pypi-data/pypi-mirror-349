...
class TestApplicationTimeThreshold(unittest.TestCase):
    """ApplicationTimeThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationTimeThreshold:
        """Test ApplicationTimeThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationTimeThreshold`
        """
        model = ApplicationTimeThreshold()
        if include_optional:
            return ApplicationTimeThreshold(
                time_window = 56,
                type = ''
            )
        else:
    ...
    def testApplicationTimeThreshold(self):
        """Test ApplicationTimeThreshold"""
