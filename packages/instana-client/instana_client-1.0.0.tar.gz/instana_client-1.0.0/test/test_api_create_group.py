...
class TestApiCreateGroup(unittest.TestCase):
    """ApiCreateGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiCreateGroup:
        """Test ApiCreateGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiCreateGroup`
        """
        model = ApiCreateGroup()
        if include_optional:
