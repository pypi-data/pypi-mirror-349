...
class TestFixedHttpPathSegmentMatchingRule(unittest.TestCase):
    """FixedHttpPathSegmentMatchingRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FixedHttpPathSegmentMatchingRule:
        """Test FixedHttpPathSegmentMatchingRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FixedHttpPathSegmentMatchingRule`
        """
        model = FixedHttpPathSegmentMatchingRule()
        if include_optional:
            return FixedHttpPathSegmentMatchingRule(
                name = ''
            )
        else:
            return FixedHttpPathSegmentMatchingRule(
    ...
    def testFixedHttpPathSegmentMatchingRule(self):
        """Test FixedHttpPathSegmentMatchingRule"""
