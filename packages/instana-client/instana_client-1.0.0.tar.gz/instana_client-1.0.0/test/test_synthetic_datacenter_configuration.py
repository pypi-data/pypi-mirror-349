...
class TestSyntheticDatacenterConfiguration(unittest.TestCase):
    """SyntheticDatacenterConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyntheticDatacenterConfiguration:
        """Test SyntheticDatacenterConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyntheticDatacenterConfiguration`
        """
        model = SyntheticDatacenterConfiguration()
        if include_optional:
            return SyntheticDatacenterConfiguration(
                ip_addresses = [
                    ''
                    ]
            )
    ...
    def testSyntheticDatacenterConfiguration(self):
        """Test SyntheticDatacenterConfiguration"""
