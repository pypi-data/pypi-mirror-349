...
class TestDNSActionConfiguration(unittest.TestCase):
    """DNSActionConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSActionConfiguration:
        """Test DNSActionConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSActionConfiguration`
        """
        model = DNSActionConfiguration()
        if include_optional:
            return DNSActionConfiguration(
                accept_cname = True,
                lookup = '',
                lookup_server_name = True,
                port = 56,
                query_time = instana_client.models.dns_action_filter_query_time.DNSActionFilterQueryTime(
                    key = '', 
                    operator = 'CONTAINS', 
                    value = 56, ),
                query_type = 'A',
                ...
                server_retries = 56,
                target_values = [
                    instana_client.models.dns_action_filter_target_value.DNSActionFilterTargetValue(
                        key = 'A', 
                        operator = 'CONTAINS', 
                        value = '', )
                    ]
    ...
    def testDNSActionConfiguration(self):
        """Test DNSActionConfiguration"""
