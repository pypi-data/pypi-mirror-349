...
class TestCustomPayloadField(unittest.TestCase):
    """CustomPayloadField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomPayloadField:
        """Test CustomPayloadField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomPayloadField`
        """
        model = CustomPayloadField()
        if include_optional:
            return CustomPayloadField(
                key = '',
                type = ''
            )
        else:
    ...
    def testCustomPayloadField(self):
        """Test CustomPayloadField"""
