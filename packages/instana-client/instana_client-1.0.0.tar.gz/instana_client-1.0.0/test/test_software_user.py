...
class TestSoftwareUser(unittest.TestCase):
    """SoftwareUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareUser:
        """Test SoftwareUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareUser`
        """
        model = SoftwareUser()
        if include_optional:
            return SoftwareUser(
