...
class TestStaticThresholdRule(unittest.TestCase):
    """StaticThresholdRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticThresholdRule:
        """Test StaticThresholdRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticThresholdRule`
        """
        model = StaticThresholdRule()
        if include_optional:
            return StaticThresholdRule(
                value = 0
            )
        else:
            return StaticThresholdRule(
    ...
    def testStaticThresholdRule(self):
        """Test StaticThresholdRule"""
