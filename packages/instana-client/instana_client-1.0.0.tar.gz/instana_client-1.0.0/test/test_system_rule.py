...
class TestSystemRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SystemRule:
        """Test SystemRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemRule`
        """
        model = SystemRule()
        if include_optional:
            return SystemRule(
