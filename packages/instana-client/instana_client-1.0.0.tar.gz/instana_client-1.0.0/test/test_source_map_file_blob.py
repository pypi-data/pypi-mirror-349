...
class TestSourceMapFileBlob(unittest.TestCase):
    """SourceMapFileBlob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceMapFileBlob:
        """Test SourceMapFileBlob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceMapFileBlob`
        """
        model = SourceMapFileBlob()
        if include_optional:
            return SourceMapFileBlob(
                blob_index = 56,
                size = 56,
                size_on_disk = 56
            )
    ...
    def testSourceMapFileBlob(self):
        """Test SourceMapFileBlob"""
