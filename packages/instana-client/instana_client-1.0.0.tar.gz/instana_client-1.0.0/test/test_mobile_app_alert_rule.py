...
class TestMobileAppAlertRule(unittest.TestCase):
    """MobileAppAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileAppAlertRule:
        """Test MobileAppAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileAppAlertRule`
        """
        model = MobileAppAlertRule()
        if include_optional:
            return MobileAppAlertRule(
                aggregation = 'SUM',
                alert_type = '',
                metric_name = ''
            )
    ...
    def testMobileAppAlertRule(self):
        """Test MobileAppAlertRule"""
