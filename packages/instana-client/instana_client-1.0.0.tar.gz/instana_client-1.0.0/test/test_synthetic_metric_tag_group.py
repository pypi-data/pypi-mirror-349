...
class TestSyntheticMetricTagGroup(unittest.TestCase):
    """SyntheticMetricTagGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyntheticMetricTagGroup:
        """Test SyntheticMetricTagGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyntheticMetricTagGroup`
        """
        model = SyntheticMetricTagGroup()
        if include_optional:
            return SyntheticMetricTagGroup(
                groupby_tag = '',
    ...
    def testSyntheticMetricTagGroup(self):
        """Test SyntheticMetricTagGroup"""
