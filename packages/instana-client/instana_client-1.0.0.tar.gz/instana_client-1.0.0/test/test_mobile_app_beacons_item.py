...
class TestMobileAppBeaconsItem(unittest.TestCase):
    """MobileAppBeaconsItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileAppBeaconsItem:
        """Test MobileAppBeaconsItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileAppBeaconsItem`
        """
        model = MobileAppBeaconsItem()
        if include_optional:
            return MobileAppBeaconsItem(
    ...
    def testMobileAppBeaconsItem(self):
        """Test MobileAppBeaconsItem"""
