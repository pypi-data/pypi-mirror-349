...
class TestPolicyRunnable(unittest.TestCase):
    """PolicyRunnable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyRunnable:
        """Test PolicyRunnable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyRunnable`
        """
        model = PolicyRunnable()
        if include_optional:
            return PolicyRunnable(
                id = '',
