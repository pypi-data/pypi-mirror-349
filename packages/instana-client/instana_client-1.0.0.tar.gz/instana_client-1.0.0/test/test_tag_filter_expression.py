...
class TestTagFilterExpression(unittest.TestCase):
    """TagFilterExpression unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagFilterExpression:
        """Test TagFilterExpression
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagFilterExpression`
        """
        model = TagFilterExpression()
        if include_optional:
            return TagFilterExpression(
                elements = [
                    instana_client.models.tag_filter_expression_element.TagFilterExpressionElement(
                        type = '', )
                    ],
    ...
    def testTagFilterExpression(self):
        """Test TagFilterExpression"""
