...
class TestSyntheticMetricConfiguration(unittest.TestCase):
    """SyntheticMetricConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyntheticMetricConfiguration:
        """Test SyntheticMetricConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyntheticMetricConfiguration`
        """
        model = SyntheticMetricConfiguration()
        if include_optional:
            return SyntheticMetricConfiguration(
                aggregation = 'SUM',
                granularity = 56,
                metric = ''
            )
    ...
    def testSyntheticMetricConfiguration(self):
        """Test SyntheticMetricConfiguration"""
