...
class TestWebexTeamsWebhookIntegration(unittest.TestCase):
    """WebexTeamsWebhookIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebexTeamsWebhookIntegration:
        """Test WebexTeamsWebhookIntegration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebexTeamsWebhookIntegration`
        """
        model = WebexTeamsWebhookIntegration()
        if include_optional:
            return WebexTeamsWebhookIntegration(
                webhook_url = ''
            )
        else:
            return WebexTeamsWebhookIntegration(
    ...
    def testWebexTeamsWebhookIntegration(self):
        """Test WebexTeamsWebhookIntegration"""
