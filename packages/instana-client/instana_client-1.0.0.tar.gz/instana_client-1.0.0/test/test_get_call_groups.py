...
class TestGetCallGroups(unittest.TestCase):
    """GetCallGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCallGroups:
        """Test GetCallGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCallGroups`
        """
        model = GetCallGroups()
        if include_optional:
