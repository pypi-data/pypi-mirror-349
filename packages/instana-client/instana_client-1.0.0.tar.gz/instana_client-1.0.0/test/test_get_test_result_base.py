...
class TestGetTestResultBase(unittest.TestCase):
    """GetTestResultBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTestResultBase:
        """Test GetTestResultBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTestResultBase`
        """
        model = GetTestResultBase()
        if include_optional:
            return GetTestResultBase(
    ...
    def testGetTestResultBase(self):
        """Test GetTestResultBase"""
