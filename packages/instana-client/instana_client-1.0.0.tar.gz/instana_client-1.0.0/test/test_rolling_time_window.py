...
class TestRollingTimeWindow(unittest.TestCase):
    """RollingTimeWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RollingTimeWindow:
        """Test RollingTimeWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RollingTimeWindow`
        """
        model = RollingTimeWindow()
        if include_optional:
    ...
    def testRollingTimeWindow(self):
        """Test RollingTimeWindow"""
