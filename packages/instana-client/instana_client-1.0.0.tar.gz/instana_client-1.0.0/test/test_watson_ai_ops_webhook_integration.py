...
class TestWatsonAIOpsWebhookIntegration(unittest.TestCase):
    """WatsonAIOpsWebhookIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatsonAIOpsWebhookIntegration:
        """Test WatsonAIOpsWebhookIntegration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatsonAIOpsWebhookIntegration`
        """
        model = WatsonAIOpsWebhookIntegration()
        if include_optional:
            return WatsonAIOpsWebhookIntegration(
                headers = [
                    ''
                    ],
                webhook_url = ''
    ...
    def testWatsonAIOpsWebhookIntegration(self):
        """Test WatsonAIOpsWebhookIntegration"""
