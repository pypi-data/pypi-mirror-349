...
class TestMetricPattern(unittest.TestCase):
    """MetricPattern unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetricPattern:
        """Test MetricPattern
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetricPattern`
        """
        model = MetricPattern()
        if include_optional:
