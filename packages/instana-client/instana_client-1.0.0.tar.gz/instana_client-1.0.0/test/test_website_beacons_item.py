...
class TestWebsiteBeaconsItem(unittest.TestCase):
    """WebsiteBeaconsItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteBeaconsItem:
        """Test WebsiteBeaconsItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteBeaconsItem`
        """
        model = WebsiteBeaconsItem()
        if include_optional:
            return WebsiteBeaconsItem(
    ...
    def testWebsiteBeaconsItem(self):
        """Test WebsiteBeaconsItem"""
