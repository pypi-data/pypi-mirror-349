...
class TestInfraMetricConfiguration(unittest.TestCase):
    """InfraMetricConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfraMetricConfiguration:
        """Test InfraMetricConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfraMetricConfiguration`
        """
        model = InfraMetricConfiguration()
        if include_optional:
            return InfraMetricConfiguration(
                aggregation = 'SUM',
    ...
    def testInfraMetricConfiguration(self):
        """Test InfraMetricConfiguration"""
