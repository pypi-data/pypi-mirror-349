...
class TestRecurrentMaintenanceWindow(unittest.TestCase):
    """RecurrentMaintenanceWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecurrentMaintenanceWindow:
        """Test RecurrentMaintenanceWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurrentMaintenanceWindow`
        """
        model = RecurrentMaintenanceWindow()
        if include_optional:
            return RecurrentMaintenanceWindow(
                rrule = '',
                timezone_id = ''
            )
        else:
    ...
    def testRecurrentMaintenanceWindow(self):
        """Test RecurrentMaintenanceWindow"""
