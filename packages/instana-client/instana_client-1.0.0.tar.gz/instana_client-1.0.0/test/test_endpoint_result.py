...
class TestEndpointResult(unittest.TestCase):
    """EndpointResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointResult:
        """Test EndpointResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointResult`
        """
        model = EndpointResult()
        if include_optional:
            return EndpointResult(
                items = [
                    instana_client.models.endpoint.Endpoint(
