...
class TestFailureSyntheticAlertRule(unittest.TestCase):
    """FailureSyntheticAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FailureSyntheticAlertRule:
        """Test FailureSyntheticAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FailureSyntheticAlertRule`
        """
        model = FailureSyntheticAlertRule()
        if include_optional:
            return FailureSyntheticAlertRule(
            )
        else:
            return FailureSyntheticAlertRule(
        )
    ...
    def testFailureSyntheticAlertRule(self):
        """Test FailureSyntheticAlertRule"""
