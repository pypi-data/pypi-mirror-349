...
class TestWebsiteApdexEntity(unittest.TestCase):
    """WebsiteApdexEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteApdexEntity:
        """Test WebsiteApdexEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteApdexEntity`
        """
        model = WebsiteApdexEntity()
        if include_optional:
            return WebsiteApdexEntity(
    ...
    def testWebsiteApdexEntity(self):
        """Test WebsiteApdexEntity"""
