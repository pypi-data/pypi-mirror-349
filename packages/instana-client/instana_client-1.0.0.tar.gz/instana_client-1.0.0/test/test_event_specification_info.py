...
class TestEventSpecificationInfo(unittest.TestCase):
    """EventSpecificationInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventSpecificationInfo:
        """Test EventSpecificationInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventSpecificationInfo`
        """
        model = EventSpecificationInfo()
        if include_optional:
    ...
    def testEventSpecificationInfo(self):
        """Test EventSpecificationInfo"""
