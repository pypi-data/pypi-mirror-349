...
class TestViolationsInSequenceApplicationTimeThreshold(unittest.TestCase):
    """ViolationsInSequenceApplicationTimeThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViolationsInSequenceApplicationTimeThreshold:
        """Test ViolationsInSequenceApplicationTimeThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViolationsInSequenceApplicationTimeThreshold`
        """
        model = ViolationsInSequenceApplicationTimeThreshold()
        if include_optional:
            return ViolationsInSequenceApplicationTimeThreshold(
            )
        else:
            return ViolationsInSequenceApplicationTimeThreshold(
        )
    ...
    def testViolationsInSequenceApplicationTimeThreshold(self):
        """Test ViolationsInSequenceApplicationTimeThreshold"""
