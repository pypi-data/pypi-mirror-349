...
class TestThroughputMobileAppAlertRule(unittest.TestCase):
    """ThroughputMobileAppAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThroughputMobileAppAlertRule:
        """Test ThroughputMobileAppAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThroughputMobileAppAlertRule`
        """
        model = ThroughputMobileAppAlertRule()
        if include_optional:
            return ThroughputMobileAppAlertRule(
            )
        else:
            return ThroughputMobileAppAlertRule(
        )
    ...
    def testThroughputMobileAppAlertRule(self):
        """Test ThroughputMobileAppAlertRule"""
