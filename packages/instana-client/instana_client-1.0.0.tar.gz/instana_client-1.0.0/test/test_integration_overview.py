...
class TestIntegrationOverview(unittest.TestCase):
    """IntegrationOverview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationOverview:
        """Test IntegrationOverview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationOverview`
        """
        model = IntegrationOverview()
        if include_optional:
    ...
    def testIntegrationOverview(self):
        """Test IntegrationOverview"""
