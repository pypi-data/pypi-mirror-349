...
class TestApplicationAlertConfig(unittest.TestCase):
    """ApplicationAlertConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationAlertConfig:
        """Test ApplicationAlertConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationAlertConfig`
        """
        model = ApplicationAlertConfig()
        if include_optional:
    ...
    def testApplicationAlertConfig(self):
        """Test ApplicationAlertConfig"""
