...
class TestActionInstanceParameter(unittest.TestCase):
    """ActionInstanceParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionInstanceParameter:
        """Test ActionInstanceParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionInstanceParameter`
        """
        model = ActionInstanceParameter()
        if include_optional:
            return ActionInstanceParameter(
                display_name = '',
                name = '',
                type = '',
                value = ''
    ...
    def testActionInstanceParameter(self):
        """Test ActionInstanceParameter"""
