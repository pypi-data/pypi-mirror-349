...
class TestLogCountAlertRule(unittest.TestCase):
    """LogCountAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogCountAlertRule:
        """Test LogCountAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogCountAlertRule`
        """
        model = LogCountAlertRule()
        if include_optional:
            return LogCountAlertRule(
            )
        else:
            return LogCountAlertRule(
        )
    ...
    def testLogCountAlertRule(self):
        """Test LogCountAlertRule"""
