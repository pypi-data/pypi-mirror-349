...
class TestWebsiteEventResult(unittest.TestCase):
    """WebsiteEventResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteEventResult:
        """Test WebsiteEventResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteEventResult`
        """
        model = WebsiteEventResult()
        if include_optional:
            return WebsiteEventResult(
                probable_root_cause = {
                    'key' : None
                    },
                website_id = ''
    ...
    def testWebsiteEventResult(self):
        """Test WebsiteEventResult"""
