...
class TestTagTreeNode(unittest.TestCase):
    """TagTreeNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagTreeNode:
        """Test TagTreeNode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagTreeNode`
        """
        model = TagTreeNode()
        if include_optional:
            return TagTreeNode(
