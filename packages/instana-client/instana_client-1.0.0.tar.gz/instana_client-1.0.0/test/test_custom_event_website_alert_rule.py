...
class TestCustomEventWebsiteAlertRule(unittest.TestCase):
    """CustomEventWebsiteAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomEventWebsiteAlertRule:
        """Test CustomEventWebsiteAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomEventWebsiteAlertRule`
        """
        model = CustomEventWebsiteAlertRule()
        if include_optional:
            return CustomEventWebsiteAlertRule(
                custom_event_name = ''
            )
        else:
            return CustomEventWebsiteAlertRule(
    ...
    def testCustomEventWebsiteAlertRule(self):
        """Test CustomEventWebsiteAlertRule"""
