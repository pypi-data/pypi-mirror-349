...
class TestMatchExpressionDTO(unittest.TestCase):
    """MatchExpressionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchExpressionDTO:
        """Test MatchExpressionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchExpressionDTO`
        """
        model = MatchExpressionDTO()
        if include_optional:
            return MatchExpressionDTO(
                type = ''
            )
        else:
            return MatchExpressionDTO(
    ...
    def testMatchExpressionDTO(self):
        """Test MatchExpressionDTO"""
