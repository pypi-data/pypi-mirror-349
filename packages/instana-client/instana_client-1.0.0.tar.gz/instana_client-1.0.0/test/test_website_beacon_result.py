...
class TestWebsiteBeaconResult(unittest.TestCase):
    """WebsiteBeaconResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteBeaconResult:
        """Test WebsiteBeaconResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteBeaconResult`
        """
        model = WebsiteBeaconResult()
        if include_optional:
            return WebsiteBeaconResult(
                ...
                can_load_more = True,
                items = [
                    instana_client.models.website_beacons_item.WebsiteBeaconsItem(
                        beacon = instana_client.models.website_monitoring_beacon.WebsiteMonitoringBeacon(
                            accuracy_radius = -1, 
    ...
    def testWebsiteBeaconResult(self):
        """Test WebsiteBeaconResult"""
