...
class TestWebpageScriptConfiguration(unittest.TestCase):
    """WebpageScriptConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebpageScriptConfiguration:
        """Test WebpageScriptConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebpageScriptConfiguration`
        """
        model = WebpageScriptConfiguration()
        if include_optional:
            return WebpageScriptConfiguration(
                browser = 'chrome',
                record_video = True,
                script = ''
            )
    ...
    def testWebpageScriptConfiguration(self):
        """Test WebpageScriptConfiguration"""
