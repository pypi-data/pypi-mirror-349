...
class TestDynamicFieldValue(unittest.TestCase):
    """DynamicFieldValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicFieldValue:
        """Test DynamicFieldValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicFieldValue`
        """
    ...
    def testDynamicFieldValue(self):
        """Test DynamicFieldValue"""
