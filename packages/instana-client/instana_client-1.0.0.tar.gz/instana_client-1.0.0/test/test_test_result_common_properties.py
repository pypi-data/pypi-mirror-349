...
class TestTestResultCommonProperties(unittest.TestCase):
    """TestResultCommonProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestResultCommonProperties:
        """Test TestResultCommonProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestResultCommonProperties`
        """
        model = TestResultCommonProperties()
        if include_optional:
            return TestResultCommonProperties(
                client_id = '',
                custom_tags = {
                    'key' : ''
                    },
    ...
    def testTestResultCommonProperties(self):
        """Test TestResultCommonProperties"""
