...
class TestAvailabilityBlueprintIndicator(unittest.TestCase):
    """AvailabilityBlueprintIndicator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailabilityBlueprintIndicator:
        """Test AvailabilityBlueprintIndicator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailabilityBlueprintIndicator`
        """
        model = AvailabilityBlueprintIndicator()
        if include_optional:
            return AvailabilityBlueprintIndicator(
                bad_events_filter = instana_client.models.tag_filter_expression_element.TagFilterExpressionElement(
                    type = '', ),
                good_events_filter = instana_client.models.tag_filter_expression_element.TagFilterExpressionElement(
                    type = '', ),
                threshold = 0
            )
        else:
    ...
    def testAvailabilityBlueprintIndicator(self):
        """Test AvailabilityBlueprintIndicator"""
