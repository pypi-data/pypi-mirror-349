...
class TestAccessLogResponse(unittest.TestCase):
    """AccessLogResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessLogResponse:
        """Test AccessLogResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessLogResponse`
        """
        model = AccessLogResponse()
        if include_optional:
            return AccessLogResponse(
                entries = [
                    instana_client.models.access_log_entry.AccessLogEntry(
    ...
    def testAccessLogResponse(self):
        """Test AccessLogResponse"""
