...
class TestMobileAppMonitoringMetricsConfiguration(unittest.TestCase):
    """MobileAppMonitoringMetricsConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileAppMonitoringMetricsConfiguration:
        """Test MobileAppMonitoringMetricsConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileAppMonitoringMetricsConfiguration`
        """
        model = MobileAppMonitoringMetricsConfiguration()
        if include_optional:
            return MobileAppMonitoringMetricsConfiguration(
                aggregation = 'SUM',
                granularity = 56,
                metric = '',
    ...
    def testMobileAppMonitoringMetricsConfiguration(self):
        """Test MobileAppMonitoringMetricsConfiguration"""
