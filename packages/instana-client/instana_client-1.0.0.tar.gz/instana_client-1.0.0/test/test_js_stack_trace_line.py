...
class TestJsStackTraceLine(unittest.TestCase):
    """JsStackTraceLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsStackTraceLine:
        """Test JsStackTraceLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsStackTraceLine`
        """
        model = JsStackTraceLine()
        if include_optional:
            return JsStackTraceLine(
                column = -1,
                file = '',
                line = -1,
                name = '',
