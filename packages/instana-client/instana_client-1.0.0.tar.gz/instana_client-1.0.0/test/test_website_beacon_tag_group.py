...
class TestWebsiteBeaconTagGroup(unittest.TestCase):
    """WebsiteBeaconTagGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteBeaconTagGroup:
        """Test WebsiteBeaconTagGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteBeaconTagGroup`
        """
        model = WebsiteBeaconTagGroup()
        if include_optional:
            return WebsiteBeaconTagGroup(
                groupby_tag = '',
    ...
    def testWebsiteBeaconTagGroup(self):
        """Test WebsiteBeaconTagGroup"""
