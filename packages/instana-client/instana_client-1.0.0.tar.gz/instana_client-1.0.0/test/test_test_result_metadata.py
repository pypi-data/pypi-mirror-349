...
class TestTestResultMetadata(unittest.TestCase):
    """TestResultMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestResultMetadata:
        """Test TestResultMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestResultMetadata`
        """
        model = TestResultMetadata()
        if include_optional:
    ...
    def testTestResultMetadata(self):
        """Test TestResultMetadata"""
