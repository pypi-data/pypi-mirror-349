...
class TestCustomBlueprintIndicator(unittest.TestCase):
    """CustomBlueprintIndicator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomBlueprintIndicator:
        """Test CustomBlueprintIndicator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomBlueprintIndicator`
        """
        model = CustomBlueprintIndicator()
        if include_optional:
            return CustomBlueprintIndicator(
    ...
    def testCustomBlueprintIndicator(self):
        """Test CustomBlueprintIndicator"""
