...
class TestLogAlertRule(unittest.TestCase):
    """LogAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogAlertRule:
        """Test LogAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogAlertRule`
        """
        model = LogAlertRule()
        if include_optional:
            return LogAlertRule(
