...
class TestPrometheusWebhookIntegration(unittest.TestCase):
    """PrometheusWebhookIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrometheusWebhookIntegration:
        """Test PrometheusWebhookIntegration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrometheusWebhookIntegration`
        """
        model = PrometheusWebhookIntegration()
        if include_optional:
            return PrometheusWebhookIntegration(
                receiver = '',
                webhook_url = ''
            )
        else:
    ...
    def testPrometheusWebhookIntegration(self):
        """Test PrometheusWebhookIntegration"""
