...
class TestTypeConfiguration(unittest.TestCase):
    """TypeConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeConfiguration:
        """Test TypeConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeConfiguration`
        """
    ...
    def testTypeConfiguration(self):
        """Test TypeConfiguration"""
