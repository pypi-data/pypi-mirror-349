...
class TestWebsiteAlertConfig(unittest.TestCase):
    """WebsiteAlertConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteAlertConfig:
        """Test WebsiteAlertConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteAlertConfig`
        """
        model = WebsiteAlertConfig()
        if include_optional:
    ...
    def testWebsiteAlertConfig(self):
        """Test WebsiteAlertConfig"""
