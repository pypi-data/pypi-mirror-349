...
class TestEndpointSimple(unittest.TestCase):
    """EndpointSimple unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointSimple:
        """Test EndpointSimple
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointSimple`
        """
        model = EndpointSimple()
        if include_optional:
