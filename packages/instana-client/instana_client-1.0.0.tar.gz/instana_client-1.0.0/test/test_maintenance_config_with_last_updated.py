...
class TestMaintenanceConfigWithLastUpdated(unittest.TestCase):
    """MaintenanceConfigWithLastUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceConfigWithLastUpdated:
        """Test MaintenanceConfigWithLastUpdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceConfigWithLastUpdated`
        """
        model = MaintenanceConfigWithLastUpdated()
        if include_optional:
    ...
    def testMaintenanceConfigWithLastUpdated(self):
        """Test MaintenanceConfigWithLastUpdated"""
