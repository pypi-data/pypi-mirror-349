...
class TestAvailableMetrics(unittest.TestCase):
    """AvailableMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableMetrics:
        """Test AvailableMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableMetrics`
        """
        model = AvailableMetrics()
        if include_optional:
            return AvailableMetrics(
                metrics = [
                    instana_client.models.metric_metadata.MetricMetadata(
                        category = '', 
                        cross_series_aggregations = [
                            'SUM'
                            ], 
                        description = '', 
                        format = 'NUMBER', 
                        id = '', 
                        infra_tag_category = 'ACE', 
                        label = '', 
                        owner_type = '', 
                        tags = [
                            ''
