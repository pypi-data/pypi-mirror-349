...
class TestEntityCountRule(unittest.TestCase):
    """EntityCountRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityCountRule:
        """Test EntityCountRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityCountRule`
        """
        model = EntityCountRule()
        if include_optional:
            return EntityCountRule(
                condition_operator = '>',
