...
class TestSyntheticAlertConfig(unittest.TestCase):
    """SyntheticAlertConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyntheticAlertConfig:
        """Test SyntheticAlertConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyntheticAlertConfig`
        """
        model = SyntheticAlertConfig()
        if include_optional:
    ...
    def testSyntheticAlertConfig(self):
        """Test SyntheticAlertConfig"""
