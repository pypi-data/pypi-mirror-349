...
class TestWebsiteSloEntity(unittest.TestCase):
    """WebsiteSloEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteSloEntity:
        """Test WebsiteSloEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteSloEntity`
        """
        model = WebsiteSloEntity()
        if include_optional:
            return WebsiteSloEntity(
