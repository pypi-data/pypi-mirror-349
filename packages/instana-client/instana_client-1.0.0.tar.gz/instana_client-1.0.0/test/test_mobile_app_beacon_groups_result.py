...
class TestMobileAppBeaconGroupsResult(unittest.TestCase):
    """MobileAppBeaconGroupsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileAppBeaconGroupsResult:
        """Test MobileAppBeaconGroupsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileAppBeaconGroupsResult`
        """
        model = MobileAppBeaconGroupsResult()
        if include_optional:
            return MobileAppBeaconGroupsResult(
                ...
                can_load_more = True,
                items = [
                    instana_client.models.mobile_app_beacon_groups_item.MobileAppBeaconGroupsItem(
    ...
    def testMobileAppBeaconGroupsResult(self):
        """Test MobileAppBeaconGroupsResult"""
