...
class TestApplicationScope(unittest.TestCase):
    """ApplicationScope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationScope:
        """Test ApplicationScope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationScope`
        """
