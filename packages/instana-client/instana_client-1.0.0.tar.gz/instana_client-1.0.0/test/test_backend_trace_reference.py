...
class TestBackendTraceReference(unittest.TestCase):
    """BackendTraceReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackendTraceReference:
        """Test BackendTraceReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackendTraceReference`
        """
        model = BackendTraceReference()
        if include_optional:
    ...
    def testBackendTraceReference(self):
        """Test BackendTraceReference"""
