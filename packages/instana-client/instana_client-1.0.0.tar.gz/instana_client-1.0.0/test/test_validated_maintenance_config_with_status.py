...
class TestValidatedMaintenanceConfigWithStatus(unittest.TestCase):
    """ValidatedMaintenanceConfigWithStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatedMaintenanceConfigWithStatus:
        """Test ValidatedMaintenanceConfigWithStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatedMaintenanceConfigWithStatus`
        """
        model = ValidatedMaintenanceConfigWithStatus()
        if include_optional:
    ...
    def testValidatedMaintenanceConfigWithStatus(self):
        """Test ValidatedMaintenanceConfigWithStatus"""
