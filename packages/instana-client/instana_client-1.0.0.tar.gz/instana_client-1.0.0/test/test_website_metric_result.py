...
class TestWebsiteMetricResult(unittest.TestCase):
    """WebsiteMetricResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteMetricResult:
        """Test WebsiteMetricResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteMetricResult`
        """
        model = WebsiteMetricResult()
        if include_optional:
    ...
    def testWebsiteMetricResult(self):
        """Test WebsiteMetricResult"""
