...
class TestWebsiteMonitoringMetricDescription(unittest.TestCase):
    """WebsiteMonitoringMetricDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteMonitoringMetricDescription:
        """Test WebsiteMonitoringMetricDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteMonitoringMetricDescription`
        """
        model = WebsiteMonitoringMetricDescription()
        if include_optional:
    ...
    def testWebsiteMonitoringMetricDescription(self):
        """Test WebsiteMonitoringMetricDescription"""
