...
class TestTestResultSubtransaction(unittest.TestCase):
    """TestResultSubtransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestResultSubtransaction:
        """Test TestResultSubtransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestResultSubtransaction`
        """
        model = TestResultSubtransaction()
        if include_optional:
            return TestResultSubtransaction(
                metrics = {
                    'key' : None
                    },
                properties = {
    ...
    def testTestResultSubtransaction(self):
        """Test TestResultSubtransaction"""
