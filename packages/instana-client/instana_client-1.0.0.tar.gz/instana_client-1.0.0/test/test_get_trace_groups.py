...
class TestGetTraceGroups(unittest.TestCase):
    """GetTraceGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTraceGroups:
        """Test GetTraceGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTraceGroups`
        """
        model = GetTraceGroups()
        if include_optional:
            return GetTraceGroups(
                group = instana_client.models.group.Group(
                    groupby_tag = '', 
                ...
                metrics = [
                    instana_client.models.metric_config.MetricConfig(
                        aggregation = 'SUM', 
                        granularity = 56, 
                        metric = '', )
                    ],
