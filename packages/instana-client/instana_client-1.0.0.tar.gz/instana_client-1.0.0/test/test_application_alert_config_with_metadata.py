...
class TestApplicationAlertConfigWithMetadata(unittest.TestCase):
    """ApplicationAlertConfigWithMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationAlertConfigWithMetadata:
        """Test ApplicationAlertConfigWithMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationAlertConfigWithMetadata`
        """
        model = ApplicationAlertConfigWithMetadata()
        if include_optional:
    ...
    def testApplicationAlertConfigWithMetadata(self):
        """Test ApplicationAlertConfigWithMetadata"""
