...
class TestCustomEventSpecification(unittest.TestCase):
    """CustomEventSpecification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomEventSpecification:
        """Test CustomEventSpecification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomEventSpecification`
        """
        model = CustomEventSpecification()
        if include_optional:
            return CustomEventSpecification(
                actions = [
    ...
    def testCustomEventSpecification(self):
        """Test CustomEventSpecification"""
