...
class TestAbstractRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AbstractRule:
        """Test AbstractRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbstractRule`
        """
        model = AbstractRule()
        if include_optional:
            return AbstractRule(
