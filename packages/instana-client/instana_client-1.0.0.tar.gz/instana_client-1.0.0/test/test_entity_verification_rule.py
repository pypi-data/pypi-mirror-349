...
class TestEntityVerificationRule(unittest.TestCase):
    """EntityVerificationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityVerificationRule:
        """Test EntityVerificationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityVerificationRule`
        """
        model = EntityVerificationRule()
        if include_optional:
            return EntityVerificationRule(
    ...
    def testEntityVerificationRule(self):
        """Test EntityVerificationRule"""
