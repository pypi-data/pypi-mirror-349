...
class TestServiceLevelsTimeThreshold(unittest.TestCase):
    """ServiceLevelsTimeThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceLevelsTimeThreshold:
        """Test ServiceLevelsTimeThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceLevelsTimeThreshold`
        """
        model = ServiceLevelsTimeThreshold()
        if include_optional:
            return ServiceLevelsTimeThreshold(
                expiry = 56,
                time_window = 56
            )
        else:
    ...
    def testServiceLevelsTimeThreshold(self):
        """Test ServiceLevelsTimeThreshold"""
