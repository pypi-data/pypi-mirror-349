...
class TestMobileAppMonitoringBeacon(unittest.TestCase):
    """MobileAppMonitoringBeacon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileAppMonitoringBeacon:
        """Test MobileAppMonitoringBeacon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileAppMonitoringBeacon`
        """
        model = MobileAppMonitoringBeacon()
        if include_optional:
    ...
    def testMobileAppMonitoringBeacon(self):
        """Test MobileAppMonitoringBeacon"""
