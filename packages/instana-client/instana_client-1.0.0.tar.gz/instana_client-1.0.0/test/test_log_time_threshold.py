...
class TestLogTimeThreshold(unittest.TestCase):
    """LogTimeThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogTimeThreshold:
        """Test LogTimeThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogTimeThreshold`
        """
        model = LogTimeThreshold()
        if include_optional:
