...
class TestBusinessPerspectiveConfig(unittest.TestCase):
    """BusinessPerspectiveConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessPerspectiveConfig:
        """Test BusinessPerspectiveConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessPerspectiveConfig`
        """
        model = BusinessPerspectiveConfig()
        if include_optional:
            return BusinessPerspectiveConfig(
                description = '',
                id = '0',
                name = '',
    ...
    def testBusinessPerspectiveConfig(self):
        """Test BusinessPerspectiveConfig"""
