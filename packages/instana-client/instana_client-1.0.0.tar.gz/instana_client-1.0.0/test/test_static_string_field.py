...
class TestStaticStringField(unittest.TestCase):
    """StaticStringField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticStringField:
        """Test StaticStringField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticStringField`
        """
        model = StaticStringField()
        if include_optional:
    ...
    def testStaticStringField(self):
        """Test StaticStringField"""
