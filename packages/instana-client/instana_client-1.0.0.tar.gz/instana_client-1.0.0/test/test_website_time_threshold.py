...
class TestWebsiteTimeThreshold(unittest.TestCase):
    """WebsiteTimeThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteTimeThreshold:
        """Test WebsiteTimeThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteTimeThreshold`
        """
        model = WebsiteTimeThreshold()
        if include_optional:
            return WebsiteTimeThreshold(
                time_window = 56,
                type = ''
            )
        else:
    ...
    def testWebsiteTimeThreshold(self):
        """Test WebsiteTimeThreshold"""
