...
class TestMatchAllHttpPathSegmentMatchingRule(unittest.TestCase):
    """MatchAllHttpPathSegmentMatchingRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAllHttpPathSegmentMatchingRule:
        """Test MatchAllHttpPathSegmentMatchingRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAllHttpPathSegmentMatchingRule`
        """
        model = MatchAllHttpPathSegmentMatchingRule()
        if include_optional:
            return MatchAllHttpPathSegmentMatchingRule(
            )
        else:
            return MatchAllHttpPathSegmentMatchingRule(
        )
    ...
    def testMatchAllHttpPathSegmentMatchingRule(self):
        """Test MatchAllHttpPathSegmentMatchingRule"""
