...
class TestHttpEndpointConfig(unittest.TestCase):
    """HttpEndpointConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HttpEndpointConfig:
        """Test HttpEndpointConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HttpEndpointConfig`
        """
        model = HttpEndpointConfig()
        if include_optional:
    ...
    def testHttpEndpointConfig(self):
        """Test HttpEndpointConfig"""
