...
class TestWebsiteAlertRule(unittest.TestCase):
    """WebsiteAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteAlertRule:
        """Test WebsiteAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteAlertRule`
        """
        model = WebsiteAlertRule()
        if include_optional:
            return WebsiteAlertRule(
                aggregation = 'SUM',
                alert_type = '',
                metric_name = ''
            )
