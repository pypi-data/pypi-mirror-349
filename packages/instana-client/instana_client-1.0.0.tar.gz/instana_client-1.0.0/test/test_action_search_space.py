...
class TestActionSearchSpace(unittest.TestCase):
    """ActionSearchSpace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionSearchSpace:
        """Test ActionSearchSpace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionSearchSpace`
        """
        model = ActionSearchSpace()
        if include_optional:
            return ActionSearchSpace(
                description = '',
                entity_type = '',
                event_id = '',
                name = ''
    ...
    def testActionSearchSpace(self):
        """Test ActionSearchSpace"""
