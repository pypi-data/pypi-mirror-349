...
class TestSlownessWebsiteAlertRule(unittest.TestCase):
    """SlownessWebsiteAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlownessWebsiteAlertRule:
        """Test SlownessWebsiteAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlownessWebsiteAlertRule`
        """
        model = SlownessWebsiteAlertRule()
        if include_optional:
            return SlownessWebsiteAlertRule(
            )
        else:
            return SlownessWebsiteAlertRule(
        )
    ...
    def testSlownessWebsiteAlertRule(self):
        """Test SlownessWebsiteAlertRule"""
