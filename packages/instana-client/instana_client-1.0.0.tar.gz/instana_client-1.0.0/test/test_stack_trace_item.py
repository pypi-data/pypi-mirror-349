...
class TestStackTraceItem(unittest.TestCase):
    """StackTraceItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StackTraceItem:
        """Test StackTraceItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StackTraceItem`
        """
        model = StackTraceItem()
        if include_optional:
