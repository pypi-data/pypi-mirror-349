...
class TestFixedTimeWindow(unittest.TestCase):
    """FixedTimeWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FixedTimeWindow:
        """Test FixedTimeWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FixedTimeWindow`
        """
        model = FixedTimeWindow()
        if include_optional:
