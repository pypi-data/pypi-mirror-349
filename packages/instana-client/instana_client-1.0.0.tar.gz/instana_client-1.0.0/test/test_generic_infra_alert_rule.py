...
class TestGenericInfraAlertRule(unittest.TestCase):
    """GenericInfraAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenericInfraAlertRule:
        """Test GenericInfraAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenericInfraAlertRule`
        """
        model = GenericInfraAlertRule()
        if include_optional:
            return GenericInfraAlertRule(
            )
        else:
            return GenericInfraAlertRule(
        )
    ...
    def testGenericInfraAlertRule(self):
        """Test GenericInfraAlertRule"""
