...
class TestApplicationSliEntity(unittest.TestCase):
    """ApplicationSliEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationSliEntity:
        """Test ApplicationSliEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationSliEntity`
        """
        model = ApplicationSliEntity()
        if include_optional:
            return ApplicationSliEntity(
                application_id = '',
                boundary_scope = 'ALL',
                endpoint_id = '',
                service_id = ''
    ...
    def testApplicationSliEntity(self):
        """Test ApplicationSliEntity"""
