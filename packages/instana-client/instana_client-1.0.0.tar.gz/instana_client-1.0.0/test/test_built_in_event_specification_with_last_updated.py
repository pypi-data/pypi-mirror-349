...
class TestBuiltInEventSpecificationWithLastUpdated(unittest.TestCase):
    """BuiltInEventSpecificationWithLastUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuiltInEventSpecificationWithLastUpdated:
        """Test BuiltInEventSpecificationWithLastUpdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuiltInEventSpecificationWithLastUpdated`
        """
        model = BuiltInEventSpecificationWithLastUpdated()
        if include_optional:
    ...
    def testBuiltInEventSpecificationWithLastUpdated(self):
        """Test BuiltInEventSpecificationWithLastUpdated"""
