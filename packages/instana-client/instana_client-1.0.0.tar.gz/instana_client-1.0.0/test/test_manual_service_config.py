...
class TestManualServiceConfig(unittest.TestCase):
    """ManualServiceConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManualServiceConfig:
        """Test ManualServiceConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManualServiceConfig`
        """
        model = ManualServiceConfig()
        if include_optional:
    ...
    def testManualServiceConfig(self):
        """Test ManualServiceConfig"""
