...
class TestCrashMobileAppAlertRule(unittest.TestCase):
    """CrashMobileAppAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrashMobileAppAlertRule:
        """Test CrashMobileAppAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrashMobileAppAlertRule`
        """
        model = CrashMobileAppAlertRule()
        if include_optional:
            return CrashMobileAppAlertRule(
            )
        else:
            return CrashMobileAppAlertRule(
        )
    ...
    def testCrashMobileAppAlertRule(self):
        """Test CrashMobileAppAlertRule"""
