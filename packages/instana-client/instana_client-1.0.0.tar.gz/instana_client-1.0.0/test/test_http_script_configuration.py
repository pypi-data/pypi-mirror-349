...
class TestHttpScriptConfiguration(unittest.TestCase):
    """HttpScriptConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HttpScriptConfiguration:
        """Test HttpScriptConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HttpScriptConfiguration`
        """
        model = HttpScriptConfiguration()
        if include_optional:
            return HttpScriptConfiguration(
                script = '',
                script_type = 'Basic',
    ...
    def testHttpScriptConfiguration(self):
        """Test HttpScriptConfiguration"""
