...
class TestAdjustedTimeframe(unittest.TestCase):
    """AdjustedTimeframe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdjustedTimeframe:
        """Test AdjustedTimeframe
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdjustedTimeframe`
        """
        model = AdjustedTimeframe()
        if include_optional:
    ...
    def testAdjustedTimeframe(self):
        """Test AdjustedTimeframe"""
