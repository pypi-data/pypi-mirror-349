...
class TestGetPayloadKeysResult(unittest.TestCase):
    """GetPayloadKeysResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPayloadKeysResult:
        """Test GetPayloadKeysResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPayloadKeysResult`
        """
        model = GetPayloadKeysResult()
        if include_optional:
            return GetPayloadKeysResult(
                payload_keys = [
                    ''
                    ]
            )
    ...
    def testGetPayloadKeysResult(self):
        """Test GetPayloadKeysResult"""
