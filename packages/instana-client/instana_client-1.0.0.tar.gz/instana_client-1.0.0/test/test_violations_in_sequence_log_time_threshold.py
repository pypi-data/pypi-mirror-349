...
class TestViolationsInSequenceLogTimeThreshold(unittest.TestCase):
    """ViolationsInSequenceLogTimeThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViolationsInSequenceLogTimeThreshold:
        """Test ViolationsInSequenceLogTimeThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViolationsInSequenceLogTimeThreshold`
        """
        model = ViolationsInSequenceLogTimeThreshold()
        if include_optional:
            return ViolationsInSequenceLogTimeThreshold(
            )
        else:
            return ViolationsInSequenceLogTimeThreshold(
        )
    ...
    def testViolationsInSequenceLogTimeThreshold(self):
        """Test ViolationsInSequenceLogTimeThreshold"""
