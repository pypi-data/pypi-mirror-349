...
class TestPagerdutyIntegration(unittest.TestCase):
    """PagerdutyIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagerdutyIntegration:
        """Test PagerdutyIntegration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagerdutyIntegration`
        """
    ...
    def testPagerdutyIntegration(self):
        """Test PagerdutyIntegration"""
