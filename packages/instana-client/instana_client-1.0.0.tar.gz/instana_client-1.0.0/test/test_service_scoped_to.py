...
class TestServiceScopedTo(unittest.TestCase):
    """ServiceScopedTo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceScopedTo:
        """Test ServiceScopedTo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceScopedTo`
        """
        model = ServiceScopedTo()
        if include_optional:
