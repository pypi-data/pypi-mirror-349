...
class TestAlertingConfigurationWithLastUpdated(unittest.TestCase):
    """AlertingConfigurationWithLastUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertingConfigurationWithLastUpdated:
        """Test AlertingConfigurationWithLastUpdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertingConfigurationWithLastUpdated`
        """
        model = AlertingConfigurationWithLastUpdated()
        if include_optional:
    ...
    def testAlertingConfigurationWithLastUpdated(self):
        """Test AlertingConfigurationWithLastUpdated"""
