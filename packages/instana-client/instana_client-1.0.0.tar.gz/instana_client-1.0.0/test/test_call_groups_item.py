...
class TestCallGroupsItem(unittest.TestCase):
    """CallGroupsItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallGroupsItem:
        """Test CallGroupsItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallGroupsItem`
        """
        model = CallGroupsItem()
        if include_optional:
            return CallGroupsItem(
                cursor = None,
                metrics = {
                    'key' : [
                        [
