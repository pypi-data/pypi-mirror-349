...
class TestPostSnapshotsResult(unittest.TestCase):
    """PostSnapshotsResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSnapshotsResult:
        """Test PostSnapshotsResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSnapshotsResult`
        """
        model = PostSnapshotsResult()
        if include_optional:
            return PostSnapshotsResult(
                items = [
    ...
    def testPostSnapshotsResult(self):
        """Test PostSnapshotsResult"""
