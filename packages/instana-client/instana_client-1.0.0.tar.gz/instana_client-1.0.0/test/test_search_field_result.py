...
class TestSearchFieldResult(unittest.TestCase):
    """SearchFieldResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchFieldResult:
        """Test SearchFieldResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchFieldResult`
        """
        model = SearchFieldResult()
        if include_optional:
            return SearchFieldResult(
                context = 'Entity data, trace data, even data',
                description = '',
                fixed_values = [
                    ''
                    ],
    ...
    def testSearchFieldResult(self):
        """Test SearchFieldResult"""
