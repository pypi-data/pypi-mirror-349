...
class TestGetTestResultList(unittest.TestCase):
    """GetTestResultList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTestResultList:
        """Test GetTestResultList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTestResultList`
        """
        model = GetTestResultList()
        if include_optional:
    ...
    def testGetTestResultList(self):
        """Test GetTestResultList"""
