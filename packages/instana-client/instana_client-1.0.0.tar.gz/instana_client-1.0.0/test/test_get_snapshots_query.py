...
class TestGetSnapshotsQuery(unittest.TestCase):
    """GetSnapshotsQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSnapshotsQuery:
        """Test GetSnapshotsQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSnapshotsQuery`
        """
        model = GetSnapshotsQuery()
        if include_optional:
            return GetSnapshotsQuery(
                snapshot_ids = [
                    ''
                    ],
    ...
    def testGetSnapshotsQuery(self):
        """Test GetSnapshotsQuery"""
