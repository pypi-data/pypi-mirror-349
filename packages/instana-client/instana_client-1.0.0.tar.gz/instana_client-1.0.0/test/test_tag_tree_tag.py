...
class TestTagTreeTag(unittest.TestCase):
    """TagTreeTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagTreeTag:
        """Test TagTreeTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagTreeTag`
        """
        model = TagTreeTag()
        if include_optional:
            return TagTreeTag(
