...
class TestSystemRuleLabel(unittest.TestCase):
    """SystemRuleLabel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemRuleLabel:
        """Test SystemRuleLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemRuleLabel`
        """
        model = SystemRuleLabel()
        if include_optional:
