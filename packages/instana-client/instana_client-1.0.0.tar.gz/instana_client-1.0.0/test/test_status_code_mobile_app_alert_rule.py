...
class TestStatusCodeMobileAppAlertRule(unittest.TestCase):
    """StatusCodeMobileAppAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusCodeMobileAppAlertRule:
        """Test StatusCodeMobileAppAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusCodeMobileAppAlertRule`
        """
        model = StatusCodeMobileAppAlertRule()
        if include_optional:
            return StatusCodeMobileAppAlertRule(
                operator = 'EQUALS',
                value = ''
            )
        else:
    ...
    def testStatusCodeMobileAppAlertRule(self):
        """Test StatusCodeMobileAppAlertRule"""
