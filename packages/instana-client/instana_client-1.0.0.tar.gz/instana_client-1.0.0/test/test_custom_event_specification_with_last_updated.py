...
class TestCustomEventSpecificationWithLastUpdated(unittest.TestCase):
    """CustomEventSpecificationWithLastUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomEventSpecificationWithLastUpdated:
        """Test CustomEventSpecificationWithLastUpdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomEventSpecificationWithLastUpdated`
        """
        model = CustomEventSpecificationWithLastUpdated()
        if include_optional:
            return CustomEventSpecificationWithLastUpdated(
                actions = [
                    instana_client.models.action.Action(
                ...
                rules = [
                    instana_client.models.abstract_rule.AbstractRule(
                        rule_type = '', 
                        severity = 56, )
                    ],
                triggering = True
    ...
    def testCustomEventSpecificationWithLastUpdated(self):
        """Test CustomEventSpecificationWithLastUpdated"""
