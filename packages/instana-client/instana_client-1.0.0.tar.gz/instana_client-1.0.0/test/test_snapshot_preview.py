...
class TestSnapshotPreview(unittest.TestCase):
    """SnapshotPreview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnapshotPreview:
        """Test SnapshotPreview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotPreview`
        """
        model = SnapshotPreview()
        if include_optional:
