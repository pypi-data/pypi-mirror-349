...
class TestScopeBinding(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScopeBinding:
        """Test ScopeBinding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScopeBinding`
        """
        model = ScopeBinding()
        if include_optional:
            return ScopeBinding(
