...
class TestServiceLevelObjectiveAlertRule(unittest.TestCase):
    """ServiceLevelObjectiveAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceLevelObjectiveAlertRule:
        """Test ServiceLevelObjectiveAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceLevelObjectiveAlertRule`
        """
        model = ServiceLevelObjectiveAlertRule()
        if include_optional:
            return ServiceLevelObjectiveAlertRule(
                metric = 'STATUS'
            )
        else:
            return ServiceLevelObjectiveAlertRule(
    ...
    def testServiceLevelObjectiveAlertRule(self):
        """Test ServiceLevelObjectiveAlertRule"""
