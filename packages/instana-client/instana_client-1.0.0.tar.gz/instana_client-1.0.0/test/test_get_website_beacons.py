...
class TestGetWebsiteBeacons(unittest.TestCase):
    """GetWebsiteBeacons unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebsiteBeacons:
        """Test GetWebsiteBeacons
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsiteBeacons`
        """
        model = GetWebsiteBeacons()
        if include_optional:
    ...
    def testGetWebsiteBeacons(self):
        """Test GetWebsiteBeacons"""
