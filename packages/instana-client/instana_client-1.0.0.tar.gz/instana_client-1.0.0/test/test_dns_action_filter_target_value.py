...
class TestDNSActionFilterTargetValue(unittest.TestCase):
    """DNSActionFilterTargetValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSActionFilterTargetValue:
        """Test DNSActionFilterTargetValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSActionFilterTargetValue`
        """
        model = DNSActionFilterTargetValue()
        if include_optional:
            return DNSActionFilterTargetValue(
                key = 'A',
                operator = 'CONTAINS',
                value = ''
            )
    ...
    def testDNSActionFilterTargetValue(self):
        """Test DNSActionFilterTargetValue"""
