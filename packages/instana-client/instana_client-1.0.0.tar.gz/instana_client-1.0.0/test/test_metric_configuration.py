...
class TestMetricConfiguration(unittest.TestCase):
    """MetricConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetricConfiguration:
        """Test MetricConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetricConfiguration`
        """
    ...
    def testMetricConfiguration(self):
        """Test MetricConfiguration"""
