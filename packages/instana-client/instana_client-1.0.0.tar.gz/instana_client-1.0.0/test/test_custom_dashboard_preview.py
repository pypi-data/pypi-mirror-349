...
class TestCustomDashboardPreview(unittest.TestCase):
    """CustomDashboardPreview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomDashboardPreview:
        """Test CustomDashboardPreview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomDashboardPreview`
        """
        model = CustomDashboardPreview()
        if include_optional:
    ...
    def testCustomDashboardPreview(self):
        """Test CustomDashboardPreview"""
