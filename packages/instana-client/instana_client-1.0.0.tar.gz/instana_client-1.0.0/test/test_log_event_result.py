...
class TestLogEventResult(unittest.TestCase):
    """LogEventResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogEventResult:
        """Test LogEventResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogEventResult`
        """
        model = LogEventResult()
        if include_optional:
