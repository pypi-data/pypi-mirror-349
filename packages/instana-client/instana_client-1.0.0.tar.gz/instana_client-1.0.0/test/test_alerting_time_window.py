...
class TestAlertingTimeWindow(unittest.TestCase):
    """AlertingTimeWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertingTimeWindow:
        """Test AlertingTimeWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertingTimeWindow`
        """
        model = AlertingTimeWindow()
        if include_optional:
            return AlertingTimeWindow(
                duration = 56,
    ...
    def testAlertingTimeWindow(self):
        """Test AlertingTimeWindow"""
