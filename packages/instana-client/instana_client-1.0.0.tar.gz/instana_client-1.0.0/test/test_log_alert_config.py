...
class TestLogAlertConfig(unittest.TestCase):
    """LogAlertConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogAlertConfig:
        """Test LogAlertConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogAlertConfig`
        """
        model = LogAlertConfig()
        if include_optional:
            return LogAlertConfig(
                alert_channel_ids = [
                    ''
                    ],
