...
class TestWebsiteMonitoringMetricsConfiguration(unittest.TestCase):
    """WebsiteMonitoringMetricsConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteMonitoringMetricsConfiguration:
        """Test WebsiteMonitoringMetricsConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteMonitoringMetricsConfiguration`
        """
        model = WebsiteMonitoringMetricsConfiguration()
        if include_optional:
            return WebsiteMonitoringMetricsConfiguration(
                aggregation = 'SUM',
                granularity = 56,
                metric = ''
            )
    ...
    def testWebsiteMonitoringMetricsConfiguration(self):
        """Test WebsiteMonitoringMetricsConfiguration"""
