...
class TestGeoMappingRule(unittest.TestCase):
    """GeoMappingRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoMappingRule:
        """Test GeoMappingRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoMappingRule`
        """
        model = GeoMappingRule()
        if include_optional:
            return GeoMappingRule(
                accuracy_radius = -1,
                cidr = '',
                city = '',
                continent = '',
