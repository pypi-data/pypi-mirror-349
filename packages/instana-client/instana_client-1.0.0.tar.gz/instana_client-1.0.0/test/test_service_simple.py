...
class TestServiceSimple(unittest.TestCase):
    """ServiceSimple unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceSimple:
        """Test ServiceSimple
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceSimple`
        """
        model = ServiceSimple()
        if include_optional:
