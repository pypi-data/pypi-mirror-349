...
class TestInfraAlertRule(unittest.TestCase):
    """InfraAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfraAlertRule:
        """Test InfraAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfraAlertRule`
        """
        model = InfraAlertRule()
        if include_optional:
            return InfraAlertRule(
                aggregation = 'SUM',
                alert_type = '',
