...
class TestThroughputApplicationAlertRule(unittest.TestCase):
    """ThroughputApplicationAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThroughputApplicationAlertRule:
        """Test ThroughputApplicationAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThroughputApplicationAlertRule`
        """
        model = ThroughputApplicationAlertRule()
        if include_optional:
            return ThroughputApplicationAlertRule(
            )
        else:
            return ThroughputApplicationAlertRule(
        )
    ...
    def testThroughputApplicationAlertRule(self):
        """Test ThroughputApplicationAlertRule"""
