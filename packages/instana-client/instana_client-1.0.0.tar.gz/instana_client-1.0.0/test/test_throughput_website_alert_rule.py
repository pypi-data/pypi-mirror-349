...
class TestThroughputWebsiteAlertRule(unittest.TestCase):
    """ThroughputWebsiteAlertRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThroughputWebsiteAlertRule:
        """Test ThroughputWebsiteAlertRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThroughputWebsiteAlertRule`
        """
        model = ThroughputWebsiteAlertRule()
        if include_optional:
            return ThroughputWebsiteAlertRule(
            )
        else:
            return ThroughputWebsiteAlertRule(
        )
    ...
    def testThroughputWebsiteAlertRule(self):
        """Test ThroughputWebsiteAlertRule"""
