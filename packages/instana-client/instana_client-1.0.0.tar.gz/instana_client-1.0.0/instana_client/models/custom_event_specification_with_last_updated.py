...
class CustomEventSpecificationWithLastUpdated(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["actions", "applicationAlertConfigId", "deleted", "description", "enabled", "entityType", "expirationTime", "id", "lastUpdated", "migrated", "name", "query", "ruleLogicalOperator", "rules", "triggering"]
