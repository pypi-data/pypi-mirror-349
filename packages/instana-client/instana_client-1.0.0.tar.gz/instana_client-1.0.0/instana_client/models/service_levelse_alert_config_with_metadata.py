...
class ServiceLevelseAlertConfigWithMetadata(BaseModel):
    ...
    severity: Optional[StrictInt] = Field(default=None, description="This is the severity of the alert. The value can be: <b>5</b>: warning, <b>10</b>: critical.")
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "burnRateTimeWindows", "created", "customPayloadFields", "description", "enabled", "id", "initialCreated", "name", "readOnly", "rule", "severity", "sloIds", "threshold", "timeThreshold", "triggering"]
