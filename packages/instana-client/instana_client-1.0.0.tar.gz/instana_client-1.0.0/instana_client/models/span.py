...
class Span(BaseModel):
    ...
    Span
    """ # noqa: E501
    batch_self_time: Optional[StrictInt] = Field(default=None, alias="batchSelfTime")
    batch_size: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="batchSize")
    calculated_self_time: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="calculatedSelfTime")
    call_id: StrictStr = Field(alias="callId")
    child_spans: List[Span] = Field(alias="childSpans")
    ...
    kind: StrictStr
    label: Annotated[str, Field(min_length=0, strict=True, max_length=128)]
    name: StrictStr
    parent_id: Optional[StrictStr] = Field(default=None, alias="parentId")
    source: Optional[SpanRelation] = None
    stack_trace: List[StackTraceItem] = Field(alias="stackTrace")
    start: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["batchSelfTime", "batchSize", "calculatedSelfTime", "callId", "childSpans", "data", "destination", "duration", "errorCount", "foreignParentId", "id", "isSynthetic", "kind", "label", "name", "parentId", "source", "stackTrace", "start"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "calculatedSelfTime": obj.get("calculatedSelfTime"),
            "callId": obj.get("callId"),
            "childSpans": [Span.from_dict(_item) for _item in obj["childSpans"]] if obj.get("childSpans") is not None else None,
            "data": obj.get("data"),
...
Span.model_rebuild(raise_errors=False)
