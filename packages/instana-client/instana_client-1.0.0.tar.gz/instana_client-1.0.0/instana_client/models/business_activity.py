...
class BusinessActivity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["activityId", "activityName", "activityStart", "activityType", "callId", "processDefinitionId", "processDefinitionName", "rootProcessInstanceId"]
