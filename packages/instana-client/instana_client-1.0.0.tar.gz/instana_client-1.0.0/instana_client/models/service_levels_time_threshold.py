...
class ServiceLevelsTimeThreshold(BaseModel):
    ...
    """ # noqa: E501
    expiry: Optional[StrictInt] = Field(default=None, description="This is the cooldown period when the active alert misses threshold and stop emitting notification.")
    time_window: Optional[StrictInt] = Field(default=None, description="This is the grace period when the threshold is reached and the alert becomes active to emit notification.", alias="timeWindow")
