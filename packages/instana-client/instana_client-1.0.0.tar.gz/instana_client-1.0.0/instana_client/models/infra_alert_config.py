...
class InfraAlertConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "alertChannels", "customPayloadFields", "description", "evaluationType", "gracePeriod", "granularity", "groupBy", "name", "rule", "rules", "severity", "tagFilterExpression", "threshold", "timeThreshold"]
