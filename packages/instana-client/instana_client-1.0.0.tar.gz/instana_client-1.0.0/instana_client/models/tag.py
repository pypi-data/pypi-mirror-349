...
class Tag(BaseModel):
    ...
    def availability_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['INFRASTRUCTURE_METRICS', 'APPLICATION', 'WEBSITE', 'MOBILE_APP', 'EUM', 'EVENT', 'SLI', 'SLO', 'SLO_PREVIEW', 'USAGE', 'LOG', 'SYNTHETICS', 'SYNTHETICS_DETAIL', 'APDEX', 'BIZOPS', 'SUBTRACE', 'UNKNOWN']):
                raise ValueError("each list item must be one of ('INFRASTRUCTURE_METRICS', 'APPLICATION', 'WEBSITE', 'MOBILE_APP', 'EUM', 'EVENT', 'SLI', 'SLO', 'SLO_PREVIEW', 'USAGE', 'LOG', 'SYNTHETICS', 'SYNTHETICS_DETAIL', 'APDEX', 'BIZOPS', 'SUBTRACE', 'UNKNOWN')")
        return value

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BOOLEAN', 'STRING', 'NUMBER', 'STRING_SET', 'STRING_LIST', 'KEY_VALUE_PAIR', 'KEY_NUMBER_PAIR']):
            raise ValueError("must be one of enum values ('BOOLEAN', 'STRING', 'NUMBER', 'STRING_SET', 'STRING_LIST', 'KEY_VALUE_PAIR', 'KEY_NUMBER_PAIR')")
        return value
