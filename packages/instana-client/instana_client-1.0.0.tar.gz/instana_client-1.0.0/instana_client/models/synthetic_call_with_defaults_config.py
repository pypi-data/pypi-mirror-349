...
class SyntheticCallWithDefaultsConfig(BaseModel):
    ...
    """ # noqa: E501
    custom_rules: Annotated[List[SyntheticCallRule], Field(min_length=0, max_length=500)] = Field(alias="customRules")
    default_rules: List[SyntheticCallRule] = Field(alias="defaultRules")
    default_rules_enabled: Optional[StrictBool] = Field(default=None, alias="defaultRulesEnabled")
