...
class SloEntity(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'application': 'ApplicationSloEntity','synthetic': 'SyntheticSloEntity','website': 'WebsiteSloEntity'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[ApplicationSloEntity, SyntheticSloEntity, WebsiteSloEntity]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ApplicationSloEntity, SyntheticSloEntity, WebsiteSloEntity]]:
