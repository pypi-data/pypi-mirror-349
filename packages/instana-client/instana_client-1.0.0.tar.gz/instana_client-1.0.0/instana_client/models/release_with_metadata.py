...
class ReleaseWithMetadata(BaseModel):
    ...
    ReleaseWithMetadata
    """ # noqa: E501
    applications: Optional[Annotated[List[ApplicationScopeWithMetadata], Field(min_length=0, max_length=10)]] = None
    ...
    services: Optional[Annotated[List[ServiceScopeWithMetadata], Field(min_length=0, max_length=10)]] = None
