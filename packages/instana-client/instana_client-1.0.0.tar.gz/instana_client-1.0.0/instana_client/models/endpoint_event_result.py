...
class EndpointEventResult(EventResult):
    ...
    endpoint_service_id: Optional[StrictStr] = Field(default=None, alias="endpointServiceId")
    probable_root_cause: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, alias="probableRootCause")
    __properties: ClassVar[List[str]] = ["detail", "end", "entityLabel", "entityName", "entityType", "eventId", "eventSpecificationId", "fixSuggestion", "metrics", "probableCause", "problem", "recentEvents", "severity", "snapshotId", "start", "state", "type", "applicationId", "endpointId", "endpointServiceId", "probableRootCause"]
