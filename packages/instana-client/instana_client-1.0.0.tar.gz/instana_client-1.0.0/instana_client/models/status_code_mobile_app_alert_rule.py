...
class StatusCodeMobileAppAlertRule(MobileAppAlertRule):
    ...
    def operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['EQUALS', 'CONTAINS', 'LESS_THAN', 'LESS_OR_EQUAL_THAN', 'GREATER_THAN', 'GREATER_OR_EQUAL_THAN', 'NOT_EMPTY', 'NOT_EQUAL', 'NOT_CONTAIN', 'IS_EMPTY', 'NOT_BLANK', 'IS_BLANK', 'STARTS_WITH', 'ENDS_WITH', 'NOT_STARTS_WITH', 'NOT_ENDS_WITH']):
            raise ValueError("must be one of enum values ('EQUALS', 'CONTAINS', 'LESS_THAN', 'LESS_OR_EQUAL_THAN', 'GREATER_THAN', 'GREATER_OR_EQUAL_THAN', 'NOT_EMPTY', 'NOT_EQUAL', 'NOT_CONTAIN', 'IS_EMPTY', 'NOT_BLANK', 'IS_BLANK', 'STARTS_WITH', 'ENDS_WITH', 'NOT_STARTS_WITH', 'NOT_ENDS_WITH')")
        return value
