...
class DNSActionConfiguration(SyntheticTypeConfiguration):
    """
    ...
    query_time: Optional[DNSActionFilterQueryTime] = Field(default=None, alias="queryTime")
    ...
    target_values: Optional[List[DNSActionFilterTargetValue]] = Field(default=None, alias="targetValues")
    __properties: ClassVar[List[str]] = ["markSyntheticCall", "retries", "retryInterval", "syntheticType", "timeout", "acceptCNAME", "lookup", "lookupServerName", "port", "queryTime", "queryType", "recursiveLookups", "server", "serverRetries", "targetValues"]
    ...
    def query_type_validate_enum(cls, value):
        ...
        if value not in set(['A', 'AAAA', 'ANY', 'CNAME', 'NS']):
            raise ValueError("must be one of enum values ('A', 'AAAA', 'ANY', 'CNAME', 'NS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "port": obj.get("port"),
            "queryTime": DNSActionFilterQueryTime.from_dict(obj["queryTime"]) if obj.get("queryTime") is not None else None,
            "queryType": obj.get("queryType"),
            "recursiveLookups": obj.get("recursiveLookups"),
            "server": obj.get("server"),
            "serverRetries": obj.get("serverRetries"),
            "targetValues": [DNSActionFilterTargetValue.from_dict(_item) for _item in obj["targetValues"]] if obj.get("targetValues") is not None else None
        })
        return _obj
