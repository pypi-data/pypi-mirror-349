...
class ServiceLevelsAlertConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alertChannelIds", "burnRateTimeWindows", "customPayloadFields", "description", "name", "rule", "severity", "sloIds", "threshold", "timeThreshold", "triggering"]
