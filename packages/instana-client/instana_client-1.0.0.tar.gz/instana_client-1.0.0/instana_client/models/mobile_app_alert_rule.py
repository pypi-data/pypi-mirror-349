...
class MobileAppAlertRule(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'crash': 'CrashMobileAppAlertRule','customEvent': 'CustomEventMobileAppAlertRule','statusCode': 'StatusCodeMobileAppAlertRule','throughput': 'ThroughputMobileAppAlertRule'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[CrashMobileAppAlertRule, CustomEventMobileAppAlertRule, StatusCodeMobileAppAlertRule, ThroughputMobileAppAlertRule]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CrashMobileAppAlertRule, CustomEventMobileAppAlertRule, StatusCodeMobileAppAlertRule, ThroughputMobileAppAlertRule]]:
