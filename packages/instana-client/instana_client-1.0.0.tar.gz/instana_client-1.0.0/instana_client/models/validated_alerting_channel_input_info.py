...
class ValidatedAlertingChannelInputInfo(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Alert', 'WebsiteSmartAlert', 'MobileSmartAlert', 'ApplicationSmartAlert', 'GlobalApplicationSmartAlert', 'SyntheticSmartAlert', 'InfraSmartAlert', 'ServiceLevelSmartAlert']):
            raise ValueError("must be one of enum values ('Alert', 'WebsiteSmartAlert', 'MobileSmartAlert', 'ApplicationSmartAlert', 'GlobalApplicationSmartAlert', 'SyntheticSmartAlert', 'InfraSmartAlert', 'ServiceLevelSmartAlert')")
        return value
