...
class StreamCollection(StreamArray):
    ...
    def __init__(
        ...
        self.__group_by_net_sta_loc_inst()
        self.validate()
    ...
    def select_colocated(
        ...
        for group in match_list.values():
            ...
            if len(group) > 1:
                ...
                no_match = True
                group_tr = self[group[0]][0]
                group_network = group_tr.stats.network
                group_station = group_tr.stats.station
    ...
    def __group_by_net_sta_loc_inst(self):
        trace_list = []
