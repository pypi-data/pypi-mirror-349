...
- Enhancements
  - Use location code to distinguish among instruments at a site.
- Bugfix
  - Bugfixes in the COSMOS fetcher query values.
  - The `any_trace_failures` option was not working as intended. See issue #1261 and the merge request that closes it.
- Dependencies
  - Require usgs-strec >= 2.3.11, update tests to reflect strec fixes.
