...
class GitlabServeFileTool:
    ...
    def server_res_last_key_path() -> str:
        ...
        """
        app: ProjectApp = WorkSpaceTool.get_project_app()
        type: ProjectType = WorkSpaceTool.get_project_type()
        tool_path = FileUtil.tdf_i18n_path()
        if type == ProjectType.FLUTTER:
            return tool_path + "/flutter_res_last_server_key.txt"
        else:
            return tool_path + "/{}_res_last_server_key.txt".format(app.decs())
    ...
    def server_text_last_key_path() -> str:
        ...
        if type == ProjectType.FLUTTER:
            ...
            return tool_path + "/{}_text_last_server_key.txt".format(app.decs())
    ...
    def server_text_key_desc_path() -> str:
        ...
        if type == ProjectType.FLUTTER:
            ...
            return tool_path + "/{}_text_server_key.json".format(app.decs())
    ...
    def server_res_key_desc_path() -> str:
        ...
        if type == ProjectType.FLUTTER:
            ...
            return tool_path + "/{}_res_server_key.json".format(app.decs())
    ...
    def server_in_operation_path() -> str:
        ...
        if type == ProjectType.FLUTTER:
            ...
            return tool_path + "/{}_in_operation.text".format(app.decs())
    ...
    def server_res_excel_path() -> str:
        ...
        if type == ProjectType.FLUTTER:
            ...
            return tool_path + "/{}_res_excel.xlsx".format(app.decs())
    ...
    def server_text_excel_path() -> str:
        ...
        if type == ProjectType.FLUTTER:
            ...
            return tool_path + "/{}_text_excel.xlsx".format(app.decs())
