...
deploy_objects_opt = click.option(
    "--deploy-objects",
    type=click.STRING,
    required=False,
    help="List of objects to deploy, separated by commas",
)
deploy_objects_except_opt = click.option(
    "--deploy-objects-except",
    type=click.STRING,
    required=False,
    help="List of objects to exclude from deployment, separated by commas",
)
...
def validate(
    ...
    deploy_objects: str | None,
    deploy_objects_except: str | None,
) -> None:
