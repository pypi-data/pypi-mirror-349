...
class CreateNetworkRequest(_message.Message):
    ...
    spec: _network_pb2.NetworkSpec
    def __init__(self, metadata: _Optional[_Union[_metadata_pb2.ResourceMetadata, _Mapping]] = ..., spec: _Optional[_Union[_network_pb2.NetworkSpec, _Mapping]] = ...) -> None: ...

class CreateDefaultNetworkRequest(_message.Message):
    __slots__ = ["metadata"]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    metadata: _metadata_pb2.ResourceMetadata
    def __init__(self, metadata: _Optional[_Union[_metadata_pb2.ResourceMetadata, _Mapping]] = ...) -> None: ...
