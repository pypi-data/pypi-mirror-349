...
class AuditEvent(_message.Message):
    __slots__ = ["id", "source", "spec_version", "type", "service", "action", "time", "event_version", "authentication", "authorization", "resource", "request", "response", "status"]
