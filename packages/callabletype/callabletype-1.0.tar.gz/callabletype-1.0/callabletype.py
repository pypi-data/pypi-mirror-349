...
def is_method(obj:TCallable) -> bool:
    return (isinstance(obj, types.MethodType) or is_selfmethod(obj)) if is_function(obj) else False

METHOD = CallableType(
    name = 'METHOD', 
    allowed_types = [INSTANCESELFMETHOD, SELFMETHOD, CLASSMETHOD],
...
FUNCTION = CallableType(
    name ='FUNCTION',
    allowed_types = [INSTANCESELFMETHOD, SELFMETHOD, CLASSMETHOD, METHOD],
