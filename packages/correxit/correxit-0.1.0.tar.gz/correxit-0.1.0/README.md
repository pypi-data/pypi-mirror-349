...
correxit is a JupyterLab extension and the third-person singular perfect active indicative conjugation of the Latin verb corrigere

This extension is composed of a Python package named `correxit`
for the server extension and a NPM package named `correxit`
...
folder is located. Then you can remove the symlink named `correxit` within that folder.
