...
class TestBindingsInference:
    ...
    def test_infer_bindings_overwrites_name_and_folder_path(self, mock_read_resource_overwrites):
        mock_cm = MagicMock()
        ...
        mock_read_resource_overwrites.assert_called_once_with("bucket", "old_name", "old_folder")

    def test_infer_bindings_skips_when_no_name_and_folder_path(self, mock_read_resource_overwrites):
        @infer_bindings(resource_type="bucket")
