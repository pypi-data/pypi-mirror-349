...
def showError(text, details = None):
    ...
    " If text is an exception, use the exception message"
    if isinstance(text, Exception):
        msg.setText(str(text))
    else:
        """
        If text is a string, use it as the message
        """
        msg.setText(text)
    """
    ...
    " If details is a string, use it as the detailed text"
    if isinstance(details, str):
        msg.setDetailedText(details)
    elif isinstance(details, Exception):
        msg.setDetailedText(str(details))
    elif details is not None:
        msg.setDetailedText("Details: " + str(details))
