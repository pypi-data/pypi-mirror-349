...
class TestDatasetPlugin(unittest.TestCase):
    ...
    @patch("requests.get")
    @patch("cogflow_lite.cogflow_lite.plugins.dataset_plugin.DatasetPlugin.save_to_minio")
    @patch("cogflow_lite.cogflow_lite.pluginmanager.PluginManager.verify_activation")
    ...
    @patch("cogflow_lite.cogflow_lite.plugins.dataset_plugin.DatasetPlugin.create_minio_client")
    @patch("os.getenv")
    @patch("cogflow_lite.cogflow_lite.pluginmanager.PluginManager.verify_activation")
    ...
    def test_log_model_with_dataset(self):
        ...
        with patch("mlflow.sklearn.log_model") as mock_log_model:
            with patch(
                "cogflow_lite.cogflow_lite.plugins.notebook_plugin.NotebookPlugin.get_model_latest_version"
