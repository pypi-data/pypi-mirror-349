...
def custom_log_model(
    ...
    **kwargs,
    ...
    """
    Custom wrapper around cogflow_lite.pyfunc.log_model with extended signature.
    ...
    Args:
        ...
        **kwargs: Additional arguments for cogflow_lite.pyfunc.log_model.
    """

    # Call the original cogflow_lite.pyfunc.log_model
...
# Reassign the custom function to cogflow_lite.pyfunc.log_model
...
def log_model_by_model_file(model_file_path, model_name):
    """
        log_model in cogflow_lite with the model_file
