...
class MessageContentAudioPart(TypedDict):
    ...
    input_audio: NotRequired[Dict[str, Any]] = (
        TypedDict(  # Using NotRequired if not universally supported
            "InputAudio",
            {
                "data": str,  # Base64 encoded audio
                "format": NotRequired[
                    Literal["wav", "mp3", "opus", "flac", "aac", "m4a"]
                ],  # Common audio formats
            },
        )
    )
    audio_url: NotRequired[Dict[str, Any]] = (
        TypedDict(  # Alternative structure if URL based
            "AudioURL",
            {
                "url": str,
            },
    ...
    type: Required[
        Literal["audio_url", "input_audio"]
    ]  # Type might depend on how audio is provided
    """
...
MessageTextContent: TypeAlias = Union[
    ...
    Iterable[
        MessageContentTextPart
    ],  # Technically, a string content is just `[{"type": "text", "text": "string"}]`
]
"""
...
class Message(TypedDict):
    ...
    tool_calls: NotRequired[
        List[ToolCall]
    ]  # Changed from Iterable[Dict[str, Any]] to List[ToolCall]
    """
...
class Subscriptable(BaseModel):
    ...
    def __contains__(self, key: str) -> bool:
        ...
        if (
            ...
            and self.model_fields[key].default is not None
        ):
            return True
...
class CompletionFunction(
    Subscriptable
):  # Corresponds to FunctionCall in the response
    """
...
class CompletionChunk(Subscriptable):
    ...
    class Choice(Subscriptable):
        ...
        class Delta(
            Subscriptable
        ):  # Renamed from CompletionMessage to Delta for clarity in chunks
            """
            ...
            content: Optional[str] = (
                None  # Content is streamed token by token
            )
            """
            ...
            """
            function_call: Optional[CompletionFunction] = (
                None  # Deprecated
            )
            """
        ...
        logprobs: Optional[ChoiceLogprobs] = (
            None  # Logprobs can also be part of chunks
        )
        """
        Log probability information for the choice.
        """
    ...
    ]  # OpenAI SDK uses 'chat.completion.chunk'
    """
...
class Embedding(
    Subscriptable
):  # This 'Embedding' refers to a single embedding object in the response list
    """
...
class EmbeddingResponse(
    Subscriptable
):  # Added a top-level response type for embeddings
    """
    ...
    object: Literal[
        "list"
    ]  # The top-level object is often "list" containing embeddings
    """
