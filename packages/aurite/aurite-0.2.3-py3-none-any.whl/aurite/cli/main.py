...
def init(
    ...
    try:
        ...
        logger(
            f"2. Your project is configured with '{default_project_config_name}' in the root."
        )
        logger(
            "   Aurite will automatically look for this file when you run your application from this directory."
        )
        logger(
            "   Optionally, you can set the PROJECT_CONFIG_PATH environment variable if you need to specify a different path or run from outside this directory."
        )
        ...
        logger(
            f"6. Try running the example: python run_example_project.py"
        )
