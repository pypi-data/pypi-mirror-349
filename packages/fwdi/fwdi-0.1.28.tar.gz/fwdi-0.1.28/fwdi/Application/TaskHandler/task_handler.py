from fwdi.Application.Abstractions.base_task_callback_handler import BaseTaskCallbackHandler
from fwdi.Application.Abstractions.base_task_queue_manager import BaseTaskQueueManager
from fwdi.Application.TaskManager.job_task import JobTask
...
class TaskHandler():
    ...
    def add_to_task(fn:callable, 
        ...
        TaskHandler.__log__(f"Start new job task: {job.id}")
    ...
    def add_to_task_callback(fn:callable, 
                             ...
                             callback_handler:BaseTaskCallbackHandler)-> JobTask | None:
