...
class ServiceDescriptorFWDI():
    ...
    @classmethod
    def create_from_instance(cls: type[_CLS_], _instance:T, lifetime:ServiceLifetime)-> _CLS_:
        new_instance = cls()
        new_instance.ImplementationType = type(_instance)
    ...
    @classmethod
    def create_from_type(cls: type[_CLS_], _type:type[T] , lifetime:ServiceLifetime)-> _CLS_:
         new_instance = cls()
         new_instance.ServiceType = _type
         new_instance.ImplementationType = ServiceDescriptorFWDI.__set_inject_v2(_type)
         new_instance.Lifetime = lifetime

         return new_instance

    @classmethod
    def create(cls: type[_CLS_], base_type:type[T], _instance:type[T], lifetime: ServiceLifetime)-> _CLS_:
        new_instance = cls()
    ...
    @classmethod
    def create_log(cls: type[_CLS_], _instance:T, lifetime:ServiceLifetime)-> _CLS_:
        new_instance = cls()
        new_instance.ImplementationType = type(_instance)
        new_instance.ServiceType = new_instance.ImplementationType
        new_instance.ImplementationType = ServiceDescriptorFWDI.__set_inject_log_v1(_instance)
        new_instance.Lifetime = lifetime
        ...
        for attr, value in cls.__dict__.items():
            if callable(value):
                ...
                if not attr.startswith('__') and not inspect.isabstract(cls):
                    ...
                    if signature_has_self and len(method_signature) == 1:
                        ...
                    else:
                        match type_call:
