# ai_shell_agent/toolsets/files/texts.py
"""
Loads Files toolset text strings based on selected language.
"""
...
if __name__ == '__main__':
    print(f"--- Files Texts Loader Test ---")
    ...
    # Example: print(f"Test get_text: {get_text('tools.create.success', type='file', path='file.txt')}")