# ai_shell_agent/toolsets/aider/texts.py
"""
Loads Aider toolset text strings based on selected language.
"""
...
if __name__ == '__main__':
    print(f"--- Aider Texts Loader Test ---")
    ...
    # Example: print(f"Test get_text: {get_text('tools.add_file.name')}")