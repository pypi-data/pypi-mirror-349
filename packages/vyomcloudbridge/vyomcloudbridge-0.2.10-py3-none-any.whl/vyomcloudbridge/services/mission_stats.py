...
class MissionStats(ServiceAbstract):
    ...
    def start_mission(
        ...
        try:
            ...
            mission_detail = {
                ...
                "owner_id": owner_id,
                "mission_status": 1,
                "campaign_id": None,  # You can replace this with an actual campaign ID if needed
    ...
    def on_mission_data_arrive(
        ...
        last_data_mission = self._get_last_data_mission_id()
        if last_data_mission and last_data_mission != mission_id:
            self._publish_stats_to_hq(last_data_mission)
    ...
    def _publish_stats_to_hq(self, mission_id: int):
        try:
            ...
            def mission_publisher_loop():
                while self.is_running:
                    try:
                        ...
                        if current_mission:
                            self.logger.info(
                                f"current mission FOUND, {current_mission}"
                            )
