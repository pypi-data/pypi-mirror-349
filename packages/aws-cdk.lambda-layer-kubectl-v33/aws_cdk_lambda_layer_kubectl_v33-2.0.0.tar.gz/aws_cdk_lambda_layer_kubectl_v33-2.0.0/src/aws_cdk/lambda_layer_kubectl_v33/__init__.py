...
class KubectlV33Layer(
    _aws_cdk_aws_lambda_ceddda9d.LayerVersion,
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/lambda-layer-kubectl-v33.KubectlV33Layer",
):
    ...
    def __init__(self, scope: _constructs_77d1e7e8.Construct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6fc2e9166f35270e9dd8f8fb1299c48c6151211a87ee918175c6f9b0e5ceaac7)
...
def _typecheckingstub__6fc2e9166f35270e9dd8f8fb1299c48c6151211a87ee918175c6f9b0e5ceaac7(
