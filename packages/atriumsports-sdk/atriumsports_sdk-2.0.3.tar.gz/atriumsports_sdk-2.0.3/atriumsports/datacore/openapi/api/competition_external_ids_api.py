...
class CompetitionExternalIDsApi:
    ...
    @validate_call
    def competition_external_ids_insert_update(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
        ...
        _param = self._competition_external_ids_insert_update_serialize(
            organization_id=organization_id,
            sport=sport,
            competition_external_ids_post_body=competition_external_ids_post_body,
            external=external,
        ...
        try:
            ...
            logger.error(
                "Exception when calling CompetitionExternalIDsApi->competition_external_ids_insert_update: %s\n" % e
            )
            raise

    @validate_call
    def competition_external_ids_insert_update_with_http_info(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    @validate_call
    def competition_external_ids_insert_update_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _competition_external_ids_insert_update_serialize(
        self,
        organization_id,
        sport,
        competition_external_ids_post_body,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/competitions/externalids/force",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
