...
class StandingProgressionsApi:
    ...
    @validate_call
    def standing_progressions_delete(
        self,
        ...
        standing_progression_id: Annotated[
            StrictStr, Field(description="The unique identifier of standing progression Id")
        ],
        external: Annotated[
            Optional[StrictStr],
            Field(
        ...
        :type sport: str
        :param standing_progression_id: The unique identifier of standing progression Id (required)
        :type standing_progression_id: str
        ...
        _param = self._standing_progressions_delete_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "StandingProgressionsResponse",
        }
        try:
            ...
            logger.error("Exception when calling StandingProgressionsApi->standing_progressions_delete: %s\n" % e)
            raise

    @validate_call
    def standing_progressions_delete_with_http_info(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StandingProgressionsResponse]:
        """Delete a standing progression
    ...
    @validate_call
    def standing_progressions_delete_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _standing_progressions_delete_serialize(
        self,
        organization_id,
        season_id,
        sport,
        standing_progression_id,
        external,
        fields,
        force_delete,
        hide_null,
        ...
        if standing_progression_id is not None:
            _path_params["standingProgressionId"] = standing_progression_id
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/{sport}/o/{organizationId}/seasons/{seasonId}/standings/progressions/{standingProgressionId}",
    ...
    @validate_call
    def standing_progressions_detail(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
        ...
        _param = self._standing_progressions_detail_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            standing_progression_id=standing_progression_id,
        ...
        try:
            ...
            logger.error("Exception when calling StandingProgressionsApi->standing_progressions_detail: %s\n" % e)
            raise

    @validate_call
    def standing_progressions_detail_with_http_info(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    @validate_call
    def standing_progressions_detail_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _standing_progressions_detail_serialize(
        self,
        organization_id,
        season_id,
        sport,
    ...
    @validate_call
    def standing_progressions_insert(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
        season_id: Annotated[StrictStr, Field(description="The unique identifier of the season")],
        sport: Annotated[StrictStr, Field(description="Sport name")],
        standing_progressions_post_body: StandingProgressionsPostBody,
        external: Annotated[
            Optional[StrictStr],
            Field(
                description="A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information."
        ...
        :param sport: Sport name (required)
        :type sport: str
        :param standing_progressions_post_body: (required)
        :type standing_progressions_post_body: StandingProgressionsPostBody
        :param external: A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information.
        :type external: str
        :param fields: A comma separated list of fields to display.  The response will only display these fields. See [Partial Response](#section/Partial-Response) section for more information.
        :type fields: str
        ...
        _param = self._standing_progressions_insert_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            standing_progressions_post_body=standing_progressions_post_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
        ...
        try:
            ...
            logger.error("Exception when calling StandingProgressionsApi->standing_progressions_insert: %s\n" % e)
            raise

    @validate_call
    def standing_progressions_insert_with_http_info(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    @validate_call
    def standing_progressions_insert_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _standing_progressions_insert_serialize(
        self,
        organization_id,
        season_id,
        sport,
        standing_progressions_post_body,
        external,
        fields,
        hide_null,
        include,
        ...
        # process the form parameters
        # process the body parameter
        if standing_progressions_post_body is not None:
            _body_params = standing_progressions_post_body
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/seasons/{seasonId}/standings/progressions",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def standing_progressions_list(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
        ...
        _param = self._standing_progressions_list_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            added=added,
        ...
        try:
            ...
            logger.error("Exception when calling StandingProgressionsApi->standing_progressions_list: %s\n" % e)
            raise

    @validate_call
    def standing_progressions_list_with_http_info(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    @validate_call
    def standing_progressions_list_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _standing_progressions_list_serialize(
        self,
        organization_id,
        season_id,
        sport,
    ...
    @validate_call
    def standing_progressions_update(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
        ...
        standing_progressions_put_body: StandingProgressionsPutBody,
        external: Annotated[
            Optional[StrictStr],
            Field(
                description="A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information."
        ...
        :param standing_progression_id: The unique identifier of standing progression Id (required)
        :type standing_progression_id: str
        :param standing_progressions_put_body: (required)
        :type standing_progressions_put_body: StandingProgressionsPutBody
        :param external: A comma separated list of fields that will instead be interpreted as an externalId. See [External Ids](#section/Introduction/External-Ids) for more information.
        :type external: str
        :param fields: A comma separated list of fields to display.  The response will only display these fields. See [Partial Response](#section/Partial-Response) section for more information.
        :type fields: str
        ...
        _param = self._standing_progressions_update_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            standing_progression_id=standing_progression_id,
            standing_progressions_put_body=standing_progressions_put_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
        ...
        try:
            ...
            logger.error("Exception when calling StandingProgressionsApi->standing_progressions_update: %s\n" % e)
            raise

    @validate_call
    def standing_progressions_update_with_http_info(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    @validate_call
    def standing_progressions_update_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _standing_progressions_update_serialize(
        self,
        organization_id,
        season_id,
        sport,
        standing_progression_id,
        standing_progressions_put_body,
        external,
        fields,
        hide_null,
        include,
        ...
        # process the form parameters
        # process the body parameter
        if standing_progressions_put_body is not None:
            _body_params = standing_progressions_put_body
