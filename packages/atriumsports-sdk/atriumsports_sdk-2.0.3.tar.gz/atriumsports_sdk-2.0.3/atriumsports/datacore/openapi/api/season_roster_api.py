...
class SeasonRosterApi:
    ...
    def season_roster_delete(
        ...
        _param = self._season_roster_delete_serialize(
    ...
    def season_roster_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SeasonRosterResponse]:
        """Delete a season roster
    ...
    @validate_call
    def season_roster_delete_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _season_roster_delete_serialize(
        self,
        organization_id,
        person_id,
        season_id,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/{sport}/o/{organizationId}/seasons/{seasonId}/persons/{personId}/roster",
    ...
    def season_roster_detail(
        ...
        _param = self._season_roster_detail_serialize(
            organization_id=organization_id,
            person_id=person_id,
            season_id=season_id,
            sport=sport,
    ...
    @validate_call
    def season_roster_detail_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _season_roster_detail_serialize(
        self,
        organization_id,
        person_id,
        season_id,
    ...
    def season_roster_insert_update(
        ...
        _param = self._season_roster_insert_update_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            season_roster_post_body=season_roster_post_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def season_roster_insert_update_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _season_roster_insert_update_serialize(
        self,
        organization_id,
        season_id,
        sport,
        ...
        # process the form parameters
        # process the body parameter
        if season_roster_post_body is not None:
            _body_params = season_roster_post_body
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/seasons/{seasonId}/roster",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def season_roster_list(
        ...
        _param = self._season_roster_list_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            added=added,
    ...
    @validate_call
    def season_roster_list_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _season_roster_list_serialize(
        self,
        organization_id,
        season_id,
        sport,
    ...
    def season_roster_list_by_entity(
        ...
        """Get the roster for an entity for the season

        Return the roster for an entity for the season
        ...
        _param = self._season_roster_list_by_entity_serialize(
            entity_id=entity_id,
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
    ...
    @validate_call
    def season_roster_list_by_entity_without_preload_content(
        self,
        entity_id: Annotated[StrictStr, Field(description="The unique identifier of the entity")],
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
    ...
    def _season_roster_list_by_entity_serialize(
        self,
        entity_id,
        organization_id,
        season_id,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/{sport}/o/{organizationId}/seasons/{seasonId}/entities/{entityId}/roster",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def seasons_roster_list_by_entity(
        ...
        """Get the rosters for an entity for all seasons

        Return the rosters for an entity for all seasons
        ...
        _param = self._seasons_roster_list_by_entity_serialize(
            entity_id=entity_id,
            organization_id=organization_id,
            sport=sport,
            added=added,
    ...
    @validate_call
    def seasons_roster_list_by_entity_without_preload_content(
        self,
        entity_id: Annotated[StrictStr, Field(description="The unique identifier of the entity")],
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
    ...
    def _seasons_roster_list_by_entity_serialize(
        self,
        entity_id,
        organization_id,
        sport,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/{sport}/o/{organizationId}/seasons/entities/{entityId}/roster",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
