...
class CompetitionExternalIdsModel(BaseModel):
    ...
    competition_external_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the external ids", alias="competitionExternalId"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "competitionExternalId": obj.get("competitionExternalId"),
                "organizationId": obj.get("organizationId"),
                "organization": (
                    CompetitionExternalIdsModelOrganization.from_dict(obj["organization"])
