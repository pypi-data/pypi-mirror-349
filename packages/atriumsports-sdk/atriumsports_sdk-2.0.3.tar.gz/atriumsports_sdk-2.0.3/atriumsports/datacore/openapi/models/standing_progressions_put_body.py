...
class StandingProgressionsPutBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["seasonId", "nameLocal", "nameLatin", "stageCode", "poolCode", "fixtureIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandingProgressionsPutBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandingProgressionsPutBody from a dict"""
        if obj is None:
            return None
