...
class FixturePersonStatisticsPeriodsPostBody(BaseModel):
    ...
    period_id: StrictInt = Field(description="The identifier for the period", alias="periodId")
    ...
    __properties: ClassVar[List[str]] = ["personId", "entityId", "fixtureId", "statistics", "periodId", "section"]
