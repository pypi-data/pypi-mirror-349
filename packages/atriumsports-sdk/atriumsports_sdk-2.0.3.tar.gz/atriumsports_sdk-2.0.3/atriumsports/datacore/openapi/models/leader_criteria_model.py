...
class LeaderCriteriaModel(BaseModel):
    ...
    leader_criteria_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the leader criteria", alias="leaderCriteriaId"
    )
    name: Optional[StrictStr] = Field(default=None, description="The name of the criteria")
        ...
        _obj = cls.model_validate(
            {
                ...
                "organization": (
                    LeaderCriteriaModelOrganization.from_dict(obj["organization"])
