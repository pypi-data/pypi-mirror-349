...
class SitesModel(BaseModel):
    ...
    site_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the site", alias="siteId")
        ...
        _obj = cls.model_validate(
            {
                ...
                "organization": (
                    SitesModelOrganization.from_dict(obj["organization"])
                ...
                "address": SiteAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
