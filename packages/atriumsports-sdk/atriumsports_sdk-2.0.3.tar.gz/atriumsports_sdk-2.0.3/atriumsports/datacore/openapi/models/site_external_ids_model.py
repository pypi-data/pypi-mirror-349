...
class SiteExternalIdsModel(BaseModel):
    ...
    site_external_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the external ids", alias="siteExternalId"
    )
    ...
    site_id: Optional[StrictStr] = Field(
        default=None, description="The site that this site external ids belongs to", alias="siteId"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "siteExternalId": obj.get("siteExternalId"),
                "organizationId": obj.get("organizationId"),
                "organization": (
                    SiteExternalIdsModelOrganization.from_dict(obj["organization"])
                    if obj.get("organization") is not None
                    else None
                ),
                "siteId": obj.get("siteId"),
                "site": SiteExternalIdsModelSite.from_dict(obj["site"]) if obj.get("site") is not None else None,
