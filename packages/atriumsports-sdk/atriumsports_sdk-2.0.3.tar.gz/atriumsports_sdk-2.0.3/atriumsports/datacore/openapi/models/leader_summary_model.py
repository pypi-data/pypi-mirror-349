...
class LeaderSummaryModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["statName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        _items = []
        if self.stat_name:
            for _item_stat_name in self.stat_name:
                if _item_stat_name:
                    _items.append(_item_stat_name.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "statName": (
                    [SeasonPersonStatisticsModel.from_dict(_item) for _item in obj["statName"]]
