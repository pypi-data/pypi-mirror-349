...
class SEASONENTITYPlacingsPostBody(BaseModel):
    ...
    placing_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the SEASON ENTITY placing", alias="placingId"
    )
    ...
    __properties: ClassVar[List[str]] = ["placingId", "seasonId", "entityId", "resultPlace", "points", "prizeMoney"]
