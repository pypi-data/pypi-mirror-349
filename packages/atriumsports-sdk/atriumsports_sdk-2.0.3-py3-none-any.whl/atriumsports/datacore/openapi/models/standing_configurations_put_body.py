...
class StandingConfigurationsPutBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nameLocal", "nameLatin", "buildRules", "configuration", "externalId"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "buildRules": (
                    StandingBuilding.from_dict(obj["buildRules"]) if obj.get("buildRules") is not None else None
                ),
                "configuration": (
                    StandingConfiguration.from_dict(obj["configuration"])
