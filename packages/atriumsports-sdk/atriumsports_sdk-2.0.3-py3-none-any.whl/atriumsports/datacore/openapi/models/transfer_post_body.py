...
class TransferPostBody(BaseModel):
    ...
    transfer_type: Annotated[str, Field(strict=True, max_length=100)] = Field(
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(["APPROVED", "PENDING", "DECLINED", "null"]):
        ...
        _obj = cls.model_validate(
            {
                ...
                "components": (
                    [TransferComponent.from_dict(_item) for _item in obj["components"]]
