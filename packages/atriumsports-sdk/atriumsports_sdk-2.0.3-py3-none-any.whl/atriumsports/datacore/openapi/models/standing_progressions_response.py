...
class StandingProgressionsResponse(BaseModel):
    """
    ...
    data: Optional[List[StandingProgressionsModel]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandingProgressionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandingProgressionsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [StandingProgressionsModel.from_dict(_item) for _item in obj["data"]]
