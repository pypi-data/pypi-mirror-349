...
class FixtureCompetitor(BaseModel):
    ...
    shoot_out_attempts: Optional[StrictStr] = Field(
        default=None, description="shootOut Attempts", alias="shootOutAttempts"
    )
    roster_status: Optional[StrictStr] = Field(default=None, description="Roster status", alias="rosterStatus")
