...
class SEASONPERSONPlacingsPostBody(BaseModel):
    ...
    placing_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the SEASON PERSON placing", alias="placingId"
    )
    ...
    __properties: ClassVar[List[str]] = ["placingId", "seasonId", "personId", "resultPlace", "points", "prizeMoney"]
