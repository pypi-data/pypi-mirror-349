...
class LeagueExternalIdsModel(BaseModel):
    ...
    league_external_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the external ids", alias="leagueExternalId"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "leagueExternalId": obj.get("leagueExternalId"),
                "organizationId": obj.get("organizationId"),
                "organization": (
                    LeagueExternalIdsModelOrganization.from_dict(obj["organization"])
                    if obj.get("organization") is not None
                    else None
                ),
                "leagueId": obj.get("leagueId"),
                "league": (
                    LeagueExternalIdsModelLeague.from_dict(obj["league"]) if obj.get("league") is not None else None
                ),
