...
class StandingProgressionsModel(BaseModel):
    """
    StandingProgressionsModel
    """  # noqa: E501

    standing_progression_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the progression", alias="standingProgressionId"
    )
    organization_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the organization", alias="organizationId"
    )
    organization: Optional[StandingProgressionsModelOrganization] = None
    ...
    name_local: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(
        default=None,
        description="The name of the standing progressions in the [local](#section/Introduction/Character-Sets-and-Names) language",
        alias="nameLocal",
    )
    name_latin: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(
        default=None,
        description="The name of the standing progressions in [latin](#section/Introduction/Character-Sets-and-Names) characters",
        alias="nameLatin",
    )
    ...
    fixture_ids: Optional[List[StrictStr]] = Field(default=None, alias="fixtureIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandingProgressionsModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandingProgressionsModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "standingProgressionId": obj.get("standingProgressionId"),
                "organizationId": obj.get("organizationId"),
                "organization": (
                    StandingProgressionsModelOrganization.from_dict(obj["organization"])
