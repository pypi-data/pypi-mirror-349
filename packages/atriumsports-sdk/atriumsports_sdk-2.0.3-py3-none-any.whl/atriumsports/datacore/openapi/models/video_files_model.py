...
class VideoFilesModel(BaseModel):
    ...
    def storage_provider_validate_enum(cls, value):
        ...
        if value not in set(["5STREAM", "AV_SPORTRADAR", "KEEMOTION", "SYNERGY", "null"]):
            raise ValueError("must be one of enum values ('5STREAM', 'AV_SPORTRADAR', 'KEEMOTION', 'SYNERGY', 'null')")
        return value
