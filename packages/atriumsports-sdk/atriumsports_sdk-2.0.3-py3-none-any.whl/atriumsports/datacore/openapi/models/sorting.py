...
class Sorting(BaseModel):
    ...
    sort_field: Optional[StrictStr] = Field(default=None, description="Sort Field", alias="sortField")
    sort_direction: Optional[StrictStr] = Field(default=None, description="Sort direction", alias="sortDirection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"sortField": obj.get("sortField"), "sortDirection": obj.get("sortDirection")})
        return _obj
