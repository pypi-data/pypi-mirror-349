        ...
        _obj = cls.model_validate(
            {
                ...
                "organization": (
                    CompetitionsModelOrganization.from_dict(obj["organization"])
                    if obj.get("organization") is not None
                    else None
                ),
                "leagueId": obj.get("leagueId"),
                "league": CompetitionsModelLeague.from_dict(obj["league"]) if obj.get("league") is not None else None,
                ...
                "historicalNames": (
                    [CompetitionHistoricalName.from_dict(_item) for _item in obj["historicalNames"]]
