...
class SeasonStagePostBody(BaseModel):
    ...
    stage_code: Annotated[str, Field(strict=True, max_length=30)] = Field(
        description="A unique code for the stage. (Unique for season)", alias="stageCode"
    )
    ...
    stage_order: Optional[Annotated[int, Field(strict=True)]] = Field(
        default=None, description="User defined sort order of the stage", alias="stageOrder"
    )
