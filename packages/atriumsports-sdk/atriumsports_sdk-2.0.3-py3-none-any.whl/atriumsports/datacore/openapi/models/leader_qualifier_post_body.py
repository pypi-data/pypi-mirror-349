...
class LeaderQualifierPostBody(BaseModel):
    ...
    leader_criteria_id: StrictStr = Field(
        description="The unique identifier of the ~LeaderCriteria~", alias="leaderCriteriaId"
    )
    statistic_field: StrictStr = Field(
        description="The statistic field that this qualifier is for.", alias="statisticField"
    )
    comparison_field: StrictStr = Field(description="The statistic field to compare against.", alias="comparisonField")
    ...
    comparison_value: Union[StrictFloat, StrictInt] = Field(
        description="Comparison value for the qualifier", alias="comparisonValue"
    )
