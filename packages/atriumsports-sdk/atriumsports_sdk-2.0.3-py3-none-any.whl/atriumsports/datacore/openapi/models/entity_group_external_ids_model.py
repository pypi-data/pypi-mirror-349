...
class EntityGroupExternalIdsModel(BaseModel):
    ...
    entity_group_external_id: Optional[StrictStr] = Field(
        default=None, description="The unique identifier of the external ids", alias="entityGroupExternalId"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "entityGroupExternalId": obj.get("entityGroupExternalId"),
                "organizationId": obj.get("organizationId"),
                "organization": (
                    EntityGroupExternalIdsModelOrganization.from_dict(obj["organization"])
