        ...
        _obj = cls.model_validate(
            {
                ...
                "organization": (
                    FixtureEntitiesModelOrganization.from_dict(obj["organization"])
                ...
                "includeInRepresentation": (
                    obj.get("includeInRepresentation") if obj.get("includeInRepresentation") is not None else True
                ),
                "rosterStatus": obj.get("rosterStatus") if obj.get("rosterStatus") is not None else "UNKNOWN",
                "uniformId": obj.get("uniformId"),
                "uniform": (
                    FixtureEntitiesModelUniform.from_dict(obj["uniform"]) if obj.get("uniform") is not None else None
                ),
