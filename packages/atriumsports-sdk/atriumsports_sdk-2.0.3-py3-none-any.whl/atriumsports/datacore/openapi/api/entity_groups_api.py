...
class EntityGroupsApi:
    ...
    def entity_group_delete(
        ...
        Delete a specific entity group
        ...
        _param = self._entity_group_delete_serialize(
    ...
    def entity_group_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EntityGroupsResponse]:
        """Delete an entity group
    ...
    @validate_call
    def entity_group_delete_without_preload_content(
        self,
        entity_group_id: Annotated[StrictStr, Field(description="The unique identifier of the entity group")],
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
    ...
    def _entity_group_delete_serialize(
        self,
        entity_group_id,
        organization_id,
        sport,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/{sport}/o/{organizationId}/entityGroups/{entityGroupId}",
    ...
    def entity_group_detail(
        ...
        Return detailed information about a specific entity group
        ...
        _param = self._entity_group_detail_serialize(
            entity_group_id=entity_group_id,
            organization_id=organization_id,
            sport=sport,
            external=external,
    ...
    @validate_call
    def entity_group_detail_without_preload_content(
        self,
        entity_group_id: Annotated[StrictStr, Field(description="The unique identifier of the entity group")],
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
    ...
    def _entity_group_detail_serialize(
        self,
        entity_group_id,
        organization_id,
        sport,
    ...
    def entity_group_insert(
        ...
        _param = self._entity_group_insert_serialize(
            organization_id=organization_id,
            sport=sport,
            entity_group_post_body=entity_group_post_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def entity_group_insert_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _entity_group_insert_serialize(
        self,
        organization_id,
        sport,
        ...
        # process the form parameters
        # process the body parameter
        if entity_group_post_body is not None:
            _body_params = entity_group_post_body
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/entityGroups",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def entity_group_list(
        ...
        Return a list of available entity groups
        ...
        _param = self._entity_group_list_serialize(
            organization_id=organization_id,
            sport=sport,
            added=added,
            external=external,
    ...
    @validate_call
    def entity_group_list_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _entity_group_list_serialize(
        self,
        organization_id,
        sport,
        added,
    ...
    def entity_group_update(
        ...
        Change the information of a specific entity group
        ...
        _param = self._entity_group_update_serialize(
            entity_group_id=entity_group_id,
            organization_id=organization_id,
            sport=sport,
            entity_group_put_body=entity_group_put_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def entity_group_update_without_preload_content(
        self,
        entity_group_id: Annotated[StrictStr, Field(description="The unique identifier of the entity group")],
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
    ...
    def _entity_group_update_serialize(
        self,
        entity_group_id,
        organization_id,
        sport,
        ...
        # process the form parameters
        # process the body parameter
        if entity_group_put_body is not None:
            _body_params = entity_group_put_body
