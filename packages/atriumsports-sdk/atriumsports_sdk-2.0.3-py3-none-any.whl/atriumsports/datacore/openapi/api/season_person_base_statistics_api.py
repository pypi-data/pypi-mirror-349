...
class SeasonPersonBaseStatisticsApi:
    ...
    def spbs_delete_all(
        ...
        _param = self._spbs_delete_all_serialize(
    ...
    def spbs_delete_all_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SeasonPersonBaseStatisticsResponse]:
        """Delete season person base statistics
    ...
    @validate_call
    def spbs_delete_all_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _spbs_delete_all_serialize(
        self,
        organization_id,
        season_id,
        sport,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/{sport}/o/{organizationId}/statistics/base/for/person/in/seasons/{seasonId}",
    ...
    def spbs_insert_update(
        ...
        _param = self._spbs_insert_update_serialize(
            organization_id=organization_id,
            sport=sport,
            season_person_base_statistics_post_body=season_person_base_statistics_post_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def spbs_insert_update_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _spbs_insert_update_serialize(
        self,
        organization_id,
        sport,
        ...
        # process the form parameters
        # process the body parameter
        if season_person_base_statistics_post_body is not None:
            _body_params = season_person_base_statistics_post_body
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/statistics/base/for/person/in/seasons",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def spbs_list(
        ...
        _param = self._spbs_list_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            added=added,
    ...
    @validate_call
    def spbs_list_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
