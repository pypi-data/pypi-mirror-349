...
class LocalVideoEndpointsApi:
    ...
    def video_stream_local_delete(
        ...
        _param = self._video_stream_local_delete_serialize(
    ...
    def video_stream_local_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VideoStreamLocalResponse]:
        """Delete a local streaming video endpoint
    ...
    @validate_call
    def video_stream_local_delete_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _video_stream_local_delete_serialize(
        self,
        organization_id,
        sport,
        url_id,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/{sport}/o/{organizationId}/video/streams/local/{urlId}",
    ...
    def video_stream_local_detail(
        ...
        _param = self._video_stream_local_detail_serialize(
            organization_id=organization_id,
            sport=sport,
            url_id=url_id,
            external=external,
    ...
    @validate_call
    def video_stream_local_detail_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _video_stream_local_detail_serialize(
        self,
        organization_id,
        sport,
        url_id,
    ...
    def video_stream_local_insert(
        ...
        _param = self._video_stream_local_insert_serialize(
            fixture_id=fixture_id,
            organization_id=organization_id,
            sport=sport,
            video_stream_local_post_body=video_stream_local_post_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def video_stream_local_insert_without_preload_content(
        self,
        fixture_id: Annotated[StrictStr, Field(description="The unique identifier of the fixture")],
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
    ...
    def _video_stream_local_insert_serialize(
        self,
        fixture_id,
        organization_id,
        sport,
        ...
        # process the form parameters
        # process the body parameter
        if video_stream_local_post_body is not None:
            _body_params = video_stream_local_post_body
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/fixtures/{fixtureId}/video/streams/local",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def video_stream_local_list(
        ...
        _param = self._video_stream_local_list_serialize(
            fixture_id=fixture_id,
            organization_id=organization_id,
            sport=sport,
            added=added,
    ...
    @validate_call
    def video_stream_local_list_without_preload_content(
        self,
        fixture_id: Annotated[StrictStr, Field(description="The unique identifier of the fixture")],
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
    ...
    def _video_stream_local_list_serialize(
        self,
        fixture_id,
        organization_id,
        sport,
    ...
    def video_stream_local_update(
        ...
        _param = self._video_stream_local_update_serialize(
            organization_id=organization_id,
            sport=sport,
            url_id=url_id,
            video_stream_local_put_body=video_stream_local_put_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def video_stream_local_update_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _video_stream_local_update_serialize(
        self,
        organization_id,
        sport,
        url_id,
        ...
        # process the form parameters
        # process the body parameter
        if video_stream_local_put_body is not None:
            _body_params = video_stream_local_put_body
