...
class SeasonEntityPlacingsApi:
    ...
    def sep_delete(
        ...
        """Delete a season entity placing

        Delete a specific season entity placing
        ...
        _param = self._sep_delete_serialize(
    ...
    def sep_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SeasonEntityPlacingsResponse]:
        """Delete a season entity placing
    ...
    @validate_call
    def sep_delete_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _sep_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/{sport}/o/{organizationId}/seasons/entities/placings/{placingId}",
    ...
    def sep_detail(
        ...
        """Get a season entity placing

        Return detailed information about a specific season entity placing
        ...
        _param = self._sep_detail_serialize(
            organization_id=organization_id,
            placing_id=placing_id,
            sport=sport,
            external=external,
    ...
    @validate_call
    def sep_detail_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def sep_insert(
        ...
        """Create a new season entity placing

        Add a new season entity placing
        ...
        _param = self._sep_insert_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            seasonentity_placings_post_body=seasonentity_placings_post_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def sep_insert_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _sep_insert_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if seasonentity_placings_post_body is not None:
            _body_params = seasonentity_placings_post_body
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/seasons/{seasonId}/entities/placings",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sep_list(
        ...
        """Get a list of placings for entity in a season

        Return a list of final placings for an entity in a season
        ...
        _param = self._sep_list_serialize(
            organization_id=organization_id,
            season_id=season_id,
            sport=sport,
            added=added,
    ...
    @validate_call
    def sep_list_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def sep_update(
        ...
        """Update a specific season entity placing

        Change the information of a specific season entity placing
        ...
        _param = self._sep_update_serialize(
            organization_id=organization_id,
            placing_id=placing_id,
            sport=sport,
            seasonentity_placings_put_body=seasonentity_placings_put_body,
            external=external,
            fields=fields,
            hide_null=hide_null,
            include=include,
    ...
    @validate_call
    def sep_update_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _sep_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if seasonentity_placings_put_body is not None:
            _body_params = seasonentity_placings_put_body
