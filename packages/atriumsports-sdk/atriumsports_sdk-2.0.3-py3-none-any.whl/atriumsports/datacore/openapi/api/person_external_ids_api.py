...
class PersonExternalIDsApi:
    ...
    @validate_call
    def person_external_ids_insert_update(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
        ...
        _param = self._person_external_ids_insert_update_serialize(
            organization_id=organization_id,
            sport=sport,
            person_external_ids_post_body=person_external_ids_post_body,
            external=external,
        ...
        try:
            ...
            logger.error("Exception when calling PersonExternalIDsApi->person_external_ids_insert_update: %s\n" % e)
            raise

    @validate_call
    def person_external_ids_insert_update_with_http_info(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    @validate_call
    def person_external_ids_insert_update_without_preload_content(
        self,
        organization_id: Annotated[
            str, Field(min_length=5, strict=True, max_length=5, description="The unique identifier of the organization")
        ],
    ...
    def _person_external_ids_insert_update_serialize(
        self,
        organization_id,
        sport,
        person_external_ids_post_body,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/{sport}/o/{organizationId}/persons/externalids/force",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
