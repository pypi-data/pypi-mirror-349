...
def get_instruction(language: str, description: str) -> str:
    ...
    instruction = (
        ...
        f"Keep line breaks, formatting, and special characters unless they directly interfere with grammar.\n"
        f"Do NOT move, merge or split the 'content' of objects. They must retain their original meaning."
    )
    if description:
