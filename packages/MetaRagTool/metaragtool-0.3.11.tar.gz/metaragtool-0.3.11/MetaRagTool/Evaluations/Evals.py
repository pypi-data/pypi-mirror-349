...
def basic_eval(evaluatable_rag, sample_size=200, qa_sample_size=100, multi_hop_hardness_factor=0, top_k=None,run_name=None,log_all_retrival_results =False,multi_hop=True):
...
def god_eval(encoder_name, sample_size=200, qa_sample_size=100, local_mode=False, multi_hop_hardness_factor=0,
             judged=False, top_k=None, useTool=False, llm=None, reranker_name=None,tests=[]):
    import MetaRagTool.Evaluations.TestManager as TestManager
    import MetaRagTool.Utils.MRUtils as MRUtils
