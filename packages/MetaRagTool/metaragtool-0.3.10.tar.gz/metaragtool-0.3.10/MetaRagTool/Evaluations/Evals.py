...
def basic_eval(evaluatable_rag, sample_size=200, qa_sample_size=100, multi_hop_hardness_factor=0, top_k=None,run_name='basic_eval',log_all_retrival_results =False,multi_hop=True):
