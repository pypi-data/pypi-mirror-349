...
from torchmil.models.transformer_prob_smooth_abmil import TransformerProbSmoothABMIL  # Assuming your script is saved as 'your_module.py'
...
class TestTransformerProbSmoothABMIL:
    ...
    def test_predict(self):
        ...
        Y_pred_samples, att_val_samples = model.predict(X, adj, mask, return_inst_pred=True, return_samples=True)
