...
class HTTP_Status(Enum):
    GET                 = "200: Get"                              # HTTP 200
    CREATE              = "201: Created"                          # HTTP 201
    UPDATE              = "203: Non-Authoritative Information"    # HTTP 203
    DELETE              = "204: No Content"                       # HTTP 204
    ERROR_BAD_REQUEST   = "400: Bad Request"                      # HTTP 400
    ERROR_NOT_FOUND     = "404: Not Found"                        # HTTP 404
