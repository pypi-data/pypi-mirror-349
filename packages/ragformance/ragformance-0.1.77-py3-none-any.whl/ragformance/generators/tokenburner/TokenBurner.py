...
def _run_smoke_test():
    ...
    if not OPENROUTER_API_KEY:
        print("⚠️ OPENROUTER_API_KEY not set. Skipping smoke test.")
        return
    try:
        ...
        print("🔹 Chat OK →", response.choices[0].message.content[:80], "…")
    except Exception as e:
        raise RuntimeError(f"⚠️ Chat smoke-test failed: {e}")
