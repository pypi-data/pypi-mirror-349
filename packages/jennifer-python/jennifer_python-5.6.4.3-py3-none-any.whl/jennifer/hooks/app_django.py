...
import semver
from .util import _log, _to_valid_version

__hooking_module__ = 'django'
__minimum_python_version__ = semver.parse_version_info("2.7.0")
...
def hook(django_module):
    ...
    global __target_version
    __target_version = _to_valid_version(django_module.__version__)
    ...
    current_ver = semver.parse_version_info(__target_version)
    base_ver = semver.parse_version_info("3.0.0")
