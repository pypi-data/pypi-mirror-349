...
from .util import _to_valid_version

# python-oracledb
# https://oracle.github.io/python-oracledb/
__hooking_module__ = 'oracledb'
__minimum_python_version__ = semver.parse_version_info("3.8.0")
...
def hook(oracledb_module):
    ...
    global __target_version
    __target_version = _to_valid_version(oracledb_module.__version__)
    ...
    #     module_version = semver.parse_version_info(__target_version)
    #     async_support_version = semver.parse_version_info("2.4.0")
    #
