...
def save_file(data: any, path: str, autocreate_folder: bool = True) -> None:
    ...
    Args:
        ...
        path (str): The file path including the file name and extension where the data should
            be saved.
        autocreate_folder (bool, optional): If True, automatically creates the folder structure required by
