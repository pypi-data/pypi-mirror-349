...
def sklearn_regression(**kwargs) -> 'DataSet':
    ...
    Args:
        **kwargs: Parameters to control the regression dataset generation behavior. These
                  parameters are passed directly to the make_regression function. For further information about the parameters, see the sklearn documentation https://scikit-learn.org/stable/modules/generated/sklearn.datasets.make_regression.html.

    Returns:
        DataSet: A DataSet object containing the generated regression dataset, with metadata
                 describing it.
    """
