...
from ..google import (
    longrunning as _google_longrunning__,
    type as _google_type__,
)
...
class UpdateUserRequest(betterproto.Message):
    ...
    update_mask: "betterproto_lib_google_protobuf.FieldMask" = betterproto.message_field(2)
...
class Account(betterproto.Message):
    ...
    organization_name: str = betterproto.string_field(20)
...
class Deployment(betterproto.Message):
    ...
    annotations: Dict[str, str] = betterproto.map_field(64, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """
    ...
    extra_values: Dict[str, str] = betterproto.map_field(60, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """
    A JSON object of extra values that should be passed to the helm chart when installed.
    """

    is_nim: bool = betterproto.bool_field(62)
    """
    Whether this deployment should be created with NIM.
     TODO(shaunak): This is a hack and should be replaced with something better.
    """
...
class AutoscalingPolicy(betterproto.Message):
    ...
    load_targets: Dict[str, float] = betterproto.map_field(4, betterproto.TYPE_STRING, betterproto.TYPE_FLOAT)
    """
...
class GetDeploymentMetricsResponse(betterproto.Message):
    metrics: Dict[str, float] = betterproto.map_field(1, betterproto.TYPE_STRING, betterproto.TYPE_DOUBLE)
...
class DeploymentPrerequisites(betterproto.Message):
    accelerator_configs: List["DeploymentAcceleratorConfig"] = betterproto.message_field(1)
...
class BatchInferenceJob(betterproto.Message):
    ...
    append_to_messages: "AppendToMessages" = betterproto.message_field(11, group="format")
...
class GetBatchInferenceJobInputUploadEndpointRequest(betterproto.Message):
    name: str = betterproto.string_field(1)
    filename_to_size: Dict[str, int] = betterproto.map_field(2, betterproto.TYPE_STRING, betterproto.TYPE_INT64)
    """
...
class BatchJob(betterproto.Message):
    ...
    env_vars: Dict[str, str] = betterproto.map_field(6, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    ...
    python_executor: "PythonExecutor" = betterproto.message_field(7, group="executor_type")
    notebook_executor: "NotebookExecutor" = betterproto.message_field(8, group="executor_type")
    shell_executor: "ShellExecutor" = betterproto.message_field(16, group="executor_type")
    ...
    annotations: Dict[str, str] = betterproto.map_field(18, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """
...
class ListPaymentMethodsResponse(betterproto.Message):
    ...
    stripe_payment_methods: List["ListPaymentMethodsResponseStripePaymentMethod"] = betterproto.message_field(2)
    pending_checkout_sessions: List["StripeCheckoutSession"] = betterproto.message_field(3)
    """
...
class ListPaymentMethodsResponseStripePaymentMethod(betterproto.Message):
    ...
    us_bank_account: "ListPaymentMethodsResponseUsBankAccount" = betterproto.message_field(3, group="type")
    """ACH Direct Debit"""
...
class ListCostsResponse(betterproto.Message):
    cost_data_items: List["ListCostsResponseCostDataItem"] = betterproto.message_field(1)
...
class Cluster(betterproto.Message):
    ...
    annotations: Dict[str, str] = betterproto.map_field(10, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """
    Arbitrary, user-specified metadata.
     Keys and values must adhere to Kubernetes constraints: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/#syntax-and-character-set
     Additionally, the "fireworks.ai/" prefix is reserved.
...
class Dataset(betterproto.Message):
    ...
    evaluation_result: "EvaluationResult" = betterproto.message_field(15, group="data_source")
    fireworks_traced: "FireworksTraced" = betterproto.message_field(12, group="data_source")
    draft_model_states: "DraftModelStates" = betterproto.message_field(13, group="data_source")
...
class DeploymentTemplate(betterproto.Message):
    ...
    autoscaling_policy: Optional["AutoscalingPolicy"] = betterproto.message_field(8, optional=True)
    ...
    accelerator_type: Optional["AcceleratorType"] = betterproto.enum_field(26, optional=True)
    ...
    disaggregated_prefill_count: Optional[int] = betterproto.int32_field(11, optional=True)
    disaggregated_prefill_world_size: Optional[int] = betterproto.int32_field(12, optional=True)
    ...
    direct_route_type: Optional["DirectRouteType"] = betterproto.enum_field(33, optional=True)
    precision: Optional["DeploymentPrecision"] = betterproto.enum_field(34, optional=True)
    extra_args: List[str] = betterproto.string_field(36)
    """A list of extra arguments that should be passed to the server."""

    extra_values: Dict[str, str] = betterproto.map_field(37, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """
    A JSON object of extra values that should be passed to the helm chart when installed.
    """
...
class Environment(betterproto.Message):
    ...
    annotations: Dict[str, str] = betterproto.map_field(9, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """
    Arbitrary, user-specified metadata.
     Keys and values must adhere to Kubernetes constraints: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/#syntax-and-character-set
     Additionally, the "fireworks.ai/" prefix is reserved.
...
class CodeAssertionExecutionOptions(betterproto.Message):
    ...
    env_vars: Dict[str, str] = betterproto.map_field(3, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
...
class Provider(betterproto.Message):
    ...
    id: str = betterproto.string_field(1)
    config: Dict[str, str] = betterproto.map_field(2, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
...
class UpdateEvaluationRequest(betterproto.Message):
    name: str = betterproto.string_field(1)
    evaluation: "Evaluation" = betterproto.message_field(2)
    update_mask: "betterproto_lib_google_protobuf.FieldMask" = betterproto.message_field(3)
...
class ValidateAssertionsResponse(betterproto.Message):
    ...
    metric_to_errors: Dict[str, "ValidateAssertionsResponseValidateAssertionError"] = betterproto.map_field(
...
class PreviewEvaluationResult(betterproto.Message):
    ...
    messages: List["betterproto_lib_google_protobuf.Struct"] = betterproto.message_field(4)
    """messages, which can be any kind of object"""

    metrics: Dict[str, float] = betterproto.map_field(5, betterproto.TYPE_STRING, betterproto.TYPE_DOUBLE)
    """Metrics from the evaluation run"""

    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("score"):
            warnings.warn("PreviewEvaluationResult.score is deprecated", DeprecationWarning)
...
class EvaluationJob(betterproto.Message):
    ...
    metrics: Dict[str, float] = betterproto.map_field(9, betterproto.TYPE_STRING, betterproto.TYPE_DOUBLE)
...
class CodeSnippets(betterproto.Message):
    language: str = betterproto.string_field(1)
    file_contents: Dict[str, str] = betterproto.map_field(2, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """File name to code snippet, default is main.py"""


@dataclass(eq=False, repr=False)
class RollupSettings(betterproto.Message):
    criteria_weights: Dict[str, float] = betterproto.map_field(1, betterproto.TYPE_STRING, betterproto.TYPE_FLOAT)
...
class PreviewEvaluatorSampleResult(betterproto.Message):
    ...
    per_metric_evals: Dict[str, "betterproto_lib_google_protobuf.Struct"] = betterproto.map_field(
...
class FineTuningJob(betterproto.Message):
    ...
    text_completion: "FineTuningJobTextCompletion" = betterproto.message_field(15, group="kind")
    text_classification: "FineTuningJobTextClassification" = betterproto.message_field(16, group="kind")
    conversation: "FineTuningJobConversation" = betterproto.message_field(23, group="kind")
    draft_model_data: "FineTuningJobDraftModelData" = betterproto.message_field(32, group="kind")
    ...
    def __post_init__(self) -> None:
        ...
        if self.is_set("draft_model_data"):
            warnings.warn("FineTuningJob.draft_model_data is deprecated", DeprecationWarning)
...
class InferenceLog(betterproto.Message):
    ...
    metadata: Dict[str, str] = betterproto.map_field(9, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
...
class NodePool(betterproto.Message):
    ...
    fake_node_pool: "FakeNodePool" = betterproto.message_field(3, group="node_pool_type")
    annotations: Dict[str, str] = betterproto.map_field(14, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
    """
    Arbitrary, user-specified metadata.
     Keys and values must adhere to Kubernetes constraints: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/#syntax-and-character-set
     Additionally, the "fireworks.ai/" prefix is reserved.
...
class NodePoolStats(betterproto.Message):
    ...
    batch_job_count: Dict[str, int] = betterproto.map_field(5, betterproto.TYPE_STRING, betterproto.TYPE_INT32)
    """
    ...
    batch_job_ranks: Dict[str, int] = betterproto.map_field(6, betterproto.TYPE_STRING, betterproto.TYPE_INT32)
    """
    The key is the string representation of BatchJob.State (e.g. "RUNNING").
...
class CreateReinforcementFineTuningEpochRequest(betterproto.Message):
    ...
    reinforcement_fine_tuning_epoch: "ReinforcementFineTuningEpoch" = betterproto.message_field(2)
    debug: bool = betterproto.bool_field(3)
...
class ListReinforcementFineTuningEpochsResponse(betterproto.Message):
    reinforcement_fine_tuning_epochs: List["ReinforcementFineTuningEpoch"] = betterproto.message_field(1)
    next_page_token: str = betterproto.string_field(2)
    """
    A token, which can be sent as `page_token` to retrieve the next page.
     If this field is omitted, there are no subsequent pages.
...
class CreateReinforcementFineTuningJobRequest(betterproto.Message):
    ...
    reinforcement_fine_tuning_job: "ReinforcementFineTuningJob" = betterproto.message_field(2)
    debug: bool = betterproto.bool_field(3)
...
class ListReinforcementFineTuningJobsResponse(betterproto.Message):
    reinforcement_fine_tuning_jobs: List["ReinforcementFineTuningJob"] = betterproto.message_field(1)
    next_page_token: str = betterproto.string_field(2)
    """
    A token, which can be sent as `page_token` to retrieve the next page.
     If this field is omitted, there are no subsequent pages.
...
class SupervisedFineTuningJob(betterproto.Message):
    ...
    base_model_weight_precision: "SupervisedFineTuningJobWeightPrecision" = betterproto.enum_field(17)
    """The weight precision of the base model."""
...
class ListSupervisedFineTuningJobsResponse(betterproto.Message):
    supervised_fine_tuning_jobs: List["SupervisedFineTuningJob"] = betterproto.message_field(1)
    next_page_token: str = betterproto.string_field(2)
    """
    A token, which can be sent as `page_token` to retrieve the next page.
     If this field is omitted, there are no subsequent pages.
...
@dataclass(eq=False, repr=False)
class GetDeploymentUsageRequest(betterproto.Message):
    parent: str = betterproto.string_field(1)
    region: "Region" = betterproto.enum_field(2)
    """The geographic region where the deployment is located."""

    accelerator_type: "AcceleratorType" = betterproto.enum_field(3)
    """The accelerator type of the deployment."""

    exclude_deployment_id: str = betterproto.string_field(4)
    """The deployment ID to exclude from the usage calculation."""


@dataclass(eq=False, repr=False)
class GetTrainingUsageRequest(betterproto.Message):
    parent: str = betterproto.string_field(1)
    region: "Region" = betterproto.enum_field(2)
    accelerator_type: "AcceleratorType" = betterproto.enum_field(3)
    """The accelerator type of the deployment."""
...
class Usage(betterproto.Message):
    total_gpu_usage: int = betterproto.int64_field(1)
    """The total GPU usage of the training."""
...
class GatewayStub(betterproto.ServiceStub):
    ...
    async def get_deployment_usage(
        self,
        get_deployment_usage_request: "GetDeploymentUsageRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
        ...
        return await self._unary_unary(
            "/gateway.Gateway/GetDeploymentUsage",
            get_deployment_usage_request,
            Usage,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_training_usage(
        self,
        get_training_usage_request: "GetTrainingUsageRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
        ...
        return await self._unary_unary(
            "/gateway.Gateway/GetTrainingUsage",
            get_training_usage_request,
            Usage,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class GatewayBase(ServiceBase):
    ...
    async def create_account(self, create_account_request: "CreateAccountRequest") -> "Account":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_account(self, get_account_request: "GetAccountRequest") -> "Account":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_accounts(self, list_accounts_request: "ListAccountsRequest") -> "ListAccountsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_account(self, update_account_request: "UpdateAccountRequest") -> "Account":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def list_costs(self, list_costs_request: "ListCostsRequest") -> "ListCostsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_invoices(self, list_invoices_request: "ListInvoicesRequest") -> "ListInvoicesResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def create_batch_job(self, create_batch_job_request: "CreateBatchJobRequest") -> "BatchJob":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_batch_job(self, get_batch_job_request: "GetBatchJobRequest") -> "BatchJob":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_batch_jobs(self, list_batch_jobs_request: "ListBatchJobsRequest") -> "ListBatchJobsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_batch_job(self, update_batch_job_request: "UpdateBatchJobRequest") -> "BatchJob":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def create_cluster(self, create_cluster_request: "CreateClusterRequest") -> "Cluster":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_cluster(self, get_cluster_request: "GetClusterRequest") -> "Cluster":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_clusters(self, list_clusters_request: "ListClustersRequest") -> "ListClustersResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_cluster(self, update_cluster_request: "UpdateClusterRequest") -> "Cluster":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def create_environment(self, create_environment_request: "CreateEnvironmentRequest") -> "Environment":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_environment(self, get_environment_request: "GetEnvironmentRequest") -> "Environment":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def update_environment(self, update_environment_request: "UpdateEnvironmentRequest") -> "Environment":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_feature_flag(self, get_feature_flag_request: "GetFeatureFlagRequest") -> "FeatureFlag":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def create_snapshot(self, create_snapshot_request: "CreateSnapshotRequest") -> "Snapshot":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_snapshot(self, get_snapshot_request: "GetSnapshotRequest") -> "Snapshot":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_snapshots(self, list_snapshots_request: "ListSnapshotsRequest") -> "ListSnapshotsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def create_node_pool(self, create_node_pool_request: "CreateNodePoolRequest") -> "NodePool":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_node_pool(self, get_node_pool_request: "GetNodePoolRequest") -> "NodePool":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_node_pools(self, list_node_pools_request: "ListNodePoolsRequest") -> "ListNodePoolsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_node_pool(self, update_node_pool_request: "UpdateNodePoolRequest") -> "NodePool":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_node_pool_stats(self, get_node_pool_stats_request: "GetNodePoolStatsRequest") -> "NodePoolStats":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def list_users(self, list_users_request: "ListUsersRequest") -> "ListUsersResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_user(self, update_user_request: "UpdateUserRequest") -> "User":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def delete_user(self, delete_user_request: "DeleteUserRequest") -> "betterproto_lib_google_protobuf.Empty":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_audit_logs(self, list_audit_logs_request: "ListAuditLogsRequest") -> "ListAuditLogsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def create_api_key(self, create_api_key_request: "CreateApiKeyRequest") -> "ApiKey":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_api_keys(self, list_api_keys_request: "ListApiKeysRequest") -> "ListApiKeysResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_internal_api_key(self, get_internal_api_key_request: "GetInternalApiKeyRequest") -> "ApiKey":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def list_models(self, list_models_request: "ListModelsRequest") -> "ListModelsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def import_model(self, import_model_request: "ImportModelRequest") -> "_google_longrunning__.Operation":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def create_deployment(self, create_deployment_request: "CreateDeploymentRequest") -> "Deployment":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_deployment(self, get_deployment_request: "GetDeploymentRequest") -> "Deployment":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_deployments(self, list_deployments_request: "ListDeploymentsRequest") -> "ListDeploymentsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_deployment(self, update_deployment_request: "UpdateDeploymentRequest") -> "Deployment":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_deployed_model(self, get_deployed_model_request: "GetDeployedModelRequest") -> "DeployedModel":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def create_dataset(self, create_dataset_request: "CreateDatasetRequest") -> "Dataset":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_dataset(self, get_dataset_request: "GetDatasetRequest") -> "Dataset":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_datasets(self, list_datasets_request: "ListDatasetsRequest") -> "ListDatasetsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_dataset(self, update_dataset_request: "UpdateDatasetRequest") -> "Dataset":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def upload_dataset(self, upload_dataset_request: "UploadDatasetRequest") -> "UploadDatasetResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def preview_dataset(self, preview_dataset_request: "PreviewDatasetRequest") -> "PreviewDatasetResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def create_evaluator(self, create_evaluator_request: "CreateEvaluatorRequest") -> "Evaluator":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_evaluator(self, get_evaluator_request: "GetEvaluatorRequest") -> "Evaluator":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_evaluators(self, list_evaluators_request: "ListEvaluatorsRequest") -> "ListEvaluatorsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def create_evaluation(self, create_evaluation_request: "CreateEvaluationRequest") -> "Evaluation":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_evaluation(self, get_evaluation_request: "GetEvaluationRequest") -> "Evaluation":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_evaluations(self, list_evaluations_request: "ListEvaluationsRequest") -> "ListEvaluationsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_evaluation_job(self, get_evaluation_job_request: "GetEvaluationJobRequest") -> "EvaluationJob":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_fine_tuning_job(self, get_fine_tuning_job_request: "GetFineTuningJobRequest") -> "FineTuningJob":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_rlor_trainer_job(self, get_rlor_trainer_job_request: "GetRlorTrainerJobRequest") -> "RlorTrainerJob":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_peft_merge_job(self, get_peft_merge_job_request: "GetPeftMergeJobRequest") -> "PeftMergeJob":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def list_quotas(self, list_quotas_request: "ListQuotasRequest") -> "ListQuotasResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def create_secret(self, create_secret_request: "CreateSecretRequest") -> "Secret":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_secret(self, get_secret_request: "GetSecretRequest") -> "Secret":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def list_secrets(self, list_secrets_request: "ListSecretsRequest") -> "ListSecretsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def update_secret(self, update_secret_request: "UpdateSecretRequest") -> "Secret":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_reservation(self, get_reservation_request: "GetReservationRequest") -> "Reservation":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def test_evaluation(self, test_evaluation_request: "TestEvaluationRequest") -> "PreviewEvaluationResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_deployment_usage(self, get_deployment_usage_request: "GetDeploymentUsageRequest") -> "Usage":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_training_usage(self, get_training_usage_request: "GetTrainingUsageRequest") -> "Usage":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def get_inference_log(self, get_inference_log_request: "GetInferenceLogRequest") -> "InferenceLog":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_create_account(self, stream: "grpclib.server.Stream[CreateAccountRequest, Account]") -> None:
        request = await stream.recv_message()
        response = await self.create_account(request)
        await stream.send_message(response)

    async def __rpc_get_account(self, stream: "grpclib.server.Stream[GetAccountRequest, Account]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_update_account(self, stream: "grpclib.server.Stream[UpdateAccountRequest, Account]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_balance(self, stream: "grpclib.server.Stream[GetBalanceRequest, Balance]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_list_costs(self, stream: "grpclib.server.Stream[ListCostsRequest, ListCostsResponse]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_batch_job(self, stream: "grpclib.server.Stream[CreateBatchJobRequest, BatchJob]") -> None:
        request = await stream.recv_message()
        response = await self.create_batch_job(request)
        await stream.send_message(response)

    async def __rpc_get_batch_job(self, stream: "grpclib.server.Stream[GetBatchJobRequest, BatchJob]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_update_batch_job(self, stream: "grpclib.server.Stream[UpdateBatchJobRequest, BatchJob]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_cluster(self, stream: "grpclib.server.Stream[CreateClusterRequest, Cluster]") -> None:
        request = await stream.recv_message()
        response = await self.create_cluster(request)
        await stream.send_message(response)

    async def __rpc_get_cluster(self, stream: "grpclib.server.Stream[GetClusterRequest, Cluster]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_update_cluster(self, stream: "grpclib.server.Stream[UpdateClusterRequest, Cluster]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_environment(self, stream: "grpclib.server.Stream[GetEnvironmentRequest, Environment]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_snapshot(self, stream: "grpclib.server.Stream[CreateSnapshotRequest, Snapshot]") -> None:
        request = await stream.recv_message()
        response = await self.create_snapshot(request)
        await stream.send_message(response)

    async def __rpc_get_snapshot(self, stream: "grpclib.server.Stream[GetSnapshotRequest, Snapshot]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_node_pool(self, stream: "grpclib.server.Stream[CreateNodePoolRequest, NodePool]") -> None:
        request = await stream.recv_message()
        response = await self.create_node_pool(request)
        await stream.send_message(response)

    async def __rpc_get_node_pool(self, stream: "grpclib.server.Stream[GetNodePoolRequest, NodePool]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_update_node_pool(self, stream: "grpclib.server.Stream[UpdateNodePoolRequest, NodePool]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_api_key(self, stream: "grpclib.server.Stream[CreateApiKeyRequest, ApiKey]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_model(self, stream: "grpclib.server.Stream[CreateModelRequest, Model]") -> None:
        request = await stream.recv_message()
        response = await self.create_model(request)
        await stream.send_message(response)

    async def __rpc_get_model(self, stream: "grpclib.server.Stream[GetModelRequest, Model]") -> None:
        request = await stream.recv_message()
        response = await self.get_model(request)
        await stream.send_message(response)

    async def __rpc_list_models(self, stream: "grpclib.server.Stream[ListModelsRequest, ListModelsResponse]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_update_model(self, stream: "grpclib.server.Stream[UpdateModelRequest, Model]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_deployment(self, stream: "grpclib.server.Stream[GetDeploymentRequest, Deployment]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_dataset(self, stream: "grpclib.server.Stream[CreateDatasetRequest, Dataset]") -> None:
        request = await stream.recv_message()
        response = await self.create_dataset(request)
        await stream.send_message(response)

    async def __rpc_get_dataset(self, stream: "grpclib.server.Stream[GetDatasetRequest, Dataset]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_update_dataset(self, stream: "grpclib.server.Stream[UpdateDatasetRequest, Dataset]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_create_evaluator(self, stream: "grpclib.server.Stream[CreateEvaluatorRequest, Evaluator]") -> None:
        request = await stream.recv_message()
        response = await self.create_evaluator(request)
        await stream.send_message(response)

    async def __rpc_get_evaluator(self, stream: "grpclib.server.Stream[GetEvaluatorRequest, Evaluator]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_evaluation(self, stream: "grpclib.server.Stream[GetEvaluationRequest, Evaluation]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_quota(self, stream: "grpclib.server.Stream[GetQuotaRequest, Quota]") -> None:
        request = await stream.recv_message()
        response = await self.get_quota(request)
        await stream.send_message(response)

    async def __rpc_update_quota(self, stream: "grpclib.server.Stream[UpdateQuotaRequest, Quota]") -> None:
        request = await stream.recv_message()
        response = await self.update_quota(request)
        await stream.send_message(response)

    async def __rpc_list_quotas(self, stream: "grpclib.server.Stream[ListQuotasRequest, ListQuotasResponse]") -> None:
        request = await stream.recv_message()
        response = await self.list_quotas(request)
        await stream.send_message(response)

    async def __rpc_create_secret(self, stream: "grpclib.server.Stream[CreateSecretRequest, Secret]") -> None:
        request = await stream.recv_message()
        response = await self.create_secret(request)
        await stream.send_message(response)

    async def __rpc_get_secret(self, stream: "grpclib.server.Stream[GetSecretRequest, Secret]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_update_secret(self, stream: "grpclib.server.Stream[UpdateSecretRequest, Secret]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_reservation(self, stream: "grpclib.server.Stream[GetReservationRequest, Reservation]") -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_get_deployment_usage(
        self, stream: "grpclib.server.Stream[GetDeploymentUsageRequest, Usage]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_deployment_usage(request)
        await stream.send_message(response)

    async def __rpc_get_training_usage(self, stream: "grpclib.server.Stream[GetTrainingUsageRequest, Usage]") -> None:
        request = await stream.recv_message()
        response = await self.get_training_usage(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/gateway.Gateway/GetDeploymentUsage": grpclib.const.Handler(
                self.__rpc_get_deployment_usage,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetDeploymentUsageRequest,
                Usage,
            ),
            "/gateway.Gateway/GetTrainingUsage": grpclib.const.Handler(
                self.__rpc_get_training_usage,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTrainingUsageRequest,
                Usage,
            ),
