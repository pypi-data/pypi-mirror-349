from ..models import EventTrack, EventTrackLane, TimeMode, Keyframe, ConcreteSchemaType, KeyframeData
...
class KeyframeArgs:
    def __init__(self, time: float, data: KeyframeData):
        self.time = time
        self.data = data
        

class EventTrackLaneArgs:
    def __init__(self, short_id: str, name: str, keys: List[KeyframeArgs]):
        self.short_id = short_id
        self.name = name
        self.type = type
        self.keys = keys
