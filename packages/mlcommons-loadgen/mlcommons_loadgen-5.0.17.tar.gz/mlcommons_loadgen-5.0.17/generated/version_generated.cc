...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.17";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-05-20T16:59:09.577389";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-05-20T16:59:09.577405";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "654b6ec354";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-05-20T16:58:33Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(654b6ec3542c3002082091af3faefd8f5cb6cd13 Increment version to 5.0.17)LGVG_RSLD";
  return str;
}
...
574726b60d80aac6a818caaf153f8f529b643702 /VERSION.txt
