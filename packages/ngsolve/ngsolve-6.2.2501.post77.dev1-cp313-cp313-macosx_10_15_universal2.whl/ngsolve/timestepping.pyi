...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', '_lin_solver_args', 'time', 'gfu_old', 'bfmstar', 'c', 'dt')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfv_old', '_lin_solver_cls', '_lin_solver_args', 'time', 'gfa_old', 'gfu_old', 'bfmstar', 'c', 'dt')
