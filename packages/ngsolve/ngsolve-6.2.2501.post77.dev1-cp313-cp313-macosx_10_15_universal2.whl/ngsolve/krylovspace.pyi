...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('iterations', 'restart', 'innerproduct', 'norm')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('clear_output', 'atol', 'plt', 'fig', 'iterations', 'sol', 'callback', 'maxiter', 'tol', 'printrates', 'its', 'mat', 'ress', 'display', 'plotrates', 'residuals', '_final_residual', 'pre', 'ax', 'callback_sol')
