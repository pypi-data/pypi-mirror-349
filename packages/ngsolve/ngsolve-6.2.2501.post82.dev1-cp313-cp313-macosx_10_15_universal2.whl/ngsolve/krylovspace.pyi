...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('callback_sol', 'its', 'printrates', 'display', 'clear_output', 'iterations', 'residuals', 'sol', 'atol', 'ress', 'tol', 'fig', 'plotrates', 'maxiter', 'mat', 'pre', '_final_residual', 'ax', 'callback', 'plt')
