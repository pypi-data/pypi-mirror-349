...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bfmstar', '_lin_solver_args', 'c', 'time', 'gfu_old', '_lin_solver_cls', 'dt')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bfmstar', '_lin_solver_args', 'gfv_old', 'gfa_old', 'time', 'c', 'gfu_old', '_lin_solver_cls', 'dt')
