...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_cls', '_lin_solver_args', 'c', 'gfu_old', 'bfmstar', 'time')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', 'gfv_old', '_lin_solver_cls', '_lin_solver_args', 'gfa_old', 'c', 'gfu_old', 'bfmstar', 'time')
