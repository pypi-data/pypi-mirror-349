...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('residuals', 'plotrates', 'display', 'maxiter', 'callback_sol', 'sol', 'fig', 'printrates', 'callback', 'mat', 'tol', 'pre', 'plt', 'iterations', 'atol', '_final_residual', 'ress', 'ax', 'its', 'clear_output')
