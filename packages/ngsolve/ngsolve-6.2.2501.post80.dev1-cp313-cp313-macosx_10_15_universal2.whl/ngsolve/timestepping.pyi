...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', '_lin_solver_cls', 'dt', 'gfu_old', 'bfmstar', 'c', 'time')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_args', '_lin_solver_cls', 'dt', 'gfv_old', 'gfu_old', 'gfa_old', 'bfmstar', 'c', 'time')
