...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('residuals', 'printrates', 'plt', 'atol', 'clear_output', 'plotrates', 'callback', 'sol', 'fig', 'callback_sol', 'ax', 'tol', 'mat', 'its', 'pre', 'iterations', '_final_residual', 'maxiter', 'ress', 'display')
