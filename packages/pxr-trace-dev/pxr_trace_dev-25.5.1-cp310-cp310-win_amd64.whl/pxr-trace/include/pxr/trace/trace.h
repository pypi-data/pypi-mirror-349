...
#ifndef PXR_TRACE_TRACE_H
#define PXR_TRACE_TRACE_H
...
constexpr static pxr::TraceStaticKeyData \
    TF_PP_CAT(TraceKeyData_, instance)(name, prettyName); \
pxr::TraceScopeAuto TF_PP_CAT(TraceScopeAuto_, instance)(\
...
pxr::TraceAuto TF_PP_CAT(TraceAuto_, instance)(fnName, fnPrettyName, name)

#define _TRACE_SCOPE_DYNAMIC_INSTANCE(instance, str) \
pxr::TraceAuto TF_PP_CAT(TraceAuto_, instance)(str)
