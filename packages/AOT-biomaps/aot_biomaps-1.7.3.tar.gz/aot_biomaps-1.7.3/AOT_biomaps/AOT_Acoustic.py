...
class AcousticField(ABC):
    ...
    def __init__(self, params):
        ...
        if params != None:
            ...
            self.params['Nt'] = ceil(self.params['f_AQ'] * self.params['dz']*self.params['Nz'] / self.params['c0']*1.5)
            print(f"Nt: {self.params['Nt']}")
            self.kgrid.setTime(Nt=self.params['Nt'], dt=1/self.params['f_AQ'])
            print(self.kgrid.Nx, self.kgrid.Ny)
