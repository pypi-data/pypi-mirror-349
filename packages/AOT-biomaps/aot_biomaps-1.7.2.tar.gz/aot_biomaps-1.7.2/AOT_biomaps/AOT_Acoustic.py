...
class AcousticField(ABC):
    ...
    def __init__(self, params):
        ...
        if params != None:
            ...
            t_end = self.params["dz"]*self.params["Nz"]*self.params["c0"]*1e3
            self.kgrid.makeTime(self.params["c0"], t_end=t_end)
            print(self.kgrid)
    ...
    def _generate_burst_signalKWAVE(self):
        ...
        try:
            ...
            input_signal = tone_burst(1 / self.kgrid.dt, self.params['f_US'], self.params['num_cycles'])
            input_signal = (source_strength / (self.params['c0'] * 1000)) * input_signal
            return input_signal
        except Exception as e:
