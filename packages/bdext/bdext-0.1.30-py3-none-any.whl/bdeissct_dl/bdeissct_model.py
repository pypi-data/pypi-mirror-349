...
TARGET_COLUMNS_BDEI = TARGET_COLUMNS_BD + TARGET_INCUBATION_COLUMNS + (PI_E, )
TARGET_COLUMNS_BDEICT = TARGET_COLUMNS_BD + TARGET_INCUBATION_COLUMNS + TARGET_CT_COLUMNS + (PI_E, PI_EC, PI_IC)
TARGET_COLUMNS_BDSS = TARGET_COLUMNS_BD + TARGET_SS_COLUMNS + (PI_S, )
TARGET_COLUMNS_BDSSCT = TARGET_COLUMNS_BD + TARGET_SS_COLUMNS + TARGET_CT_COLUMNS + (PI_S, PI_IC, PI_SC)
TARGET_COLUMNS_BDEISS = TARGET_COLUMNS_BD + TARGET_INCUBATION_COLUMNS + TARGET_SS_COLUMNS + (PI_E, PI_S)
TARGET_COLUMNS_BDEISSCT = TARGET_COLUMNS_BD + TARGET_INCUBATION_COLUMNS + TARGET_SS_COLUMNS + TARGET_CT_COLUMNS + (PI_E, PI_S, PI_EC, PI_IC, PI_SC)
