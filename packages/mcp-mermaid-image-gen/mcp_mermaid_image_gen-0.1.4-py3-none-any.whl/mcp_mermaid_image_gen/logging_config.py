...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    ...
    for logger_instance in [
        ...
        if logger_instance is not root_logger:
            logger_instance.propagate = True

    # Log initial setup with the project_logger
    project_logger.info("=" * 80)
    project_logger.info("MCP Mermaid Image Gen Server Starting")
    project_logger.info(f"Log File: {log_file.absolute()}")
