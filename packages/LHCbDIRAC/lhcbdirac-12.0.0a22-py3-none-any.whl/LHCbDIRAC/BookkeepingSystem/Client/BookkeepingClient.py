...
class BookkeepingClient(Client):
    ...
    def dumpRunDataQuality(self, configName, configVersion, eventType=None):
        """Dump the run data quality for a given configuration.

        :param str configName: configuration name
        :param str configVersion: configuration version
        :param int eventType: event type (optional)
        :return: S_OK with the data quality information
        """
        return self._getRPC().dumpRunDataQuality(configName, configVersion, eventType)
