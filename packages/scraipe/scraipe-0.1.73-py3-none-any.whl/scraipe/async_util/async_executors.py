...
class IAsyncExecutor:
    ...
    async def run_multiple_async(self, tasks: List[Awaitable[Any]], max_workers: int = 10, timeout:float = DEFAULT_TIMEOUT) -> AsyncGenerator[Tuple[Any, str], None]:
        """
    ...
    def run_multiple(self, tasks: List[Awaitable[Any]], max_workers:int=10, timeout=DEFAULT_TIMEOUT) -> Generator[Tuple[Any,str], None, None]:
        """
        Run multiple coroutines in parallel using the underlying executor.
