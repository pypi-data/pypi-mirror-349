...
class AsyncTableNameTransform(_TableNameTransform):
    ...
    @classmethod
    async def _process_table_names(cls, query: glue.QueryStatement, table_schema: AsyncHistoricalTableSchema | None = None) -> glue.QueryStatement: ...
    @classmethod
    async def process_table_name(cls, table: glue.SchemaReference | glue.SubQueryStatement, table_schema: AsyncHistoricalTableSchema | None = None) -> None: ...
