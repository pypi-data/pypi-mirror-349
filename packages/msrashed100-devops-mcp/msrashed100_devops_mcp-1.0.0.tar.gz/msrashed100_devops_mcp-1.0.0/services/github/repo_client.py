...
class GitHubRepoClient:
    ...
    def list_commits(self, repo_name: str, branch: Optional[str] = None, 
        ...
        try:
            ...
            # Get commits
            commits = list(repo.get_commits(sha=branch, path=path, author=author, 
                                         since=since_date, until=until_date)[:max_results])
            ...
            self.github._handle_error(f"list_commits({repo_name})", e)
