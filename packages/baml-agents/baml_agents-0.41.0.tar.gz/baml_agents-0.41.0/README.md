...
[![PyPI Version](https://img.shields.io/badge/v0.41.0-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/baml-agents)
...
```bash
pip install "baml-agents>=0.41.0,<0.42.0"
```
