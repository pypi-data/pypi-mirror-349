...
[![PyPI version](https://badge.fury.io/py/douyin-wenan-mcp-server.svg)](https://badge.fury.io/py/douyin-wenan-mcp-server)
[![Python version](https://img.shields.io/pypi/pyversions/douyin-wenan-mcp-server.svg)](https://pypi.org/project/douyin-wenan-mcp-server/)
...
```bash
uvx douyin-wenan-mcp-server
```

### 使用 pip 安装

```bash
pip install douyin-wenan-mcp-server
```
...
```bash
git clone https://github.com/yzfly/douyin-wenan-mcp-server.git
cd douyin-wenan-mcp-server
pip install -e .
```
...
```bash
python -m douyin_wenan_mcp_server.server
```
