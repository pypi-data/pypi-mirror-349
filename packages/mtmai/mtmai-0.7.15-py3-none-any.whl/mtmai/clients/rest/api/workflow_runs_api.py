...
class WorkflowRunsApi:
    ...
    @validate_call
    async def v1_workflow_run_get_timings(
        self,
        v1_workflow_run: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The workflow run id to get")],
    ...
    @validate_call
    async def v1_workflow_run_get_timings_with_http_info(
        self,
        v1_workflow_run: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The workflow run id to get")],
        depth: Annotated[Optional[StrictInt], Field(description="The depth to retrieve children")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_workflow_run_get_timings_without_preload_content(
        self,
        v1_workflow_run: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The workflow run id to get")],
        depth: Annotated[Optional[StrictInt], Field(description="The depth to retrieve children")] = None,
        _request_timeout: Union[
