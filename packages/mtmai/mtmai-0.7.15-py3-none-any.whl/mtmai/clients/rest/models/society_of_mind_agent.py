...
class SocietyOfMindAgent(BaseModel):
    """
    SocietyOfMindAgent
    """ # noqa: E501
    provider: StrictStr
    ...
    config: Optional[SocietyOfMindAgentConfig] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SocietyOfMindAgent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SocietyOfMindAgent from a dict"""
        if obj is None:
            return None
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SocietyOfMindAgent) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "config": SocietyOfMindAgentConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
