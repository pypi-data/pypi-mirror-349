...
class V1Filter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadata", "tenantId", "workflowId", "scope", "expression", "payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in V1Filter) in the input: " + _key)
