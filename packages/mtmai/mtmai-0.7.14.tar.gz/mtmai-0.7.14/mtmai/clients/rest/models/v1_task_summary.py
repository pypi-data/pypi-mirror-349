...
class V1TaskSummary(BaseModel):
    ...
    children: Optional[List[Dict[str, Any]]] = Field(default=None, description="The list of children tasks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in V1TaskSummary) in the input: " + _key)
