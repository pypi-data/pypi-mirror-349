...
class CreateArtifacttRequest(BaseModel):
    """
    CreateArtifacttRequest
    """ # noqa: E501
    art_id: Annotated[str, Field(min_length=36, strict=True, max_length=36)] = Field(description="The blog id.", alias="artId")
    ...
    __properties: ClassVar[List[str]] = ["artId", "title", "state"]
