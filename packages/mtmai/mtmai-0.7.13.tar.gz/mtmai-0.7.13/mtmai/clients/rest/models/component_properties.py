...
class ComponentProperties(BaseModel):
    ...
    config: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["label", "description", "provider", "component_type", "version", "component_version", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ComponentProperties) in the input: " + _key)
