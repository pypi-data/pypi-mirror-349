...
class FilterApi:
    ...
    @validate_call
    async def v1_filter_create_with_http_info(
        self,
        v1_create_filter_request: Annotated[V1CreateFilterRequest, Field(description="The input to the filter creation")],
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_filter_create_without_preload_content(
        self,
        v1_create_filter_request: Annotated[V1CreateFilterRequest, Field(description="The input to the filter creation")],
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_filter_delete_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        v1_filter: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The filter id to delete")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_filter_delete_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        v1_filter: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The filter id to delete")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_filter_get_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        v1_filter: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The filter id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_filter_get_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        v1_filter: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The filter id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def v1_filter_list_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        offset: Annotated[Optional[StrictInt], Field(description="The number to skip")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number to limit by")] = None,
    ...
    @validate_call
    async def v1_filter_list_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        offset: Annotated[Optional[StrictInt], Field(description="The number to skip")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number to limit by")] = None,
