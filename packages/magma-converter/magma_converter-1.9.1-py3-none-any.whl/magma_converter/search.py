...
class Search:
    ...
    def _rename_error_files(self, error_files: List[str], prefix: str = 'ERROR',
                            input_dir: str = None,
            ...
            try:
                ...
                if self.check_file_integrity is True:
                    ...
                    if isinstance(e, TypeError):
                        _file = str(e).split('Unknown format for file ')[1]
                        self._rename_error_files([_file])
                    else:
