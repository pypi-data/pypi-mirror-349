...
# TODO: This is wrong!
#   We should be using the TOE for Foot-Off events.
#   ...
#   We should definitely improve this.
#   We are losing some good strides because the heel marker is JUST off the back of the plate. (See "BBF 07.c3d")
#   We should probably check if there is actually relevant force data (during that stance?) on the other plate and just change the plate...?
